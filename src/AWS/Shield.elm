module AWS.Shield
    exposing
        ...
        , UpdateEmergencyContactSettingsOptions
        , updateSubscription
...
associateDRTLogBucket logBucket =
    ...
    let
        requestInput = AssociateDRTLogBucketRequest
...
associateDRTRole roleArn =
    ...
    let
        requestInput = AssociateDRTRoleRequest
...
createProtection name resourceArn =
    ...
    let
        requestInput = CreateProtectionRequest
...
createSubscription :
    ...
    AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper CreateSubscriptionResponse)

createSubscription =
    
    let
        requestInput = CreateSubscriptionRequest
...
deleteProtection protectionId =
    ...
    let
        requestInput = DeleteProtectionRequest
...
deleteSubscription :
    ...
    AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper DeleteSubscriptionResponse)

deleteSubscription =
    
    let
        requestInput = DeleteSubscriptionRequest
...
describeAttack attackId =
    ...
    let
        requestInput = DescribeAttackRequest
...
describeDRTAccess :
    ...
    AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper DescribeDRTAccessResponse)

describeDRTAccess =
    
    let
        requestInput = DescribeDRTAccessRequest
...
describeEmergencyContactSettings :
    ...
    AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper DescribeEmergencyContactSettingsResponse)

describeEmergencyContactSettings =
    
    let
        requestInput = DescribeEmergencyContactSettingsRequest
...
describeProtection setOptions =
    ...
    let
        requestInput = DescribeProtectionRequest
        ...
        options = setOptions (DescribeProtectionOptions Nothing Nothing)
...
type alias DescribeProtectionOptions =
    {
    protectionId : Maybe String,resourceArn : Maybe String
    }
...
describeSubscription :
    ...
    AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper DescribeSubscriptionResponse)

describeSubscription =
    
    let
        requestInput = DescribeSubscriptionRequest
...
disassociateDRTLogBucket logBucket =
    ...
    let
        requestInput = DisassociateDRTLogBucketRequest
...
disassociateDRTRole :
    ...
    AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper DisassociateDRTRoleResponse)

disassociateDRTRole =
    
    let
        requestInput = DisassociateDRTRoleRequest
...
getSubscriptionState :
    ...
    AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper GetSubscriptionStateResponse)

getSubscriptionState =
    
    let
        requestInput = GetSubscriptionStateRequest
...
listAttacks setOptions =
    ...
    let
        requestInput = ListAttacksRequest
...
type alias ListAttacksOptions =
    {
    resourceArns : Maybe (List String),startTime : Maybe TimeRange,endTime : Maybe TimeRange,nextToken : Maybe String,maxResults : Maybe Int
    }
...
listProtections setOptions =
    ...
    let
        requestInput = ListProtectionsRequest
...
updateEmergencyContactSettings setOptions =
    ...
    let
        requestInput = UpdateEmergencyContactSettingsRequest
            
            options.emergencyContactList
            
        
        options = setOptions (UpdateEmergencyContactSettingsOptions Nothing)
...
updateSubscription setOptions =
    ...
    let
        requestInput = UpdateSubscriptionRequest
            
            options.autoRenew
            
        
        options = setOptions (UpdateSubscriptionOptions Nothing)
...
associateDRTLogBucketResponseToString : AssociateDRTLogBucketResponse -> String -- List (String, String)
associateDRTLogBucketResponseToString val =
    -- Dict.empty
...
associateDRTRoleResponseToString : AssociateDRTRoleResponse -> String -- List (String, String)
associateDRTRoleResponseToString val =
    -- Dict.empty
...
attackDetailToString : AttackDetail -> String -- List (String, String)
attackDetailToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "attackId" "" -- val.attackId
        
    --     |> Dict.insert
    --         "resourceArn" "" -- val.resourceArn
        
    --     |> Dict.insert
    --         "subResources" "" -- val.subResources
    ...
    --     |> Dict.insert
    --         "attackCounters" "" -- val.attackCounters
        
    --     |> Dict.insert
    --         "attackProperties" "" -- val.attackProperties
...
attackPropertyToString : AttackProperty -> String -- List (String, String)
attackPropertyToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "attackLayer" "" -- val.attackLayer
        
    --     |> Dict.insert
    --         "attackPropertyIdentifier" "" -- val.attackPropertyIdentifier
        
    --     |> Dict.insert
    --         "topContributors" "" -- val.topContributors
...
attackSummaryToString : AttackSummary -> String -- List (String, String)
attackSummaryToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "attackVectors" "" -- val.attackVectors
...
attackVectorDescriptionToString : AttackVectorDescription -> String -- List (String, String)
attackVectorDescriptionToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "vectorType" "" -- val.vectorType
...
contributorToString : Contributor -> String -- List (String, String)
contributorToString val =
    -- Dict.empty
...
createProtectionResponseToString : CreateProtectionResponse -> String -- List (String, String)
createProtectionResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "protectionId" "" -- val.protectionId
...
createSubscriptionResponseToString : CreateSubscriptionResponse -> String -- List (String, String)
createSubscriptionResponseToString val =
    -- Dict.empty
...
deleteProtectionResponseToString : DeleteProtectionResponse -> String -- List (String, String)
deleteProtectionResponseToString val =
    -- Dict.empty
...
deleteSubscriptionResponseToString : DeleteSubscriptionResponse -> String -- List (String, String)
deleteSubscriptionResponseToString val =
    -- Dict.empty
...
describeAttackResponseToString : DescribeAttackResponse -> String -- List (String, String)
describeAttackResponseToString val =
    -- Dict.empty
...
describeDRTAccessResponseToString : DescribeDRTAccessResponse -> String -- List (String, String)
describeDRTAccessResponseToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "logBucketList" "" -- val.logBucketList
...
describeEmergencyContactSettingsResponseToString : DescribeEmergencyContactSettingsResponse -> String -- List (String, String)
describeEmergencyContactSettingsResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "emergencyContactList" "" -- val.emergencyContactList
...
describeProtectionResponseToString : DescribeProtectionResponse -> String -- List (String, String)
describeProtectionResponseToString val =
    -- Dict.empty
...
describeSubscriptionResponseToString : DescribeSubscriptionResponse -> String -- List (String, String)
describeSubscriptionResponseToString val =
    -- Dict.empty
...
disassociateDRTLogBucketResponseToString : DisassociateDRTLogBucketResponse -> String -- List (String, String)
disassociateDRTLogBucketResponseToString val =
    -- Dict.empty
...
disassociateDRTRoleResponseToString : DisassociateDRTRoleResponse -> String -- List (String, String)
disassociateDRTRoleResponseToString val =
    -- Dict.empty
...
emergencyContactToString : EmergencyContact -> String -- List (String, String)
emergencyContactToString val =
    -- Dict.empty
...
getSubscriptionStateResponseToString : GetSubscriptionStateResponse -> String -- List (String, String)
getSubscriptionStateResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "subscriptionState" "" -- val.subscriptionState
...
listAttacksResponseToString : ListAttacksResponse -> String -- List (String, String)
listAttacksResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "attackSummaries" "" -- val.attackSummaries
...
listProtectionsResponseToString : ListProtectionsResponse -> String -- List (String, String)
listProtectionsResponseToString val =
    -- Dict.empty
...
mitigationToString : Mitigation -> String -- List (String, String)
mitigationToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "mitigationName" "" -- val.mitigationName
...
protectionToString : Protection -> String -- List (String, String)
protectionToString val =
    -- Dict.empty
...
subResourceSummaryToString : SubResourceSummary -> String -- List (String, String)
subResourceSummaryToString val =
    -- Dict.empty
...
subscriptionToString val =
    ...
    --     |> Dict.insert
    --         "timeCommitmentInSeconds" "" -- val.timeCommitmentInSeconds
...
summarizedAttackVectorToString : SummarizedAttackVector -> String -- List (String, String)
summarizedAttackVectorToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "vectorCounters" "" -- val.vectorCounters
...
summarizedCounterToString : SummarizedCounter -> String -- List (String, String)
summarizedCounterToString val =
    -- Dict.empty
...
timeRangeToString val =
    ...
    --     |> Dict.insert
    --         "fromInclusive" "" -- val.fromInclusive
        
    --     |> Dict.insert
    --         "toExclusive" "" -- val.toExclusive
...
updateEmergencyContactSettingsResponseToString : UpdateEmergencyContactSettingsResponse -> String -- List (String, String)
updateEmergencyContactSettingsResponseToString val =
    -- Dict.empty
...
updateSubscriptionResponseToString : UpdateSubscriptionResponse -> String -- List (String, String)
updateSubscriptionResponseToString val =
    -- Dict.empty
