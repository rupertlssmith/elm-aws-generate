module AWS.Budgets exposing
    ( service
    , createBudget, CreateBudgetOptions, createNotification, createSubscriber, deleteBudget, deleteNotification, deleteSubscriber, describeBudget, describeBudgetPerformanceHistory, DescribeBudgetPerformanceHistoryOptions, describeBudgets, DescribeBudgetsOptions, describeNotificationsForBudget, DescribeNotificationsForBudgetOptions, describeSubscribersForNotification, DescribeSubscribersForNotificationOptions, updateBudget, updateNotification, updateSubscriber
    , CreateBudgetResponse, CreateNotificationResponse, CreateSubscriberResponse, DeleteBudgetResponse, DeleteNotificationResponse, DeleteSubscriberResponse, DescribeBudgetPerformanceHistoryResponse, DescribeBudgetResponse, DescribeBudgetsResponse, DescribeNotificationsForBudgetResponse, DescribeSubscribersForNotificationResponse, UpdateBudgetResponse, UpdateNotificationResponse, UpdateSubscriberResponse
    , Budget, BudgetPerformanceHistory, BudgetedAndActualAmounts, CalculatedSpend, CostTypes, Notification, NotificationWithSubscribers, Spend, Subscriber, TimePeriod
    , BudgetType(..), ComparisonOperator(..), NotificationState(..), NotificationType(..), SubscriptionType(..), ThresholdType(..), TimeUnit(..)
    )
...
createBudget accountId budget setOptions =
    let
        ...
        options =
            setOptions (CreateBudgetOptions Nothing)
    in
...
describeBudgetPerformanceHistory accountId budgetName setOptions =
    let
        ...
        options =
            setOptions (DescribeBudgetPerformanceHistoryOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeBudgets accountId setOptions =
    let
        ...
        options =
            setOptions (DescribeBudgetsOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeNotificationsForBudget accountId budgetName setOptions =
    let
        ...
        options =
            setOptions (DescribeNotificationsForBudgetOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeSubscribersForNotification accountId budgetName notification setOptions =
    let
        ...
        options =
            setOptions (DescribeSubscribersForNotificationOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
budgetPerformanceHistoryToString :
...
budgetedAndActualAmountsToString :
...
createNotificationResponseToString :
...
createSubscriberResponseToString :
...
deleteNotificationResponseToString :
...
deleteSubscriberResponseToString :
...
describeBudgetPerformanceHistoryResponseToString :
...
describeBudgetResponseToString :
...
describeBudgetsResponseToString :
...
describeNotificationsForBudgetResponseToString :
...
describeSubscribersForNotificationResponseToString :
...
notificationWithSubscribersToString :
...
updateNotificationResponseToString :
...
updateSubscriberResponseToString :
