...
copyImage sourceImageName destinationImageName destinationRegion setOptions =
    let
        ...
        options =
            setOptions (CopyImageOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createFleet name instanceType computeCapacity setOptions =
    let
        ...
        options =
            setOptions (CreateFleetOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createImageBuilder name instanceType setOptions =
    let
        ...
        options =
            setOptions (CreateImageBuilderOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createImageBuilderStreamingURL name setOptions =
    let
        ...
        options =
            setOptions (CreateImageBuilderStreamingURLOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createStack name setOptions =
    let
        ...
        options =
            setOptions (CreateStackOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createStreamingURL stackName fleetName userId setOptions =
    let
        ...
        options =
            setOptions (CreateStreamingURLOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
-}
createUsageReportSubscription : AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper CreateUsageReportSubscriptionResult)
...
-}
deleteUsageReportSubscription : AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper DeleteUsageReportSubscriptionResult)
...
describeDirectoryConfigs setOptions =
    let
        ...
        options =
            setOptions (DescribeDirectoryConfigsOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeFleets setOptions =
    let
        ...
        options =
            setOptions (DescribeFleetsOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeImageBuilders setOptions =
    let
        ...
        options =
            setOptions (DescribeImageBuildersOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeImagePermissions name setOptions =
    let
        ...
        options =
            setOptions (DescribeImagePermissionsOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeImages setOptions =
    let
        ...
        options =
            setOptions (DescribeImagesOptions Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeSessions stackName fleetName setOptions =
    let
        ...
        options =
            setOptions (DescribeSessionsOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeUsageReportSubscriptions setOptions =
    let
        ...
        options =
            setOptions (DescribeUsageReportSubscriptionsOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeUserStackAssociations setOptions =
    let
        ...
        options =
            setOptions (DescribeUserStackAssociationsOptions Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeUsers authenticationType setOptions =
    let
        ...
        options =
            setOptions (DescribeUsersOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listAssociatedFleets stackName setOptions =
    let
        ...
        options =
            setOptions (ListAssociatedFleetsOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listAssociatedStacks fleetName setOptions =
    let
        ...
        options =
            setOptions (ListAssociatedStacksOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
startImageBuilder name setOptions =
    let
        ...
        options =
            setOptions (StartImageBuilderOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
updateDirectoryConfig directoryName setOptions =
    let
        ...
        options =
            setOptions (UpdateDirectoryConfigOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
updateFleet setOptions =
    let
        ...
        options =
            setOptions (UpdateFleetOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
updateStack name setOptions =
    let
        ...
        options =
            setOptions (UpdateStackOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
