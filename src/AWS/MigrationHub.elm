module AWS.MigrationHub
    exposing
        ...
        , AssociateCreatedArtifactOptions
        , associateDiscoveredResource
        , AssociateDiscoveredResourceOptions
        , createProgressUpdateStream
        , CreateProgressUpdateStreamOptions
        , deleteProgressUpdateStream
        , DeleteProgressUpdateStreamOptions
        , describeApplicationState
        , describeMigrationTask
        , disassociateCreatedArtifact
        , DisassociateCreatedArtifactOptions
        , disassociateDiscoveredResource
        , DisassociateDiscoveredResourceOptions
        , importMigrationTask
        , ImportMigrationTaskOptions
        , listCreatedArtifacts
        , ListCreatedArtifactsOptions
        , listDiscoveredResources
        , ListDiscoveredResourcesOptions
        , listMigrationTasks
        , ListMigrationTasksOptions
        , listProgressUpdateStreams
        , ListProgressUpdateStreamsOptions
        , notifyApplicationState
        , NotifyApplicationStateOptions
        , notifyMigrationTaskState
        , NotifyMigrationTaskStateOptions
        , putResourceAttributes
        , PutResourceAttributesOptions
...
* `progressUpdateStream` __:__ `String`
* `migrationTaskName` __:__ `String`
* `createdArtifact` __:__ `CreatedArtifact`
...
associateCreatedArtifact progressUpdateStream migrationTaskName createdArtifact setOptions =
    ...
    let
        requestInput = AssociateCreatedArtifactRequest
        ...
        options = setOptions (AssociateCreatedArtifactOptions Nothing)
...
* `progressUpdateStream` __:__ `String`
* `migrationTaskName` __:__ `String`
* `discoveredResource` __:__ `DiscoveredResource`
...
associateDiscoveredResource progressUpdateStream migrationTaskName discoveredResource setOptions =
    ...
    let
        requestInput = AssociateDiscoveredResourceRequest
        ...
        options = setOptions (AssociateDiscoveredResourceOptions Nothing)
...
* `progressUpdateStreamName` __:__ `String`
...
createProgressUpdateStream progressUpdateStreamName setOptions =
    ...
    let
        requestInput = CreateProgressUpdateStreamRequest
        ...
        options = setOptions (CreateProgressUpdateStreamOptions Nothing)
...
deleteProgressUpdateStream progressUpdateStreamName setOptions =
    ...
    let
        requestInput = DeleteProgressUpdateStreamRequest
        ...
        options = setOptions (DeleteProgressUpdateStreamOptions Nothing)
...
describeApplicationState applicationId =
    ...
    let
        requestInput = DescribeApplicationStateRequest
...
describeMigrationTask progressUpdateStream migrationTaskName =
    ...
    let
        requestInput = DescribeMigrationTaskRequest
...
* `progressUpdateStream` __:__ `String`
* `migrationTaskName` __:__ `String`
* `createdArtifactName` __:__ `String`
...
disassociateCreatedArtifact progressUpdateStream migrationTaskName createdArtifactName setOptions =
    ...
    let
        requestInput = DisassociateCreatedArtifactRequest
        ...
        options = setOptions (DisassociateCreatedArtifactOptions Nothing)
...
disassociateDiscoveredResource progressUpdateStream migrationTaskName configurationId setOptions =
    ...
    let
        requestInput = DisassociateDiscoveredResourceRequest
        ...
        options = setOptions (DisassociateDiscoveredResourceOptions Nothing)
...
importMigrationTask progressUpdateStream migrationTaskName setOptions =
    ...
    let
        requestInput = ImportMigrationTaskRequest
        ...
        options = setOptions (ImportMigrationTaskOptions Nothing)
...
listCreatedArtifacts progressUpdateStream migrationTaskName setOptions =
    ...
    let
        requestInput = ListCreatedArtifactsRequest
        ...
        options = setOptions (ListCreatedArtifactsOptions Nothing Nothing)
...
listDiscoveredResources progressUpdateStream migrationTaskName setOptions =
    ...
    let
        ...
        options = setOptions (ListDiscoveredResourcesOptions Nothing Nothing)
...
listMigrationTasks setOptions =
    ...
    let
        requestInput = ListMigrationTasksRequest
        ...
        options = setOptions (ListMigrationTasksOptions Nothing Nothing Nothing)
...
type alias ListMigrationTasksOptions =
    {
    nextToken : Maybe String,maxResults : Maybe Int,resourceName : Maybe String
    }
...
listProgressUpdateStreams setOptions =
    ...
    let
        requestInput = ListProgressUpdateStreamsRequest
        ...
        options = setOptions (ListProgressUpdateStreamsOptions Nothing Nothing)
...
* `applicationId` __:__ `String`
* `status` __:__ `ApplicationStatus`
...
notifyApplicationState applicationId status setOptions =
    ...
    let
        requestInput = NotifyApplicationStateRequest
        ...
        options = setOptions (NotifyApplicationStateOptions Nothing)
...
* `migrationTaskName` __:__ `String`
* `task` __:__ `Task`
* `updateDateTime` __:__ `Posix`
* `nextUpdateSeconds` __:__ `Int`
...
notifyMigrationTaskState progressUpdateStream migrationTaskName task updateDateTime nextUpdateSeconds setOptions =
    ...
    let
        requestInput = NotifyMigrationTaskStateRequest
        ...
        options = setOptions (NotifyMigrationTaskStateOptions Nothing)
...
* `progressUpdateStream` __:__ `String`
* `migrationTaskName` __:__ `String`
* `resourceAttributeList` __:__ `(List ResourceAttribute)`
...
putResourceAttributes progressUpdateStream migrationTaskName resourceAttributeList setOptions =
    ...
    let
        requestInput = PutResourceAttributesRequest
        ...
        options = setOptions (PutResourceAttributesOptions Nothing)
...
accessDeniedExceptionToString : AccessDeniedException -> String -- List (String, String)
accessDeniedExceptionToString val =
    -- Dict.empty
...
associateCreatedArtifactResultToString : AssociateCreatedArtifactResult -> String -- List (String, String)
associateCreatedArtifactResultToString val =
    -- Dict.empty
...
associateDiscoveredResourceResultToString : AssociateDiscoveredResourceResult -> String -- List (String, String)
associateDiscoveredResourceResultToString val =
    -- Dict.empty
...
createProgressUpdateStreamResultToString : CreateProgressUpdateStreamResult -> String -- List (String, String)
createProgressUpdateStreamResultToString val =
    -- Dict.empty
...
createdArtifactToString : CreatedArtifact -> String -- List (String, String)
createdArtifactToString val =
    -- Dict.empty
...
deleteProgressUpdateStreamResultToString : DeleteProgressUpdateStreamResult -> String -- List (String, String)
deleteProgressUpdateStreamResultToString val =
    -- Dict.empty
...
describeApplicationStateResultToString : DescribeApplicationStateResult -> String -- List (String, String)
describeApplicationStateResultToString val =
    -- Dict.empty
...
describeMigrationTaskResultToString : DescribeMigrationTaskResult -> String -- List (String, String)
describeMigrationTaskResultToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "migrationTask" "" -- val.migrationTask
...
disassociateCreatedArtifactResultToString : DisassociateCreatedArtifactResult -> String -- List (String, String)
disassociateCreatedArtifactResultToString val =
    -- Dict.empty
...
disassociateDiscoveredResourceResultToString : DisassociateDiscoveredResourceResult -> String -- List (String, String)
disassociateDiscoveredResourceResultToString val =
    -- Dict.empty
...
discoveredResourceToString : DiscoveredResource -> String -- List (String, String)
discoveredResourceToString val =
    -- Dict.empty
...
dryRunOperationToString : DryRunOperation -> String -- List (String, String)
dryRunOperationToString val =
    -- Dict.empty
...
importMigrationTaskResultToString : ImportMigrationTaskResult -> String -- List (String, String)
importMigrationTaskResultToString val =
    -- Dict.empty
...
listCreatedArtifactsResultToString : ListCreatedArtifactsResult -> String -- List (String, String)
listCreatedArtifactsResultToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "createdArtifactList" "" -- val.createdArtifactList
...
listDiscoveredResourcesResultToString : ListDiscoveredResourcesResult -> String -- List (String, String)
listDiscoveredResourcesResultToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "discoveredResourceList" "" -- val.discoveredResourceList
...
listMigrationTasksResultToString : ListMigrationTasksResult -> String -- List (String, String)
listMigrationTasksResultToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "migrationTaskSummaryList" "" -- val.migrationTaskSummaryList
...
listProgressUpdateStreamsResultToString : ListProgressUpdateStreamsResult -> String -- List (String, String)
listProgressUpdateStreamsResultToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "progressUpdateStreamSummaryList" "" -- val.progressUpdateStreamSummaryList
...
migrationTaskToString : MigrationTask -> String -- List (String, String)
migrationTaskToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "progressUpdateStream" "" -- val.progressUpdateStream
        
    --     |> Dict.insert
    --         "migrationTaskName" "" -- val.migrationTaskName
    ...
    --     |> Dict.insert
    --         "resourceAttributeList" "" -- val.resourceAttributeList
...
migrationTaskSummaryToString : MigrationTaskSummary -> String -- List (String, String)
migrationTaskSummaryToString val =
    -- Dict.empty
...
notifyApplicationStateResultToString : NotifyApplicationStateResult -> String -- List (String, String)
notifyApplicationStateResultToString val =
    -- Dict.empty
...
notifyMigrationTaskStateResultToString : NotifyMigrationTaskStateResult -> String -- List (String, String)
notifyMigrationTaskStateResultToString val =
    -- Dict.empty
...
policyErrorExceptionToString : PolicyErrorException -> String -- List (String, String)
policyErrorExceptionToString val =
    -- Dict.empty
...
progressUpdateStreamSummaryToString : ProgressUpdateStreamSummary -> String -- List (String, String)
progressUpdateStreamSummaryToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "progressUpdateStreamName" "" -- val.progressUpdateStreamName
...
putResourceAttributesResultToString : PutResourceAttributesResult -> String -- List (String, String)
putResourceAttributesResultToString val =
    -- Dict.empty
...
resourceAttributeToString : ResourceAttribute -> String -- List (String, String)
...
serviceUnavailableExceptionToString : ServiceUnavailableException -> String -- List (String, String)
serviceUnavailableExceptionToString val =
    -- Dict.empty
...
taskToString : Task -> String -- List (String, String)
taskToString val =
    -- Dict.empty
...
unauthorizedOperationToString : UnauthorizedOperation -> String -- List (String, String)
unauthorizedOperationToString val =
    -- Dict.empty
