module AWS.CodePipeline exposing
    ( service
...
createCustomActionType category provider version inputArtifactDetails outputArtifactDetails setOptions =
    let
        ...
        options =
            setOptions (CreateCustomActionTypeOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createPipeline pipeline setOptions =
    let
        ...
        options =
            setOptions (CreatePipelineOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
deregisterWebhookWithThirdParty setOptions =
    let
        ...
        options =
            setOptions (DeregisterWebhookWithThirdPartyOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
getPipeline name setOptions =
    let
        ...
        options =
            setOptions (GetPipelineOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listActionExecutions pipelineName setOptions =
    let
        ...
        options =
            setOptions (ListActionExecutionsOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listActionTypes setOptions =
    let
        ...
        options =
            setOptions (ListActionTypesOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listPipelineExecutions pipelineName setOptions =
    let
        ...
        options =
            setOptions (ListPipelineExecutionsOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listPipelines setOptions =
    let
        ...
        options =
            setOptions (ListPipelinesOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listWebhooks setOptions =
    let
        ...
        options =
            setOptions (ListWebhooksOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
pollForJobs actionTypeId setOptions =
    let
        ...
        options =
            setOptions (PollForJobsOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
pollForThirdPartyJobs actionTypeId setOptions =
    let
        ...
        options =
            setOptions (PollForThirdPartyJobsOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
putJobSuccessResult jobId setOptions =
    let
        ...
        options =
            setOptions (PutJobSuccessResultOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
putThirdPartyJobSuccessResult jobId clientToken setOptions =
    let
        ...
        options =
            setOptions (PutThirdPartyJobSuccessResultOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
putWebhook webhook setOptions =
    let
        ...
        options =
            setOptions (PutWebhookOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
registerWebhookWithThirdParty setOptions =
    let
        ...
        options =
            setOptions (RegisterWebhookWithThirdPartyOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
startPipelineExecution name setOptions =
    let
        ...
        options =
            setOptions (StartPipelineExecutionOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
acknowledgeThirdPartyJobOutputToString :
...
actionConfigurationPropertyToString :
...
createCustomActionTypeOutputToString :
...
deregisterWebhookWithThirdPartyOutputToString :
...
getPipelineExecutionOutputToString :
...
getPipelineStateOutputToString :
...
getThirdPartyJobDetailsOutputToString :
...
listActionExecutionsOutputToString :
...
listPipelineExecutionsOutputToString :
    ListPipelineExecutionsOutput
    -> String -- List (String, String)
...
pipelineExecutionSummaryToString :
...
pollForThirdPartyJobsOutputToString :
...
putActionRevisionOutputToString :
...
putApprovalResultOutputToString :
...
registerWebhookWithThirdPartyOutputToString :
...
retryStageExecutionOutputToString :
...
startPipelineExecutionOutputToString :
...
webhookAuthConfigurationToString :
