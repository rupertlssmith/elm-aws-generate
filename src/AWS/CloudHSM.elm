...
createHsm subnetId sshKey iamRoleArn subscriptionType setOptions =
    let
        ...
        options =
            setOptions (CreateHsmOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createLunaClient certificate setOptions =
    let
        ...
        options =
            setOptions (CreateLunaClientOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeHsm setOptions =
    let
        ...
        options =
            setOptions (DescribeHsmOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeLunaClient setOptions =
    let
        ...
        options =
            setOptions (DescribeLunaClientOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
-}
listAvailableZones : AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper ListAvailableZonesResponse)
listAvailableZones =
    let
        requestInput =
...
listHapgs setOptions =
    let
        ...
        options =
            setOptions (ListHapgsOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listHsms setOptions =
    let
        ...
        options =
            setOptions (ListHsmsOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listLunaClients setOptions =
    let
        ...
        options =
            setOptions (ListLunaClientsOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
modifyHapg hapgArn setOptions =
    let
        ...
        options =
            setOptions (ModifyHapgOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
modifyHsm hsmArn setOptions =
    let
        ...
        options =
            setOptions (ModifyHsmOptions Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
