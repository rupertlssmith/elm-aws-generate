module AWS.IAM
    exposing
        ...
        , CreateServiceLinkedRoleOptions
        ...
        , GenerateOrganizationsAccessReportOptions
        ...
        , GetOrganizationsAccessReportOptions
        , getPolicy
        , getPolicyVersion
        , getRole
        , getRolePolicy
        ...
        , GetServiceLastAccessedDetailsOptions
        , getServiceLastAccessedDetailsWithEntities
        , GetServiceLastAccessedDetailsWithEntitiesOptions
        ...
        , ListPoliciesGrantingServiceAccessOptions
        , listPolicyVersions
...
addClientIDToOpenIDConnectProvider openIDConnectProviderArn clientID =
    ...
    let
        requestInput = AddClientIDToOpenIDConnectProviderRequest
...
addRoleToInstanceProfile instanceProfileName roleName =
    ...
    let
        requestInput = AddRoleToInstanceProfileRequest
...
addUserToGroup groupName userName =
    ...
    let
        requestInput = AddUserToGroupRequest
...
attachGroupPolicy groupName policyArn =
    ...
    let
        requestInput = AttachGroupPolicyRequest
...
attachRolePolicy roleName policyArn =
    ...
    let
        requestInput = AttachRolePolicyRequest
...
attachUserPolicy userName policyArn =
    ...
    let
        requestInput = AttachUserPolicyRequest
...
createAccessKey setOptions =
    ...
    let
        requestInput = CreateAccessKeyRequest
...
createAccountAlias accountAlias =
    ...
    let
        requestInput = CreateAccountAliasRequest
...
createLoginProfile userName password setOptions =
    ...
    let
        requestInput = CreateLoginProfileRequest
...
createOpenIDConnectProvider url thumbprintList setOptions =
    ...
    let
        requestInput = CreateOpenIDConnectProviderRequest
...
createPolicy policyName policyDocument setOptions =
    ...
    let
        requestInput = CreatePolicyRequest
...
type alias CreatePolicyOptions =
    {
    path : Maybe String,description : Maybe String
    }
...
createPolicyVersion policyArn policyDocument setOptions =
    ...
    let
        requestInput = CreatePolicyVersionRequest
...
createRole roleName assumeRolePolicyDocument setOptions =
    ...
    let
        requestInput = CreateRoleRequest
        ...
        options = setOptions (CreateRoleOptions Nothing Nothing Nothing Nothing Nothing)
...
type alias CreateRoleOptions =
    {
    path : Maybe String,description : Maybe String,maxSessionDuration : Maybe Int,permissionsBoundary : Maybe String,tags : Maybe (List Tag)
    }
...
createSAMLProvider sAMLMetadataDocument name =
    ...
    let
        requestInput = CreateSAMLProviderRequest
...
createServiceLinkedRole aWSServiceName setOptions =
    ...
    let
        requestInput = CreateServiceLinkedRoleRequest
        ...
        options = setOptions (CreateServiceLinkedRoleOptions Nothing Nothing)
...
type alias CreateServiceLinkedRoleOptions =
    {
    description : Maybe String,customSuffix : Maybe String
    }
...
createServiceSpecificCredential userName serviceName =
    ...
    let
        requestInput = CreateServiceSpecificCredentialRequest
...
type alias CreateUserOptions =
    {
    path : Maybe String,permissionsBoundary : Maybe String,tags : Maybe (List Tag)
    }
...
createVirtualMFADevice virtualMFADeviceName setOptions =
    ...
    let
        requestInput = CreateVirtualMFADeviceRequest
...
deactivateMFADevice userName serialNumber =
    ...
    let
        requestInput = DeactivateMFADeviceRequest
...
deleteAccessKey accessKeyId setOptions =
    ...
    let
        requestInput = DeleteAccessKeyRequest
...
deleteAccountAlias accountAlias =
    ...
    let
        requestInput = DeleteAccountAliasRequest
...
deleteGroupPolicy groupName policyName =
    ...
    let
        requestInput = DeleteGroupPolicyRequest
...
deleteLoginProfile userName =
    ...
    let
        requestInput = DeleteLoginProfileRequest
...
deleteOpenIDConnectProvider openIDConnectProviderArn =
    ...
    let
        requestInput = DeleteOpenIDConnectProviderRequest
...
deletePolicy policyArn =
    ...
    let
        requestInput = DeletePolicyRequest
...
deletePolicyVersion policyArn versionId =
    ...
    let
        requestInput = DeletePolicyVersionRequest
...
deleteRole roleName =
    ...
    let
        requestInput = DeleteRoleRequest
...
deleteRolePermissionsBoundary roleName =
    ...
    let
        requestInput = DeleteRolePermissionsBoundaryRequest
...
deleteRolePolicy roleName policyName =
    ...
    let
        requestInput = DeleteRolePolicyRequest
...
deleteSAMLProvider sAMLProviderArn =
    ...
    let
        requestInput = DeleteSAMLProviderRequest
...
deleteSSHPublicKey userName sSHPublicKeyId =
    ...
    let
        requestInput = DeleteSSHPublicKeyRequest
...
deleteServerCertificate serverCertificateName =
    ...
    let
        requestInput = DeleteServerCertificateRequest
...
deleteServiceLinkedRole roleName =
    ...
    let
        requestInput = DeleteServiceLinkedRoleRequest
...
deleteServiceSpecificCredential serviceSpecificCredentialId setOptions =
    ...
    let
        requestInput = DeleteServiceSpecificCredentialRequest
...
deleteSigningCertificate certificateId setOptions =
    ...
    let
        requestInput = DeleteSigningCertificateRequest
...
deleteUserPermissionsBoundary userName =
    ...
    let
        requestInput = DeleteUserPermissionsBoundaryRequest
...
deleteUserPolicy userName policyName =
    ...
    let
        requestInput = DeleteUserPolicyRequest
...
deleteVirtualMFADevice serialNumber =
    ...
    let
        requestInput = DeleteVirtualMFADeviceRequest
...
detachGroupPolicy groupName policyArn =
    ...
    let
        requestInput = DetachGroupPolicyRequest
...
detachRolePolicy roleName policyArn =
    ...
    let
        requestInput = DetachRolePolicyRequest
...
detachUserPolicy userName policyArn =
    ...
    let
        requestInput = DetachUserPolicyRequest
...
enableMFADevice userName serialNumber authenticationCode1 authenticationCode2 =
    ...
    let
        requestInput = EnableMFADeviceRequest
...
generateCredentialReport :
    ...
    AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper GenerateCredentialReportResponse)
...
generateOrganizationsAccessReport entityPath setOptions =
    ...
    let
        requestInput = GenerateOrganizationsAccessReportRequest
        ...
        options = setOptions (GenerateOrganizationsAccessReportOptions Nothing)
...
generateServiceLastAccessedDetails arn =
    ...
    let
        requestInput = GenerateServiceLastAccessedDetailsRequest
...
getAccessKeyLastUsed accessKeyId =
    ...
    let
        requestInput = GetAccessKeyLastUsedRequest
...
getAccountAuthorizationDetails setOptions =
    ...
    let
        requestInput = GetAccountAuthorizationDetailsRequest
...
type alias GetAccountAuthorizationDetailsOptions =
    {
    filter : Maybe (List EntityType),maxItems : Maybe Int,marker : Maybe String
    }
...
getAccountPasswordPolicy :
    ...
    AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper GetAccountPasswordPolicyResponse)
...
getAccountSummary :
    ...
    AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper GetAccountSummaryResponse)
...
getContextKeysForCustomPolicy policyInputList =
    ...
    let
        requestInput = GetContextKeysForCustomPolicyRequest
...
getContextKeysForPrincipalPolicy policySourceArn setOptions =
    ...
    let
        requestInput = GetContextKeysForPrincipalPolicyRequest
...
getCredentialReport :
    ...
    AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper GetCredentialReportResponse)
...
type alias GetGroupOptions =
    {
    marker : Maybe String,maxItems : Maybe Int
    }
...
getGroupPolicy groupName policyName =
    ...
    let
        requestInput = GetGroupPolicyRequest
...
getLoginProfile userName =
    ...
    let
        requestInput = GetLoginProfileRequest
...
getOpenIDConnectProvider openIDConnectProviderArn =
    ...
    let
        requestInput = GetOpenIDConnectProviderRequest
...
getOrganizationsAccessReport jobId setOptions =
    ...
    let
        requestInput = GetOrganizationsAccessReportRequest
        ...
        options = setOptions (GetOrganizationsAccessReportOptions Nothing Nothing Nothing)
...
type alias GetOrganizationsAccessReportOptions =
    {
    maxItems : Maybe Int,marker : Maybe String,sortKey : Maybe SortKeyType
    }
...
getPolicyVersion policyArn versionId =
    ...
    let
        requestInput = GetPolicyVersionRequest
...
getRolePolicy roleName policyName =
    ...
    let
        requestInput = GetRolePolicyRequest
...
getSAMLProvider sAMLProviderArn =
    ...
    let
        requestInput = GetSAMLProviderRequest
...
getSSHPublicKey userName sSHPublicKeyId encoding =
    ...
    let
        requestInput = GetSSHPublicKeyRequest
...
getServerCertificate serverCertificateName =
    ...
    let
        requestInput = GetServerCertificateRequest
...
getServiceLastAccessedDetails jobId setOptions =
    ...
    let
        requestInput = GetServiceLastAccessedDetailsRequest
        ...
        options = setOptions (GetServiceLastAccessedDetailsOptions Nothing Nothing)
...
type alias GetServiceLastAccessedDetailsOptions =
    {
    maxItems : Maybe Int,marker : Maybe String
    }
...
getServiceLastAccessedDetailsWithEntities jobId serviceNamespace setOptions =
    ...
    let
        requestInput = GetServiceLastAccessedDetailsWithEntitiesRequest
        ...
        options = setOptions (GetServiceLastAccessedDetailsWithEntitiesOptions Nothing Nothing)
...
getServiceLinkedRoleDeletionStatus deletionTaskId =
    ...
    let
        requestInput = GetServiceLinkedRoleDeletionStatusRequest
...
getUserPolicy userName policyName =
    ...
    let
        requestInput = GetUserPolicyRequest
...
listAccessKeys setOptions =
    ...
    let
        requestInput = ListAccessKeysRequest
...
type alias ListAccessKeysOptions =
    {
    userName : Maybe String,marker : Maybe String,maxItems : Maybe Int
    }
...
listAccountAliases setOptions =
    ...
    let
        requestInput = ListAccountAliasesRequest
...
listAttachedGroupPolicies groupName setOptions =
    ...
    let
        requestInput = ListAttachedGroupPoliciesRequest
...
type alias ListAttachedGroupPoliciesOptions =
    {
    pathPrefix : Maybe String,marker : Maybe String,maxItems : Maybe Int
    }
...
listAttachedRolePolicies roleName setOptions =
    ...
    let
        requestInput = ListAttachedRolePoliciesRequest
...
listAttachedUserPolicies userName setOptions =
    ...
    let
        requestInput = ListAttachedUserPoliciesRequest
...
listEntitiesForPolicy policyArn setOptions =
    ...
    let
        requestInput = ListEntitiesForPolicyRequest
        ...
        options = setOptions (ListEntitiesForPolicyOptions Nothing Nothing Nothing Nothing Nothing)
...
type alias ListEntitiesForPolicyOptions =
    {
    entityFilter : Maybe EntityType,pathPrefix : Maybe String,policyUsageFilter : Maybe PolicyUsageType,marker : Maybe String,maxItems : Maybe Int
    }
...
listGroupPolicies groupName setOptions =
    ...
    let
        requestInput = ListGroupPoliciesRequest
...
listGroupsForUser userName setOptions =
    ...
    let
        requestInput = ListGroupsForUserRequest
...
listInstanceProfilesForRole roleName setOptions =
    ...
    let
        requestInput = ListInstanceProfilesForRoleRequest
...
listMFADevices setOptions =
    ...
    let
        requestInput = ListMFADevicesRequest
...
listOpenIDConnectProviders =
    ...
    let
        requestInput = ListOpenIDConnectProvidersRequest
...
listPolicies setOptions =
    ...
    let
        requestInput = ListPoliciesRequest
        ...
        options = setOptions (ListPoliciesOptions Nothing Nothing Nothing Nothing Nothing Nothing)
...
type alias ListPoliciesOptions =
    {
    scope : Maybe PolicyScopeType,onlyAttached : Maybe Bool,pathPrefix : Maybe String,policyUsageFilter : Maybe PolicyUsageType,marker : Maybe String,maxItems : Maybe Int
    }
...
* `arn` __:__ `String`
* `serviceNamespaces` __:__ `(List String)`
...
listPoliciesGrantingServiceAccess arn serviceNamespaces setOptions =
    ...
    let
        requestInput = ListPoliciesGrantingServiceAccessRequest
        ...
        options = setOptions (ListPoliciesGrantingServiceAccessOptions Nothing)
...
listPolicyVersions policyArn setOptions =
    ...
    let
        requestInput = ListPolicyVersionsRequest
...
listRolePolicies roleName setOptions =
    ...
    let
        requestInput = ListRolePoliciesRequest
...
listRoleTags roleName setOptions =
    ...
    let
        requestInput = ListRoleTagsRequest
        ...
        options = setOptions (ListRoleTagsOptions Nothing Nothing)
...
listSAMLProviders :
    ...
    AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper ListSAMLProvidersResponse)

listSAMLProviders =
    
    let
        requestInput = ListSAMLProvidersRequest
...
listSSHPublicKeys setOptions =
    ...
    let
        requestInput = ListSSHPublicKeysRequest
...
listServerCertificates setOptions =
    ...
    let
        requestInput = ListServerCertificatesRequest
...
listServiceSpecificCredentials setOptions =
    ...
    let
        requestInput = ListServiceSpecificCredentialsRequest
...
type alias ListServiceSpecificCredentialsOptions =
    {
    userName : Maybe String,serviceName : Maybe String
    }
...
listSigningCertificates setOptions =
    ...
    let
        requestInput = ListSigningCertificatesRequest
...
listUserPolicies userName setOptions =
    ...
    let
        requestInput = ListUserPoliciesRequest
...
listUserTags userName setOptions =
    ...
    let
        requestInput = ListUserTagsRequest
        ...
        options = setOptions (ListUserTagsOptions Nothing Nothing)
...
listVirtualMFADevices setOptions =
    ...
    let
        requestInput = ListVirtualMFADevicesRequest
...
type alias ListVirtualMFADevicesOptions =
    {
    assignmentStatus : Maybe AssignmentStatusType,marker : Maybe String,maxItems : Maybe Int
    }
...
putGroupPolicy groupName policyName policyDocument =
    ...
    let
        requestInput = PutGroupPolicyRequest
...
* `roleName` __:__ `String`
* `permissionsBoundary` __:__ `String`
...
putRolePermissionsBoundary roleName permissionsBoundary =
    ...
    let
        requestInput = PutRolePermissionsBoundaryRequest
...
putRolePolicy roleName policyName policyDocument =
    ...
    let
        requestInput = PutRolePolicyRequest
...
putUserPermissionsBoundary userName permissionsBoundary =
    ...
    let
        requestInput = PutUserPermissionsBoundaryRequest
...
putUserPolicy userName policyName policyDocument =
    ...
    let
        requestInput = PutUserPolicyRequest
...
removeClientIDFromOpenIDConnectProvider openIDConnectProviderArn clientID =
    ...
    let
        requestInput = RemoveClientIDFromOpenIDConnectProviderRequest
...
removeRoleFromInstanceProfile instanceProfileName roleName =
    ...
    let
        requestInput = RemoveRoleFromInstanceProfileRequest
...
removeUserFromGroup groupName userName =
    ...
    let
        requestInput = RemoveUserFromGroupRequest
...
resetServiceSpecificCredential serviceSpecificCredentialId setOptions =
    ...
    let
        requestInput = ResetServiceSpecificCredentialRequest
...
resyncMFADevice userName serialNumber authenticationCode1 authenticationCode2 =
    ...
    let
        requestInput = ResyncMFADeviceRequest
...
setDefaultPolicyVersion policyArn versionId =
    ...
    let
        requestInput = SetDefaultPolicyVersionRequest
...
* `globalEndpointTokenVersion` __:__ `GlobalEndpointTokenVersion`
...
setSecurityTokenServicePreferences globalEndpointTokenVersion =
    ...
    let
        requestInput = SetSecurityTokenServicePreferencesRequest
...
simulateCustomPolicy policyInputList actionNames setOptions =
    ...
    let
        requestInput = SimulateCustomPolicyRequest
...
type alias SimulateCustomPolicyOptions =
    {
    resourceArns : Maybe (List String),resourcePolicy : Maybe String,resourceOwner : Maybe String,callerArn : Maybe String,contextEntries : Maybe (List ContextEntry),resourceHandlingOption : Maybe String,maxItems : Maybe Int,marker : Maybe String
    }
...
simulatePrincipalPolicy policySourceArn actionNames setOptions =
    ...
    let
        requestInput = SimulatePrincipalPolicyRequest
...
type alias SimulatePrincipalPolicyOptions =
    {
    policyInputList : Maybe (List String),resourceArns : Maybe (List String),resourcePolicy : Maybe String,resourceOwner : Maybe String,callerArn : Maybe String,contextEntries : Maybe (List ContextEntry),resourceHandlingOption : Maybe String,maxItems : Maybe Int,marker : Maybe String
    }
...
updateAccessKey accessKeyId status setOptions =
    ...
    let
        requestInput = UpdateAccessKeyRequest
...
updateAccountPasswordPolicy setOptions =
    ...
    let
        requestInput = UpdateAccountPasswordPolicyRequest
...
type alias UpdateAccountPasswordPolicyOptions =
    {
    minimumPasswordLength : Maybe Int,requireSymbols : Maybe Bool,requireNumbers : Maybe Bool,requireUppercaseCharacters : Maybe Bool,requireLowercaseCharacters : Maybe Bool,allowUsersToChangePassword : Maybe Bool,maxPasswordAge : Maybe Int,passwordReusePrevention : Maybe Int,hardExpiry : Maybe Bool
    }
...
updateAssumeRolePolicy roleName policyDocument =
    ...
    let
        requestInput = UpdateAssumeRolePolicyRequest
...
type alias UpdateGroupOptions =
    {
    newPath : Maybe String,newGroupName : Maybe String
    }
...
updateLoginProfile userName setOptions =
    ...
    let
        requestInput = UpdateLoginProfileRequest
...
type alias UpdateLoginProfileOptions =
    {
    password : Maybe String,passwordResetRequired : Maybe Bool
    }
...
updateOpenIDConnectProviderThumbprint openIDConnectProviderArn thumbprintList =
    ...
    let
        requestInput = UpdateOpenIDConnectProviderThumbprintRequest
...
updateRole roleName setOptions =
    ...
    let
        requestInput = UpdateRoleRequest
        ...
        options = setOptions (UpdateRoleOptions Nothing Nothing)
...
type alias UpdateRoleOptions =
    {
    description : Maybe String,maxSessionDuration : Maybe Int
    }
...
updateRoleDescription roleName description =
    ...
    let
        requestInput = UpdateRoleDescriptionRequest
...
updateSAMLProvider sAMLMetadataDocument sAMLProviderArn =
    ...
    let
        requestInput = UpdateSAMLProviderRequest
...
updateSSHPublicKey userName sSHPublicKeyId status =
    ...
    let
        requestInput = UpdateSSHPublicKeyRequest
...
updateServerCertificate serverCertificateName setOptions =
    ...
    let
        requestInput = UpdateServerCertificateRequest
...
type alias UpdateServerCertificateOptions =
    {
    newPath : Maybe String,newServerCertificateName : Maybe String
    }
...
updateServiceSpecificCredential serviceSpecificCredentialId status setOptions =
    ...
    let
        requestInput = UpdateServiceSpecificCredentialRequest
...
updateSigningCertificate certificateId status setOptions =
    ...
    let
        requestInput = UpdateSigningCertificateRequest
...
updateUser userName setOptions =
    ...
    let
        requestInput = UpdateUserRequest
...
type alias UpdateUserOptions =
    {
    newPath : Maybe String,newUserName : Maybe String
    }
...
uploadSSHPublicKey userName sSHPublicKeyBody =
    ...
    let
        requestInput = UploadSSHPublicKeyRequest
...
uploadServerCertificate serverCertificateName certificateBody privateKey setOptions =
    ...
    let
        requestInput = UploadServerCertificateRequest
...
type alias UploadServerCertificateOptions =
    {
    path : Maybe String,certificateChain : Maybe String
    }
...
uploadSigningCertificate certificateBody setOptions =
    ...
    let
        requestInput = UploadSigningCertificateRequest
...
accessDetailToString : AccessDetail -> String -- List (String, String)
accessDetailToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "lastAuthenticatedTime" "" -- val.lastAuthenticatedTime
        
    --     |> Dict.insert
    --         "totalAuthenticatedEntities" "" -- val.totalAuthenticatedEntities
...
accessKeyToString : AccessKey -> String -- List (String, String)
accessKeyToString val =
    -- Dict.empty
...
accessKeyLastUsedToString : AccessKeyLastUsed -> String -- List (String, String)
accessKeyLastUsedToString val =
    -- Dict.empty
...
accessKeyMetadataToString : AccessKeyMetadata -> String -- List (String, String)
accessKeyMetadataToString val =
    -- Dict.empty
...
attachedPermissionsBoundaryToString : AttachedPermissionsBoundary -> String -- List (String, String)
attachedPermissionsBoundaryToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "permissionsBoundaryType" "" -- val.permissionsBoundaryType
...
attachedPolicyToString : AttachedPolicy -> String -- List (String, String)
attachedPolicyToString val =
    -- Dict.empty
...
contextEntryToString : ContextEntry -> String -- List (String, String)
contextEntryToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "contextKeyName" "" -- val.contextKeyName
        
    --     |> Dict.insert
    --         "contextKeyValues" "" -- val.contextKeyValues
        
    --     |> Dict.insert
    --         "contextKeyType" "" -- val.contextKeyType
...
createAccessKeyResponseToString : CreateAccessKeyResponse -> String -- List (String, String)
createAccessKeyResponseToString val =
    -- Dict.empty
...
createInstanceProfileResponseToString : CreateInstanceProfileResponse -> String -- List (String, String)
createInstanceProfileResponseToString val =
    -- Dict.empty
...
createLoginProfileResponseToString : CreateLoginProfileResponse -> String -- List (String, String)
createLoginProfileResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "loginProfile" "" -- val.loginProfile
...
createOpenIDConnectProviderResponseToString : CreateOpenIDConnectProviderResponse -> String -- List (String, String)
createOpenIDConnectProviderResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "openIDConnectProviderArn" "" -- val.openIDConnectProviderArn
...
createPolicyResponseToString : CreatePolicyResponse -> String -- List (String, String)
createPolicyResponseToString val =
    -- Dict.empty
...
createPolicyVersionResponseToString : CreatePolicyVersionResponse -> String -- List (String, String)
createPolicyVersionResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "policyVersion" "" -- val.policyVersion
...
createRoleResponseToString : CreateRoleResponse -> String -- List (String, String)
createRoleResponseToString val =
    -- Dict.empty
...
createSAMLProviderResponseToString : CreateSAMLProviderResponse -> String -- List (String, String)
createSAMLProviderResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "sAMLProviderArn" "" -- val.sAMLProviderArn
...
createServiceLinkedRoleResponseToString : CreateServiceLinkedRoleResponse -> String -- List (String, String)
createServiceLinkedRoleResponseToString val =
    -- Dict.empty
...
createServiceSpecificCredentialResponseToString : CreateServiceSpecificCredentialResponse -> String -- List (String, String)
createServiceSpecificCredentialResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "serviceSpecificCredential" "" -- val.serviceSpecificCredential
...
createUserResponseToString : CreateUserResponse -> String -- List (String, String)
createUserResponseToString val =
    -- Dict.empty
...
createVirtualMFADeviceResponseToString : CreateVirtualMFADeviceResponse -> String -- List (String, String)
createVirtualMFADeviceResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "virtualMFADevice" "" -- val.virtualMFADevice
...
deleteServiceLinkedRoleResponseToString : DeleteServiceLinkedRoleResponse -> String -- List (String, String)
deleteServiceLinkedRoleResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "deletionTaskId" "" -- val.deletionTaskId
...
deletionTaskFailureReasonTypeToString : DeletionTaskFailureReasonType -> String -- List (String, String)
deletionTaskFailureReasonTypeToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "roleUsageList" "" -- val.roleUsageList
...
entityDetailsToString : EntityDetails -> String -- List (String, String)
entityDetailsToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "entityInfo" "" -- val.entityInfo
        
    --     |> Dict.insert
    --         "lastAuthenticated" "" -- val.lastAuthenticated
...
entityInfoToString : EntityInfo -> String -- List (String, String)
entityInfoToString val =
    -- Dict.empty
...
evaluationResultToString : EvaluationResult -> String -- List (String, String)
evaluationResultToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "evalActionName" "" -- val.evalActionName
        
    --     |> Dict.insert
    --         "evalResourceName" "" -- val.evalResourceName
        
    --     |> Dict.insert
    --         "evalDecision" "" -- val.evalDecision
        
    --     |> Dict.insert
    --         "matchedStatements" "" -- val.matchedStatements
        
    --     |> Dict.insert
    --         "missingContextValues" "" -- val.missingContextValues
        
    --     |> Dict.insert
    --         "organizationsDecisionDetail" "" -- val.organizationsDecisionDetail
        
    --     |> Dict.insert
    --         "evalDecisionDetails" "" -- val.evalDecisionDetails
        
    --     |> Dict.insert
    --         "resourceSpecificResults" "" -- val.resourceSpecificResults
...
generateCredentialReportResponseToString : GenerateCredentialReportResponse -> String -- List (String, String)
generateCredentialReportResponseToString val =
    -- Dict.empty
...
generateOrganizationsAccessReportResponseToString : GenerateOrganizationsAccessReportResponse -> String -- List (String, String)
generateOrganizationsAccessReportResponseToString val =
    -- Dict.empty
...
generateServiceLastAccessedDetailsResponseToString : GenerateServiceLastAccessedDetailsResponse -> String -- List (String, String)
generateServiceLastAccessedDetailsResponseToString val =
    -- Dict.empty
...
getAccessKeyLastUsedResponseToString : GetAccessKeyLastUsedResponse -> String -- List (String, String)
getAccessKeyLastUsedResponseToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "accessKeyLastUsed" "" -- val.accessKeyLastUsed
...
getAccountAuthorizationDetailsResponseToString : GetAccountAuthorizationDetailsResponse -> String -- List (String, String)
getAccountAuthorizationDetailsResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "userDetailList" "" -- val.userDetailList
        
    --     |> Dict.insert
    --         "groupDetailList" "" -- val.groupDetailList
        
    --     |> Dict.insert
    --         "roleDetailList" "" -- val.roleDetailList
...
getAccountPasswordPolicyResponseToString : GetAccountPasswordPolicyResponse -> String -- List (String, String)
getAccountPasswordPolicyResponseToString val =
    -- Dict.empty
...
getAccountSummaryResponseToString : GetAccountSummaryResponse -> String -- List (String, String)
getAccountSummaryResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "summaryMap" "" -- val.summaryMap
...
getContextKeysForPolicyResponseToString : GetContextKeysForPolicyResponse -> String -- List (String, String)
getContextKeysForPolicyResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "contextKeyNames" "" -- val.contextKeyNames
...
getCredentialReportResponseToString : GetCredentialReportResponse -> String -- List (String, String)
getCredentialReportResponseToString val =
    -- Dict.empty
...
getGroupPolicyResponseToString : GetGroupPolicyResponse -> String -- List (String, String)
getGroupPolicyResponseToString val =
    -- Dict.empty
...
getInstanceProfileResponseToString : GetInstanceProfileResponse -> String -- List (String, String)
getInstanceProfileResponseToString val =
    -- Dict.empty
...
getLoginProfileResponseToString : GetLoginProfileResponse -> String -- List (String, String)
getLoginProfileResponseToString val =
    -- Dict.empty
...
getOpenIDConnectProviderResponseToString : GetOpenIDConnectProviderResponse -> String -- List (String, String)
getOpenIDConnectProviderResponseToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "clientIDList" "" -- val.clientIDList
        
    --     |> Dict.insert
    --         "thumbprintList" "" -- val.thumbprintList
...
getOrganizationsAccessReportResponseToString : GetOrganizationsAccessReportResponse -> String -- List (String, String)
getOrganizationsAccessReportResponseToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "jobCreationDate" "" -- val.jobCreationDate
        
    --     |> Dict.insert
    --         "jobCompletionDate" "" -- val.jobCompletionDate
        
    --     |> Dict.insert
    --         "numberOfServicesAccessible" "" -- val.numberOfServicesAccessible
        
    --     |> Dict.insert
    --         "numberOfServicesNotAccessed" "" -- val.numberOfServicesNotAccessed
...
getPolicyResponseToString : GetPolicyResponse -> String -- List (String, String)
getPolicyResponseToString val =
    -- Dict.empty
...
getPolicyVersionResponseToString : GetPolicyVersionResponse -> String -- List (String, String)
getPolicyVersionResponseToString val =
    -- Dict.empty
...
getRolePolicyResponseToString : GetRolePolicyResponse -> String -- List (String, String)
getRolePolicyResponseToString val =
    -- Dict.empty
...
getRoleResponseToString : GetRoleResponse -> String -- List (String, String)
getRoleResponseToString val =
    -- Dict.empty
...
getSAMLProviderResponseToString : GetSAMLProviderResponse -> String -- List (String, String)
getSAMLProviderResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "sAMLMetadataDocument" "" -- val.sAMLMetadataDocument
...
getSSHPublicKeyResponseToString : GetSSHPublicKeyResponse -> String -- List (String, String)
getSSHPublicKeyResponseToString val =
    -- Dict.empty
...
getServerCertificateResponseToString : GetServerCertificateResponse -> String -- List (String, String)
getServerCertificateResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "serverCertificate" "" -- val.serverCertificate
...
getServiceLastAccessedDetailsResponseToString : GetServiceLastAccessedDetailsResponse -> String -- List (String, String)
getServiceLastAccessedDetailsResponseToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "servicesLastAccessed" "" -- val.servicesLastAccessed
...
getServiceLastAccessedDetailsWithEntitiesResponseToString : GetServiceLastAccessedDetailsWithEntitiesResponse -> String -- List (String, String)
getServiceLastAccessedDetailsWithEntitiesResponseToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "entityDetailsList" "" -- val.entityDetailsList
...
getServiceLinkedRoleDeletionStatusResponseToString : GetServiceLinkedRoleDeletionStatusResponse -> String -- List (String, String)
getServiceLinkedRoleDeletionStatusResponseToString val =
    -- Dict.empty
...
getUserPolicyResponseToString : GetUserPolicyResponse -> String -- List (String, String)
getUserPolicyResponseToString val =
    -- Dict.empty
...
groupToString : Group -> String -- List (String, String)
groupToString val =
    -- Dict.empty
...
groupDetailToString : GroupDetail -> String -- List (String, String)
groupDetailToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "groupPolicyList" "" -- val.groupPolicyList
        
    --     |> Dict.insert
    --         "attachedManagedPolicies" "" -- val.attachedManagedPolicies
...
instanceProfileToString val =
    ...
    --     |> Dict.insert
    --         "instanceProfileName" "" -- val.instanceProfileName
        
    --     |> Dict.insert
    --         "instanceProfileId" "" -- val.instanceProfileId
...
listAccessKeysResponseToString : ListAccessKeysResponse -> String -- List (String, String)
listAccessKeysResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "accessKeyMetadata" "" -- val.accessKeyMetadata
...
listAccountAliasesResponseToString : ListAccountAliasesResponse -> String -- List (String, String)
listAccountAliasesResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "accountAliases" "" -- val.accountAliases
...
listAttachedGroupPoliciesResponseToString : ListAttachedGroupPoliciesResponse -> String -- List (String, String)
listAttachedGroupPoliciesResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "attachedPolicies" "" -- val.attachedPolicies
...
listAttachedRolePoliciesResponseToString : ListAttachedRolePoliciesResponse -> String -- List (String, String)
listAttachedRolePoliciesResponseToString val =
    -- Dict.empty
...
listAttachedUserPoliciesResponseToString : ListAttachedUserPoliciesResponse -> String -- List (String, String)
listAttachedUserPoliciesResponseToString val =
    -- Dict.empty
...
listEntitiesForPolicyResponseToString : ListEntitiesForPolicyResponse -> String -- List (String, String)
listEntitiesForPolicyResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "policyGroups" "" -- val.policyGroups
        
    --     |> Dict.insert
    --         "policyUsers" "" -- val.policyUsers
        
    --     |> Dict.insert
    --         "policyRoles" "" -- val.policyRoles
...
listGroupPoliciesResponseToString : ListGroupPoliciesResponse -> String -- List (String, String)
listGroupPoliciesResponseToString val =
    -- Dict.empty
...
listGroupsForUserResponseToString : ListGroupsForUserResponse -> String -- List (String, String)
listGroupsForUserResponseToString val =
    -- Dict.empty
...
listInstanceProfilesForRoleResponseToString : ListInstanceProfilesForRoleResponse -> String -- List (String, String)
listInstanceProfilesForRoleResponseToString val =
    -- Dict.empty
...
listInstanceProfilesResponseToString : ListInstanceProfilesResponse -> String -- List (String, String)
listInstanceProfilesResponseToString val =
    -- Dict.empty
...
listMFADevicesResponseToString : ListMFADevicesResponse -> String -- List (String, String)
listMFADevicesResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "mFADevices" "" -- val.mFADevices
...
listOpenIDConnectProvidersResponseToString : ListOpenIDConnectProvidersResponse -> String -- List (String, String)
listOpenIDConnectProvidersResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "openIDConnectProviderList" "" -- val.openIDConnectProviderList
...
listPoliciesGrantingServiceAccessEntryToString : ListPoliciesGrantingServiceAccessEntry -> String -- List (String, String)
listPoliciesGrantingServiceAccessEntryToString val =
    -- Dict.empty
...
listPoliciesGrantingServiceAccessResponseToString : ListPoliciesGrantingServiceAccessResponse -> String -- List (String, String)
listPoliciesGrantingServiceAccessResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "policiesGrantingServiceAccess" "" -- val.policiesGrantingServiceAccess
...
listPoliciesResponseToString : ListPoliciesResponse -> String -- List (String, String)
listPoliciesResponseToString val =
    -- Dict.empty
...
listPolicyVersionsResponseToString : ListPolicyVersionsResponse -> String -- List (String, String)
listPolicyVersionsResponseToString val =
    -- Dict.empty
...
listRolePoliciesResponseToString : ListRolePoliciesResponse -> String -- List (String, String)
listRolePoliciesResponseToString val =
    -- Dict.empty
...
listRoleTagsResponseToString : ListRoleTagsResponse -> String -- List (String, String)
listRoleTagsResponseToString val =
    -- Dict.empty
...
listRolesResponseToString : ListRolesResponse -> String -- List (String, String)
listRolesResponseToString val =
    -- Dict.empty
...
listSAMLProvidersResponseToString : ListSAMLProvidersResponse -> String -- List (String, String)
listSAMLProvidersResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "sAMLProviderList" "" -- val.sAMLProviderList
...
listSSHPublicKeysResponseToString : ListSSHPublicKeysResponse -> String -- List (String, String)
listSSHPublicKeysResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "sSHPublicKeys" "" -- val.sSHPublicKeys
...
listServerCertificatesResponseToString : ListServerCertificatesResponse -> String -- List (String, String)
listServerCertificatesResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "serverCertificateMetadataList" "" -- val.serverCertificateMetadataList
...
listServiceSpecificCredentialsResponseToString : ListServiceSpecificCredentialsResponse -> String -- List (String, String)
listServiceSpecificCredentialsResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "serviceSpecificCredentials" "" -- val.serviceSpecificCredentials
...
listSigningCertificatesResponseToString : ListSigningCertificatesResponse -> String -- List (String, String)
listSigningCertificatesResponseToString val =
    -- Dict.empty
...
listUserPoliciesResponseToString : ListUserPoliciesResponse -> String -- List (String, String)
listUserPoliciesResponseToString val =
    -- Dict.empty
...
listUserTagsResponseToString : ListUserTagsResponse -> String -- List (String, String)
listUserTagsResponseToString val =
    -- Dict.empty
...
listVirtualMFADevicesResponseToString : ListVirtualMFADevicesResponse -> String -- List (String, String)
listVirtualMFADevicesResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "virtualMFADevices" "" -- val.virtualMFADevices
...
loginProfileToString : LoginProfile -> String -- List (String, String)
loginProfileToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "passwordResetRequired" "" -- val.passwordResetRequired
...
mFADeviceToString : MFADevice -> String -- List (String, String)
mFADeviceToString val =
    -- Dict.empty
...
managedPolicyDetailToString : ManagedPolicyDetail -> String -- List (String, String)
managedPolicyDetailToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "policyVersionList" "" -- val.policyVersionList
...
openIDConnectProviderListEntryToString : OpenIDConnectProviderListEntry -> String -- List (String, String)
openIDConnectProviderListEntryToString val =
    -- Dict.empty
...
organizationsDecisionDetailToString : OrganizationsDecisionDetail -> String -- List (String, String)
organizationsDecisionDetailToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "allowedByOrganizations" "" -- val.allowedByOrganizations
...
passwordPolicyToString : PasswordPolicy -> String -- List (String, String)
passwordPolicyToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "minimumPasswordLength" "" -- val.minimumPasswordLength
    ...
    --     |> Dict.insert
    --         "requireUppercaseCharacters" "" -- val.requireUppercaseCharacters
        
    --     |> Dict.insert
    --         "requireLowercaseCharacters" "" -- val.requireLowercaseCharacters
        
    --     |> Dict.insert
    --         "allowUsersToChangePassword" "" -- val.allowUsersToChangePassword
        
    --     |> Dict.insert
    --         "expirePasswords" "" -- val.expirePasswords
        
    --     |> Dict.insert
    --         "maxPasswordAge" "" -- val.maxPasswordAge
        
    --     |> Dict.insert
    --         "passwordReusePrevention" "" -- val.passwordReusePrevention
        
    --     |> Dict.insert
    --         "hardExpiry" "" -- val.hardExpiry
...
policyToString : Policy -> String -- List (String, String)
policyToString val =
    -- Dict.empty
...
policyDetailToString : PolicyDetail -> String -- List (String, String)
policyDetailToString val =
    -- Dict.empty
...
policyGrantingServiceAccessToString : PolicyGrantingServiceAccess -> String -- List (String, String)
policyGrantingServiceAccessToString val =
    -- Dict.empty
...
policyGroupToString : PolicyGroup -> String -- List (String, String)
policyGroupToString val =
    -- Dict.empty
...
policyRoleToString : PolicyRole -> String -- List (String, String)
policyRoleToString val =
    -- Dict.empty
...
policyUserToString : PolicyUser -> String -- List (String, String)
policyUserToString val =
    -- Dict.empty
...
policyVersionToString : PolicyVersion -> String -- List (String, String)
policyVersionToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "isDefaultVersion" "" -- val.isDefaultVersion
...
positionToString : Position -> String -- List (String, String)
...
resetServiceSpecificCredentialResponseToString : ResetServiceSpecificCredentialResponse -> String -- List (String, String)
resetServiceSpecificCredentialResponseToString val =
    -- Dict.empty
...
resourceSpecificResultToString : ResourceSpecificResult -> String -- List (String, String)
resourceSpecificResultToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "evalResourceDecision" "" -- val.evalResourceDecision
...
roleToString : Role -> String -- List (String, String)
roleToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "assumeRolePolicyDocument" "" -- val.assumeRolePolicyDocument
    ...
    --     |> Dict.insert
    --         "permissionsBoundary" "" -- val.permissionsBoundary
...
roleDetailToString : RoleDetail -> String -- List (String, String)
roleDetailToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "instanceProfileList" "" -- val.instanceProfileList
        
    --     |> Dict.insert
    --         "rolePolicyList" "" -- val.rolePolicyList
...
roleUsageTypeToString : RoleUsageType -> String -- List (String, String)
roleUsageTypeToString val =
    -- Dict.empty
...
sAMLProviderListEntryToString : SAMLProviderListEntry -> String -- List (String, String)
sAMLProviderListEntryToString val =
    -- Dict.empty
...
sSHPublicKeyToString : SSHPublicKey -> String -- List (String, String)
sSHPublicKeyToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "sSHPublicKeyId" "" -- val.sSHPublicKeyId
        
    --     |> Dict.insert
    --         "fingerprint" "" -- val.fingerprint
        
    --     |> Dict.insert
    --         "sSHPublicKeyBody" "" -- val.sSHPublicKeyBody
...
sSHPublicKeyMetadataToString : SSHPublicKeyMetadata -> String -- List (String, String)
sSHPublicKeyMetadataToString val =
    -- Dict.empty
...
serverCertificateToString : ServerCertificate -> String -- List (String, String)
serverCertificateToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "serverCertificateMetadata" "" -- val.serverCertificateMetadata
        
    --     |> Dict.insert
    --         "certificateBody" "" -- val.certificateBody
...
serverCertificateMetadataToString : ServerCertificateMetadata -> String -- List (String, String)
serverCertificateMetadataToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "serverCertificateName" "" -- val.serverCertificateName
        
    --     |> Dict.insert
    --         "serverCertificateId" "" -- val.serverCertificateId
...
serviceLastAccessedToString : ServiceLastAccessed -> String -- List (String, String)
serviceLastAccessedToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "lastAuthenticatedEntity" "" -- val.lastAuthenticatedEntity
...
serviceSpecificCredentialToString : ServiceSpecificCredential -> String -- List (String, String)
serviceSpecificCredentialToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "servicePassword" "" -- val.servicePassword
        
    --     |> Dict.insert
    --         "serviceSpecificCredentialId" "" -- val.serviceSpecificCredentialId
...
serviceSpecificCredentialMetadataToString : ServiceSpecificCredentialMetadata -> String -- List (String, String)
serviceSpecificCredentialMetadataToString val =
    -- Dict.empty
...
signingCertificateToString : SigningCertificate -> String -- List (String, String)
signingCertificateToString val =
    -- Dict.empty
...
simulatePolicyResponseToString : SimulatePolicyResponse -> String -- List (String, String)
simulatePolicyResponseToString val =
    -- Dict.empty
...
statementToString : Statement -> String -- List (String, String)
statementToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "sourcePolicyId" "" -- val.sourcePolicyId
        
    --     |> Dict.insert
    --         "sourcePolicyType" "" -- val.sourcePolicyType
...
updateRoleDescriptionResponseToString : UpdateRoleDescriptionResponse -> String -- List (String, String)
updateRoleDescriptionResponseToString val =
    -- Dict.empty
...
updateRoleResponseToString : UpdateRoleResponse -> String -- List (String, String)
updateRoleResponseToString val =
    -- Dict.empty
...
updateSAMLProviderResponseToString : UpdateSAMLProviderResponse -> String -- List (String, String)
updateSAMLProviderResponseToString val =
    -- Dict.empty
...
uploadSSHPublicKeyResponseToString : UploadSSHPublicKeyResponse -> String -- List (String, String)
uploadSSHPublicKeyResponseToString val =
    -- Dict.empty
...
uploadServerCertificateResponseToString : UploadServerCertificateResponse -> String -- List (String, String)
uploadServerCertificateResponseToString val =
    -- Dict.empty
...
uploadSigningCertificateResponseToString : UploadSigningCertificateResponse -> String -- List (String, String)
uploadSigningCertificateResponseToString val =
    -- Dict.empty
...
userToString val =
    ...
    --     |> Dict.insert
    --         "passwordLastUsed" "" -- val.passwordLastUsed
...
userDetailToString : UserDetail -> String -- List (String, String)
userDetailToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "userPolicyList" "" -- val.userPolicyList
...
virtualMFADeviceToString : VirtualMFADevice -> String -- List (String, String)
virtualMFADeviceToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "base32StringSeed" "" -- val.base32StringSeed
        
    --     |> Dict.insert
    --         "qRCodePNG" "" -- val.qRCodePNG
