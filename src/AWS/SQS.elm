module AWS.SQS exposing
    ( service
    , addPermission, changeMessageVisibility, changeMessageVisibilityBatch, createQueue, CreateQueueOptions, deleteMessage, deleteMessageBatch, deleteQueue, getQueueAttributes, GetQueueAttributesOptions, getQueueUrl, GetQueueUrlOptions, listDeadLetterSourceQueues, listQueueTags, listQueues, ListQueuesOptions, purgeQueue, receiveMessage, ReceiveMessageOptions, removePermission, sendMessage, SendMessageOptions, sendMessageBatch, setQueueAttributes, tagQueue, untagQueue
    , ChangeMessageVisibilityBatchResult, CreateQueueResult, DeleteMessageBatchResult, GetQueueAttributesResult, GetQueueUrlResult, ListDeadLetterSourceQueuesResult, ListQueueTagsResult, ListQueuesResult, ReceiveMessageResult, SendMessageBatchResult, SendMessageResult
    , BatchResultErrorEntry, ChangeMessageVisibilityBatchRequestEntry, ChangeMessageVisibilityBatchResultEntry, DeleteMessageBatchRequestEntry, DeleteMessageBatchResultEntry, Message, MessageAttributeValue, SendMessageBatchRequestEntry, SendMessageBatchResultEntry
...
createQueue queueName setOptions =
    let
        ...
        options =
            setOptions (CreateQueueOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
getQueueAttributes queueUrl setOptions =
    let
        ...
        options =
            setOptions (GetQueueAttributesOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
getQueueUrl queueName setOptions =
    let
        ...
        options =
            setOptions (GetQueueUrlOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listQueues setOptions =
    let
        ...
        options =
            setOptions (ListQueuesOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
receiveMessage queueUrl setOptions =
    let
        ...
        options =
            setOptions (ReceiveMessageOptions Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
sendMessage queueUrl messageBody setOptions =
    let
        ...
        options =
            setOptions (SendMessageOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
