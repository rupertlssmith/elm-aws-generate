module AWS.CodeCommit exposing
    ( service
...
batchDescribeMergeConflicts repositoryName destinationCommitSpecifier sourceCommitSpecifier mergeOption setOptions =
    let
        ...
        options =
            setOptions (BatchDescribeMergeConflictsOptions Nothing Nothing Nothing Nothing Nothing Nothing)
    in
...
createCommit repositoryName branchName setOptions =
    let
        ...
        options =
            setOptions (CreateCommitOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createPullRequest title targets setOptions =
    let
        ...
        options =
            setOptions (CreatePullRequestOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createRepository repositoryName setOptions =
    let
        ...
        options =
            setOptions (CreateRepositoryOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createUnreferencedMergeCommit repositoryName sourceCommitSpecifier destinationCommitSpecifier mergeOption setOptions =
    let
        ...
        options =
            setOptions (CreateUnreferencedMergeCommitOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
deleteFile repositoryName branchName filePath parentCommitId setOptions =
    let
        ...
        options =
            setOptions (DeleteFileOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeMergeConflicts repositoryName destinationCommitSpecifier sourceCommitSpecifier mergeOption filePath setOptions =
    let
        ...
        options =
            setOptions (DescribeMergeConflictsOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describePullRequestEvents pullRequestId setOptions =
    let
        ...
        options =
            setOptions (DescribePullRequestEventsOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
getBranch setOptions =
    let
        ...
        options =
            setOptions (GetBranchOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
getCommentsForComparedCommit repositoryName afterCommitId setOptions =
    let
        ...
        options =
            setOptions (GetCommentsForComparedCommitOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
getCommentsForPullRequest pullRequestId setOptions =
    let
        ...
        options =
            setOptions (GetCommentsForPullRequestOptions Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
getDifferences repositoryName afterCommitSpecifier setOptions =
    let
        ...
        options =
            setOptions (GetDifferencesOptions Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
getFile repositoryName filePath setOptions =
    let
        ...
        options =
            setOptions (GetFileOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
getFolder repositoryName folderPath setOptions =
    let
        ...
        options =
            setOptions (GetFolderOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
getMergeCommit repositoryName sourceCommitSpecifier destinationCommitSpecifier setOptions =
    let
        ...
        options =
            setOptions (GetMergeCommitOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
getMergeConflicts repositoryName destinationCommitSpecifier sourceCommitSpecifier mergeOption setOptions =
    let
        ...
        options =
            setOptions (GetMergeConflictsOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
getMergeOptions repositoryName sourceCommitSpecifier destinationCommitSpecifier setOptions =
    let
        ...
        options =
            setOptions (GetMergeOptionsOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listBranches repositoryName setOptions =
    let
        ...
        options =
            setOptions (ListBranchesOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listPullRequests repositoryName setOptions =
    let
        ...
        options =
            setOptions (ListPullRequestsOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listRepositories setOptions =
    let
        ...
        options =
            setOptions (ListRepositoriesOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
mergeBranchesByFastForward repositoryName sourceCommitSpecifier destinationCommitSpecifier setOptions =
    let
        ...
        options =
            setOptions (MergeBranchesByFastForwardOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
mergeBranchesBySquash repositoryName sourceCommitSpecifier destinationCommitSpecifier setOptions =
    let
        ...
        options =
            setOptions (MergeBranchesBySquashOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
mergeBranchesByThreeWay repositoryName sourceCommitSpecifier destinationCommitSpecifier setOptions =
    let
        ...
        options =
            setOptions (MergeBranchesByThreeWayOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
mergePullRequestByFastForward pullRequestId repositoryName setOptions =
    let
        ...
        options =
            setOptions (MergePullRequestByFastForwardOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
mergePullRequestBySquash pullRequestId repositoryName setOptions =
    let
        ...
        options =
            setOptions (MergePullRequestBySquashOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
mergePullRequestByThreeWay pullRequestId repositoryName setOptions =
    let
        ...
        options =
            setOptions (MergePullRequestByThreeWayOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
postCommentForComparedCommit repositoryName afterCommitId content setOptions =
    let
        ...
        options =
            setOptions (PostCommentForComparedCommitOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
postCommentForPullRequest pullRequestId repositoryName beforeCommitId afterCommitId content setOptions =
    let
        ...
        options =
            setOptions (PostCommentForPullRequestOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
postCommentReply inReplyTo content setOptions =
    let
        ...
        options =
            setOptions (PostCommentReplyOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
putFile repositoryName branchName fileContent filePath setOptions =
    let
        ...
        options =
            setOptions (PutFileOptions Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
updateRepositoryDescription repositoryName setOptions =
    let
        ...
        options =
            setOptions (UpdateRepositoryDescriptionOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
batchDescribeMergeConflictsErrorToString :
...
batchDescribeMergeConflictsOutputToString :
...
batchGetRepositoriesOutputToString :
...
commentsForComparedCommitToString :
...
commentsForPullRequestToString :
...
createPullRequestOutputToString :
...
createRepositoryOutputToString :
...
createUnreferencedMergeCommitOutputToString :
...
deleteCommentContentOutputToString :
...
deleteRepositoryOutputToString :
...
describeMergeConflictsOutputToString :
...
describePullRequestEventsOutputToString :
...
getCommentsForComparedCommitOutputToString :
...
getCommentsForPullRequestOutputToString :
...
getMergeConflictsOutputToString :
...
getRepositoryTriggersOutputToString :
...
listPullRequestsOutputToString :
...
listRepositoriesOutputToString :
...
mergeBranchesByFastForwardOutputToString :
...
mergeBranchesBySquashOutputToString :
...
mergeBranchesByThreeWayOutputToString :
...
mergePullRequestByFastForwardOutputToString :
...
mergePullRequestBySquashOutputToString :
    MergePullRequestBySquashOutput
    -> String -- List (String, String)
...
mergePullRequestByThreeWayOutputToString :
    MergePullRequestByThreeWayOutput
    -> String -- List (String, String)
...
postCommentForComparedCommitOutputToString :
    PostCommentForComparedCommitOutput
    -> String -- List (String, String)
...
postCommentForPullRequestOutputToString :
...
postCommentReplyOutputToString :
...
pullRequestCreatedEventMetadataToString :
...
pullRequestMergedStateChangedEventMetadataToString :
...
pullRequestSourceReferenceUpdatedEventMetadataToString :
...
pullRequestStatusChangedEventMetadataToString :
...
putRepositoryTriggersOutputToString :
...
repositoryTriggerExecutionFailureToString :
...
testRepositoryTriggersOutputToString :
...
updatePullRequestDescriptionOutputToString :
...
updatePullRequestStatusOutputToString :
...
updatePullRequestTitleOutputToString :
