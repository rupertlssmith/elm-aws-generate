module AWS.ApplicationAutoScaling exposing
    ( service
    ...
    , DeleteScalingPolicyResponse, DeleteScheduledActionResponse, DeregisterScalableTargetResponse, DescribeScalableTargetsResponse, DescribeScalingActivitiesResponse, DescribeScalingPoliciesResponse, DescribeScheduledActionsResponse, PutScalingPolicyResponse, PutScheduledActionResponse, RegisterScalableTargetResponse
    , Alarm, CustomizedMetricSpecification, MetricDimension, PredefinedMetricSpecification, ScalableTarget, ScalableTargetAction, ScalingActivity, ScalingPolicy, ScheduledAction, StepAdjustment, StepScalingPolicyConfiguration, TargetTrackingScalingPolicyConfiguration
    , AdjustmentType(..), MetricAggregationType(..), MetricStatistic(..), MetricType(..), PolicyType(..), ScalableDimension(..), ScalingActivityStatusCode(..), ServiceNamespace(..)
    )
...
describeScalableTargets serviceNamespace setOptions =
    let
        ...
        options =
            setOptions (DescribeScalableTargetsOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeScalingPolicies serviceNamespace setOptions =
    let
        ...
        options =
            setOptions (DescribeScalingPoliciesOptions Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeScheduledActions serviceNamespace setOptions =
    let
        ...
        options =
            setOptions (DescribeScheduledActionsOptions Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
putScalingPolicy policyName serviceNamespace resourceId scalableDimension setOptions =
    let
        ...
        options =
            setOptions (PutScalingPolicyOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
putScheduledAction serviceNamespace scheduledActionName resourceId scalableDimension setOptions =
    let
        ...
        options =
            setOptions (PutScheduledActionOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
registerScalableTarget serviceNamespace resourceId scalableDimension setOptions =
    let
        ...
        options =
            setOptions (RegisterScalableTargetOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
