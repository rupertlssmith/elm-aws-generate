module AWS.ElasticLoadBalancing exposing
    ( service
...
createLBCookieStickinessPolicy loadBalancerName policyName setOptions =
    let
        ...
        options =
            setOptions (CreateLBCookieStickinessPolicyOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createLoadBalancer loadBalancerName listeners setOptions =
    let
        ...
        options =
            setOptions (CreateLoadBalancerOptions Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createLoadBalancerPolicy loadBalancerName policyName policyTypeName setOptions =
    let
        ...
        options =
            setOptions (CreateLoadBalancerPolicyOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeInstanceHealth loadBalancerName setOptions =
    let
        ...
        options =
            setOptions (DescribeInstanceHealthOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeLoadBalancerPolicies setOptions =
    let
        ...
        options =
            setOptions (DescribeLoadBalancerPoliciesOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeLoadBalancerPolicyTypes setOptions =
    let
        ...
        options =
            setOptions (DescribeLoadBalancerPolicyTypesOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeLoadBalancers setOptions =
    let
        ...
        options =
            setOptions (DescribeLoadBalancersOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
