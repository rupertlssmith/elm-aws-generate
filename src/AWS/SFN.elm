...
createActivity name setOptions =
    let
        ...
        options =
            setOptions (CreateActivityOptions Nothing)
    in
...
createStateMachine name definition roleArn setOptions =
    let
        ...
        options =
            setOptions (CreateStateMachineOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
getActivityTask activityArn setOptions =
    let
        ...
        options =
            setOptions (GetActivityTaskOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
getExecutionHistory executionArn setOptions =
    let
        ...
        options =
            setOptions (GetExecutionHistoryOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listActivities setOptions =
    let
        ...
        options =
            setOptions (ListActivitiesOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listExecutions stateMachineArn setOptions =
    let
        ...
        options =
            setOptions (ListExecutionsOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listStateMachines setOptions =
    let
        ...
        options =
            setOptions (ListStateMachinesOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
sendTaskFailure taskToken setOptions =
    let
        ...
        options =
            setOptions (SendTaskFailureOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
startExecution stateMachineArn setOptions =
    let
        ...
        options =
            setOptions (StartExecutionOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
stopExecution executionArn setOptions =
    let
        ...
        options =
            setOptions (StopExecutionOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
updateStateMachine stateMachineArn setOptions =
    let
        ...
        options =
            setOptions (UpdateStateMachineOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
