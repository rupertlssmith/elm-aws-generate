module AWS.Route53Domains
    exposing
        ...
        , CheckDomainTransferabilityOptions
        , deleteTagsForDomain
...
checkDomainAvailability domainName setOptions =
    ...
    let
        requestInput = CheckDomainAvailabilityRequest
...
checkDomainTransferability domainName setOptions =
    ...
    let
        requestInput = CheckDomainTransferabilityRequest
        ...
        options = setOptions (CheckDomainTransferabilityOptions Nothing)
...
deleteTagsForDomain domainName tagsToDelete =
    ...
    let
        requestInput = DeleteTagsForDomainRequest
...
disableDomainAutoRenew domainName =
    ...
    let
        requestInput = DisableDomainAutoRenewRequest
...
disableDomainTransferLock domainName =
    ...
    let
        requestInput = DisableDomainTransferLockRequest
...
enableDomainAutoRenew domainName =
    ...
    let
        requestInput = EnableDomainAutoRenewRequest
...
enableDomainTransferLock domainName =
    ...
    let
        requestInput = EnableDomainTransferLockRequest
...
getContactReachabilityStatus setOptions =
    ...
    let
        requestInput = GetContactReachabilityStatusRequest
...
getDomainDetail domainName =
    ...
    let
        requestInput = GetDomainDetailRequest
...
getDomainSuggestions domainName suggestionCount onlyAvailable =
    ...
    let
        requestInput = GetDomainSuggestionsRequest
...
getOperationDetail operationId =
    ...
    let
        requestInput = GetOperationDetailRequest
...
listDomains setOptions =
    ...
    let
        requestInput = ListDomainsRequest
...
listOperations setOptions =
    ...
    let
        requestInput = ListOperationsRequest
        ...
        options = setOptions (ListOperationsOptions Nothing Nothing Nothing)
...
type alias ListOperationsOptions =
    {
    submittedSince : Maybe Posix,marker : Maybe String,maxItems : Maybe Int
    }
...
listTagsForDomain domainName =
    ...
    let
        requestInput = ListTagsForDomainRequest
...
registerDomain domainName durationInYears adminContact registrantContact techContact setOptions =
    ...
    let
        requestInput = RegisterDomainRequest
...
type alias RegisterDomainOptions =
    {
    idnLangCode : Maybe String,autoRenew : Maybe Bool,privacyProtectAdminContact : Maybe Bool,privacyProtectRegistrantContact : Maybe Bool,privacyProtectTechContact : Maybe Bool
    }
...
renewDomain domainName currentExpiryYear setOptions =
    ...
    let
        requestInput = RenewDomainRequest
...
resendContactReachabilityEmail setOptions =
    ...
    let
        requestInput = ResendContactReachabilityEmailRequest
...
retrieveDomainAuthCode domainName =
    ...
    let
        requestInput = RetrieveDomainAuthCodeRequest
...
transferDomain domainName durationInYears adminContact registrantContact techContact setOptions =
    ...
    let
        requestInput = TransferDomainRequest
...
type alias TransferDomainOptions =
    {
    idnLangCode : Maybe String,nameservers : Maybe (List Nameserver),authCode : Maybe String,autoRenew : Maybe Bool,privacyProtectAdminContact : Maybe Bool,privacyProtectRegistrantContact : Maybe Bool,privacyProtectTechContact : Maybe Bool
    }
...
updateDomainContact domainName setOptions =
    ...
    let
        requestInput = UpdateDomainContactRequest
...
type alias UpdateDomainContactOptions =
    {
    adminContact : Maybe ContactDetail,registrantContact : Maybe ContactDetail,techContact : Maybe ContactDetail
    }
...
updateDomainContactPrivacy domainName setOptions =
    ...
    let
        requestInput = UpdateDomainContactPrivacyRequest
...
type alias UpdateDomainContactPrivacyOptions =
    {
    adminPrivacy : Maybe Bool,registrantPrivacy : Maybe Bool,techPrivacy : Maybe Bool
    }
...
updateDomainNameservers domainName nameservers setOptions =
    ...
    let
        requestInput = UpdateDomainNameserversRequest
...
updateTagsForDomain domainName setOptions =
    ...
    let
        requestInput = UpdateTagsForDomainRequest
...
viewBilling setOptions =
    ...
    let
        requestInput = ViewBillingRequest
...
type alias ViewBillingOptions =
    {
    start : Maybe Posix,end : Maybe Posix,marker : Maybe String,maxItems : Maybe Int
    }
...
billingRecordToString : BillingRecord -> String -- List (String, String)
billingRecordToString val =
    -- Dict.empty
...
checkDomainAvailabilityResponseToString : CheckDomainAvailabilityResponse -> String -- List (String, String)
checkDomainAvailabilityResponseToString val =
    -- Dict.empty
...
checkDomainTransferabilityResponseToString : CheckDomainTransferabilityResponse -> String -- List (String, String)
checkDomainTransferabilityResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "transferability" "" -- val.transferability
...
contactDetailToString : ContactDetail -> String -- List (String, String)
contactDetailToString val =
    -- Dict.empty
...
deleteTagsForDomainResponseToString : DeleteTagsForDomainResponse -> String -- List (String, String)
deleteTagsForDomainResponseToString val =
    -- Dict.empty
...
disableDomainAutoRenewResponseToString : DisableDomainAutoRenewResponse -> String -- List (String, String)
disableDomainAutoRenewResponseToString val =
    -- Dict.empty
...
disableDomainTransferLockResponseToString : DisableDomainTransferLockResponse -> String -- List (String, String)
disableDomainTransferLockResponseToString val =
    -- Dict.empty
...
domainLimitExceededToString : DomainLimitExceeded -> String -- List (String, String)
domainLimitExceededToString val =
    -- Dict.empty
...
domainSuggestionToString : DomainSuggestion -> String -- List (String, String)
domainSuggestionToString val =
    -- Dict.empty
...
domainSummaryToString : DomainSummary -> String -- List (String, String)
domainSummaryToString val =
    -- Dict.empty
...
domainTransferabilityToString : DomainTransferability -> String -- List (String, String)
domainTransferabilityToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "transferable" "" -- val.transferable
...
duplicateRequestToString : DuplicateRequest -> String -- List (String, String)
duplicateRequestToString val =
    -- Dict.empty
...
enableDomainAutoRenewResponseToString : EnableDomainAutoRenewResponse -> String -- List (String, String)
enableDomainAutoRenewResponseToString val =
    -- Dict.empty
...
enableDomainTransferLockResponseToString : EnableDomainTransferLockResponse -> String -- List (String, String)
enableDomainTransferLockResponseToString val =
    -- Dict.empty
...
extraParamToString : ExtraParam -> String -- List (String, String)
extraParamToString val =
    -- Dict.empty
...
getContactReachabilityStatusResponseToString : GetContactReachabilityStatusResponse -> String -- List (String, String)
getContactReachabilityStatusResponseToString val =
    -- Dict.empty
...
getDomainDetailResponseToString : GetDomainDetailResponse -> String -- List (String, String)
getDomainDetailResponseToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "adminContact" "" -- val.adminContact
        
    --     |> Dict.insert
    --         "registrantContact" "" -- val.registrantContact
        
    --     |> Dict.insert
    --         "techContact" "" -- val.techContact
        
    --     |> Dict.insert
    --         "adminPrivacy" "" -- val.adminPrivacy
        
    --     |> Dict.insert
    --         "registrantPrivacy" "" -- val.registrantPrivacy
        
    --     |> Dict.insert
    --         "techPrivacy" "" -- val.techPrivacy
        
    --     |> Dict.insert
    --         "registrarName" "" -- val.registrarName
        
    --     |> Dict.insert
    --         "whoIsServer" "" -- val.whoIsServer
        
    --     |> Dict.insert
    --         "registrarUrl" "" -- val.registrarUrl
        
    --     |> Dict.insert
    --         "abuseContactEmail" "" -- val.abuseContactEmail
        
    --     |> Dict.insert
    --         "abuseContactPhone" "" -- val.abuseContactPhone
        
    --     |> Dict.insert
    --         "registryDomainId" "" -- val.registryDomainId
...
getDomainSuggestionsResponseToString : GetDomainSuggestionsResponse -> String -- List (String, String)
getDomainSuggestionsResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "suggestionsList" "" -- val.suggestionsList
...
getOperationDetailResponseToString : GetOperationDetailResponse -> String -- List (String, String)
getOperationDetailResponseToString val =
    -- Dict.empty
...
invalidInputToString : InvalidInput -> String -- List (String, String)
invalidInputToString val =
    -- Dict.empty
...
listDomainsResponseToString : ListDomainsResponse -> String -- List (String, String)
listDomainsResponseToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "nextPageMarker" "" -- val.nextPageMarker
...
listOperationsResponseToString : ListOperationsResponse -> String -- List (String, String)
listOperationsResponseToString val =
    -- Dict.empty
...
listTagsForDomainResponseToString : ListTagsForDomainResponse -> String -- List (String, String)
listTagsForDomainResponseToString val =
    -- Dict.empty
...
nameserverToString : Nameserver -> String -- List (String, String)
nameserverToString val =
    -- Dict.empty
...
operationLimitExceededToString : OperationLimitExceeded -> String -- List (String, String)
operationLimitExceededToString val =
    -- Dict.empty
...
operationSummaryToString : OperationSummary -> String -- List (String, String)
operationSummaryToString val =
    -- Dict.empty
...
registerDomainResponseToString : RegisterDomainResponse -> String -- List (String, String)
registerDomainResponseToString val =
    -- Dict.empty
...
renewDomainResponseToString : RenewDomainResponse -> String -- List (String, String)
renewDomainResponseToString val =
    -- Dict.empty
...
resendContactReachabilityEmailResponseToString : ResendContactReachabilityEmailResponse -> String -- List (String, String)
resendContactReachabilityEmailResponseToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "isAlreadyVerified" "" -- val.isAlreadyVerified
...
retrieveDomainAuthCodeResponseToString : RetrieveDomainAuthCodeResponse -> String -- List (String, String)
retrieveDomainAuthCodeResponseToString val =
    -- Dict.empty
...
tLDRulesViolationToString : TLDRulesViolation -> String -- List (String, String)
tLDRulesViolationToString val =
    -- Dict.empty
...
transferDomainResponseToString : TransferDomainResponse -> String -- List (String, String)
transferDomainResponseToString val =
    -- Dict.empty
...
unsupportedTLDToString : UnsupportedTLD -> String -- List (String, String)
unsupportedTLDToString val =
    -- Dict.empty
...
updateDomainContactPrivacyResponseToString : UpdateDomainContactPrivacyResponse -> String -- List (String, String)
updateDomainContactPrivacyResponseToString val =
    -- Dict.empty
...
updateDomainContactResponseToString : UpdateDomainContactResponse -> String -- List (String, String)
updateDomainContactResponseToString val =
    -- Dict.empty
...
updateDomainNameserversResponseToString : UpdateDomainNameserversResponse -> String -- List (String, String)
updateDomainNameserversResponseToString val =
    -- Dict.empty
...
updateTagsForDomainResponseToString : UpdateTagsForDomainResponse -> String -- List (String, String)
updateTagsForDomainResponseToString val =
    -- Dict.empty
...
viewBillingResponseToString : ViewBillingResponse -> String -- List (String, String)
viewBillingResponseToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "billingRecords" "" -- val.billingRecords
