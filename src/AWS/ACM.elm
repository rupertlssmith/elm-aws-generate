module AWS.ACM exposing
    ...
    , DescribeCertificateResponse, ExportCertificateResponse, GetCertificateResponse, ImportCertificateResponse, ListCertificatesResponse, ListTagsForCertificateResponse, RequestCertificateResponse
    , CertificateDetail, CertificateOptions, CertificateSummary, DomainValidation, DomainValidationOption, ExtendedKeyUsage, Filters, KeyUsage, RenewalSummary, ResourceRecord, Tag
    , CertificateStatus(..), CertificateTransparencyLoggingPreference(..), CertificateType(..), DomainStatus(..), ExtendedKeyUsageName(..), FailureReason(..), KeyAlgorithm(..), KeyUsageName(..), RecordType(..), RenewalEligibility(..), RenewalStatus(..), RevocationReason(..), ValidationMethod(..)
    )
...
importCertificate certificate privateKey setOptions =
    let
        ...
        options =
            setOptions (ImportCertificateOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listCertificates setOptions =
    let
        ...
        options =
            setOptions (ListCertificatesOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
requestCertificate domainName setOptions =
    let
        ...
        options =
            setOptions (RequestCertificateOptions Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
