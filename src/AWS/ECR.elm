module AWS.ECR exposing
    ...
    , AuthorizationData, DescribeImagesFilter, Image, ImageDetail, ImageFailure, ImageIdentifier, Layer, LayerFailure, LifecyclePolicyPreviewFilter, LifecyclePolicyPreviewResult, LifecyclePolicyPreviewSummary, LifecyclePolicyRuleAction, ListImagesFilter, Repository, Tag
    , ImageActionType(..), ImageFailureCode(..), ImageTagMutability(..), LayerAvailability(..), LayerFailureCode(..), LifecyclePolicyPreviewStatus(..), TagStatus(..)
    )
...
batchCheckLayerAvailability repositoryName layerDigests setOptions =
    let
        ...
        options =
            setOptions (BatchCheckLayerAvailabilityOptions Nothing)
    in
...
batchDeleteImage repositoryName imageIds setOptions =
    let
        ...
        options =
            setOptions (BatchDeleteImageOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
batchGetImage repositoryName imageIds setOptions =
    let
        ...
        options =
            setOptions (BatchGetImageOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
completeLayerUpload repositoryName uploadId layerDigests setOptions =
    let
        ...
        options =
            setOptions (CompleteLayerUploadOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
deleteLifecyclePolicy repositoryName setOptions =
    let
        ...
        options =
            setOptions (DeleteLifecyclePolicyOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
deleteRepository repositoryName setOptions =
    let
        ...
        options =
            setOptions (DeleteRepositoryOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
deleteRepositoryPolicy repositoryName setOptions =
    let
        ...
        options =
            setOptions (DeleteRepositoryPolicyOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeRepositories setOptions =
    let
        ...
        options =
            setOptions (DescribeRepositoriesOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
getAuthorizationToken setOptions =
    let
        ...
        options =
            setOptions (GetAuthorizationTokenOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
getDownloadUrlForLayer repositoryName layerDigest setOptions =
    let
        ...
        options =
            setOptions (GetDownloadUrlForLayerOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
getLifecyclePolicy repositoryName setOptions =
    let
        ...
        options =
            setOptions (GetLifecyclePolicyOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
getLifecyclePolicyPreview repositoryName setOptions =
    let
        ...
        options =
            setOptions (GetLifecyclePolicyPreviewOptions Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
getRepositoryPolicy repositoryName setOptions =
    let
        ...
        options =
            setOptions (GetRepositoryPolicyOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
initiateLayerUpload repositoryName setOptions =
    let
        ...
        options =
            setOptions (InitiateLayerUploadOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listImages repositoryName setOptions =
    let
        ...
        options =
            setOptions (ListImagesOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
putImage repositoryName imageManifest setOptions =
    let
        ...
        options =
            setOptions (PutImageOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
putImageTagMutability repositoryName imageTagMutability setOptions =
    let
        ...
        options =
            setOptions (PutImageTagMutabilityOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
putLifecyclePolicy repositoryName lifecyclePolicyText setOptions =
    let
        ...
        options =
            setOptions (PutLifecyclePolicyOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
setRepositoryPolicy repositoryName policyText setOptions =
    let
        ...
        options =
            setOptions (SetRepositoryPolicyOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
startLifecyclePolicyPreview repositoryName setOptions =
    let
        ...
        options =
            setOptions (StartLifecyclePolicyPreviewOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
uploadLayerPart repositoryName uploadId partFirstByte partLastByte layerPartBlob setOptions =
    let
        ...
        options =
            setOptions (UploadLayerPartOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
