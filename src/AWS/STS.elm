module AWS.STS exposing
    ( service
    , assumeRole, AssumeRoleOptions, assumeRoleWithSAML, AssumeRoleWithSAMLOptions, assumeRoleWithWebIdentity, AssumeRoleWithWebIdentityOptions, decodeAuthorizationMessage, getAccessKeyInfo, getCallerIdentity, getFederationToken, GetFederationTokenOptions, getSessionToken, GetSessionTokenOptions
    , AssumeRoleResponse, AssumeRoleWithSAMLResponse, AssumeRoleWithWebIdentityResponse, DecodeAuthorizationMessageResponse, GetAccessKeyInfoResponse, GetCallerIdentityResponse, GetFederationTokenResponse, GetSessionTokenResponse
    , AssumedRoleUser, Credentials, FederatedUser, PolicyDescriptorType
    )
...
assumeRole roleArn roleSessionName setOptions =
    let
        ...
        options =
            setOptions (AssumeRoleOptions Nothing Nothing Nothing Nothing Nothing Nothing)
    in
...
assumeRoleWithSAML roleArn principalArn sAMLAssertion setOptions =
    let
        ...
        options =
            setOptions (AssumeRoleWithSAMLOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
assumeRoleWithWebIdentity roleArn roleSessionName webIdentityToken setOptions =
    let
        ...
        options =
            setOptions (AssumeRoleWithWebIdentityOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
-}
getCallerIdentity : AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper GetCallerIdentityResponse)
getCallerIdentity =
    let
        requestInput =
...
getFederationToken name setOptions =
    let
        ...
        options =
            setOptions (GetFederationTokenOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
getSessionToken setOptions =
    let
        ...
        options =
            setOptions (GetSessionTokenOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
