...
createListener loadBalancerArn protocol port_ defaultActions setOptions =
    let
        ...
        options =
            setOptions (CreateListenerOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createLoadBalancer name setOptions =
    let
        ...
        options =
            setOptions (CreateLoadBalancerOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createTargetGroup name setOptions =
    let
        ...
        options =
            setOptions (CreateTargetGroupOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeAccountLimits setOptions =
    let
        ...
        options =
            setOptions (DescribeAccountLimitsOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeListenerCertificates listenerArn setOptions =
    let
        ...
        options =
            setOptions (DescribeListenerCertificatesOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeListeners setOptions =
    let
        ...
        options =
            setOptions (DescribeListenersOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeLoadBalancers setOptions =
    let
        ...
        options =
            setOptions (DescribeLoadBalancersOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeRules setOptions =
    let
        ...
        options =
            setOptions (DescribeRulesOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeSSLPolicies setOptions =
    let
        ...
        options =
            setOptions (DescribeSSLPoliciesOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeTargetGroups setOptions =
    let
        ...
        options =
            setOptions (DescribeTargetGroupsOptions Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeTargetHealth targetGroupArn setOptions =
    let
        ...
        options =
            setOptions (DescribeTargetHealthOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
modifyListener listenerArn setOptions =
    let
        ...
        options =
            setOptions (ModifyListenerOptions Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
modifyRule ruleArn setOptions =
    let
        ...
        options =
            setOptions (ModifyRuleOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
modifyTargetGroup targetGroupArn setOptions =
    let
        ...
        options =
            setOptions (ModifyTargetGroupOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
setSubnets loadBalancerArn setOptions =
    let
        ...
        options =
            setOptions (SetSubnetsOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
