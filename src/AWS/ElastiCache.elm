module AWS.ElastiCache
    exposing
        ...
        , DescribeServiceUpdatesOptions
        , describeSnapshots
        , DescribeSnapshotsOptions
        , describeUpdateActions
        , DescribeUpdateActionsOptions
        , increaseReplicaCount
        , IncreaseReplicaCountOptions
...
authorizeCacheSecurityGroupIngress cacheSecurityGroupName eC2SecurityGroupName eC2SecurityGroupOwnerId =
    ...
    let
        requestInput = AuthorizeCacheSecurityGroupIngressMessage
...
* `replicationGroupIds` __:__ `(List String)`
* `serviceUpdateName` __:__ `String`
...
batchApplyUpdateAction replicationGroupIds serviceUpdateName =
    ...
    let
        requestInput = BatchApplyUpdateActionMessage
...
batchStopUpdateAction replicationGroupIds serviceUpdateName =
    ...
    let
        requestInput = BatchStopUpdateActionMessage
...
copySnapshot sourceSnapshotName targetSnapshotName setOptions =
    ...
    let
        requestInput = CopySnapshotMessage
...
createCacheCluster cacheClusterId setOptions =
    ...
    let
        requestInput = CreateCacheClusterMessage
...
type alias CreateCacheClusterOptions =
    {
    replicationGroupId : Maybe String,aZMode : Maybe AZMode,preferredAvailabilityZone : Maybe String,preferredAvailabilityZones : Maybe (List String),numCacheNodes : Maybe Int,cacheNodeType : Maybe String,engine : Maybe String,engineVersion : Maybe String,cacheParameterGroupName : Maybe String,cacheSubnetGroupName : Maybe String,cacheSecurityGroupNames : Maybe (List String),securityGroupIds : Maybe (List String),tags : Maybe (List Tag),snapshotArns : Maybe (List String),snapshotName : Maybe String,preferredMaintenanceWindow : Maybe String,port_ : Maybe Int,notificationTopicArn : Maybe String,autoMinorVersionUpgrade : Maybe Bool,snapshotRetentionLimit : Maybe Int,snapshotWindow : Maybe String,authToken : Maybe String
    }
...
createCacheParameterGroup cacheParameterGroupName cacheParameterGroupFamily description =
    ...
    let
        requestInput = CreateCacheParameterGroupMessage
...
createCacheSecurityGroup cacheSecurityGroupName description =
    ...
    let
        requestInput = CreateCacheSecurityGroupMessage
...
createCacheSubnetGroup cacheSubnetGroupName cacheSubnetGroupDescription subnetIds =
    ...
    let
        requestInput = CreateCacheSubnetGroupMessage
...
createReplicationGroup replicationGroupId replicationGroupDescription setOptions =
    ...
    let
        requestInput = CreateReplicationGroupMessage
        ...
        options = setOptions (CreateReplicationGroupOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
...
type alias CreateReplicationGroupOptions =
    {
    primaryClusterId : Maybe String,automaticFailoverEnabled : Maybe Bool,numCacheClusters : Maybe Int,preferredCacheClusterAZs : Maybe (List String),numNodeGroups : Maybe Int,replicasPerNodeGroup : Maybe Int,nodeGroupConfiguration : Maybe (List NodeGroupConfiguration),cacheNodeType : Maybe String,engine : Maybe String,engineVersion : Maybe String,cacheParameterGroupName : Maybe String,cacheSubnetGroupName : Maybe String,cacheSecurityGroupNames : Maybe (List String),securityGroupIds : Maybe (List String),tags : Maybe (List Tag),snapshotArns : Maybe (List String),snapshotName : Maybe String,preferredMaintenanceWindow : Maybe String,port_ : Maybe Int,notificationTopicArn : Maybe String,autoMinorVersionUpgrade : Maybe Bool,snapshotRetentionLimit : Maybe Int,snapshotWindow : Maybe String,authToken : Maybe String,transitEncryptionEnabled : Maybe Bool,atRestEncryptionEnabled : Maybe Bool
    }
...
createSnapshot snapshotName setOptions =
    ...
    let
        requestInput = CreateSnapshotMessage
...
type alias CreateSnapshotOptions =
    {
    replicationGroupId : Maybe String,cacheClusterId : Maybe String
    }
...
decreaseReplicaCount replicationGroupId applyImmediately setOptions =
    ...
    let
        requestInput = DecreaseReplicaCountMessage
        ...
        options = setOptions (DecreaseReplicaCountOptions Nothing Nothing Nothing)
...
type alias DecreaseReplicaCountOptions =
    {
    newReplicaCount : Maybe Int,replicaConfiguration : Maybe (List ConfigureShard),replicasToRemove : Maybe (List String)
    }
...
deleteCacheCluster cacheClusterId setOptions =
    ...
    let
        requestInput = DeleteCacheClusterMessage
...
deleteCacheParameterGroup cacheParameterGroupName =
    ...
    let
        requestInput = DeleteCacheParameterGroupMessage
...
deleteCacheSecurityGroup cacheSecurityGroupName =
    ...
    let
        requestInput = DeleteCacheSecurityGroupMessage
...
deleteCacheSubnetGroup cacheSubnetGroupName =
    ...
    let
        requestInput = DeleteCacheSubnetGroupMessage
...
deleteReplicationGroup replicationGroupId setOptions =
    ...
    let
        requestInput = DeleteReplicationGroupMessage
...
type alias DeleteReplicationGroupOptions =
    {
    retainPrimaryCluster : Maybe Bool,finalSnapshotIdentifier : Maybe String
    }
...
deleteSnapshot snapshotName =
    ...
    let
        requestInput = DeleteSnapshotMessage
...
describeCacheClusters setOptions =
    ...
    let
        requestInput = DescribeCacheClustersMessage
        ...
        options = setOptions (DescribeCacheClustersOptions Nothing Nothing Nothing Nothing Nothing)
...
type alias DescribeCacheClustersOptions =
    {
    cacheClusterId : Maybe String,maxRecords : Maybe Int,marker : Maybe String,showCacheNodeInfo : Maybe Bool,showCacheClustersNotInReplicationGroups : Maybe Bool
    }
...
describeCacheEngineVersions setOptions =
    ...
    let
        requestInput = DescribeCacheEngineVersionsMessage
...
type alias DescribeCacheEngineVersionsOptions =
    {
    engine : Maybe String,engineVersion : Maybe String,cacheParameterGroupFamily : Maybe String,maxRecords : Maybe Int,marker : Maybe String,defaultOnly : Maybe Bool
    }
...
describeCacheParameterGroups setOptions =
    ...
    let
        requestInput = DescribeCacheParameterGroupsMessage
...
type alias DescribeCacheParameterGroupsOptions =
    {
    cacheParameterGroupName : Maybe String,maxRecords : Maybe Int,marker : Maybe String
    }
...
describeCacheParameters cacheParameterGroupName setOptions =
    ...
    let
        requestInput = DescribeCacheParametersMessage
...
describeCacheSecurityGroups setOptions =
    ...
    let
        requestInput = DescribeCacheSecurityGroupsMessage
...
type alias DescribeCacheSecurityGroupsOptions =
    {
    cacheSecurityGroupName : Maybe String,maxRecords : Maybe Int,marker : Maybe String
    }
...
describeCacheSubnetGroups setOptions =
    ...
    let
        requestInput = DescribeCacheSubnetGroupsMessage
...
type alias DescribeCacheSubnetGroupsOptions =
    {
    cacheSubnetGroupName : Maybe String,maxRecords : Maybe Int,marker : Maybe String
    }
...
describeReplicationGroups setOptions =
    ...
    let
        requestInput = DescribeReplicationGroupsMessage
...
type alias DescribeReplicationGroupsOptions =
    {
    replicationGroupId : Maybe String,maxRecords : Maybe Int,marker : Maybe String
    }
...
describeReservedCacheNodes setOptions =
    ...
    let
        requestInput = DescribeReservedCacheNodesMessage
...
type alias DescribeReservedCacheNodesOptions =
    {
    reservedCacheNodeId : Maybe String,reservedCacheNodesOfferingId : Maybe String,cacheNodeType : Maybe String,duration : Maybe String,productDescription : Maybe String,offeringType : Maybe String,maxRecords : Maybe Int,marker : Maybe String
    }
...
describeReservedCacheNodesOfferings setOptions =
    ...
    let
        requestInput = DescribeReservedCacheNodesOfferingsMessage
...
type alias DescribeReservedCacheNodesOfferingsOptions =
    {
    reservedCacheNodesOfferingId : Maybe String,cacheNodeType : Maybe String,duration : Maybe String,productDescription : Maybe String,offeringType : Maybe String,maxRecords : Maybe Int,marker : Maybe String
    }
...
describeServiceUpdates setOptions =
    ...
    let
        requestInput = DescribeServiceUpdatesMessage
        ...
        options = setOptions (DescribeServiceUpdatesOptions Nothing Nothing Nothing Nothing)
...
type alias DescribeServiceUpdatesOptions =
    {
    serviceUpdateName : Maybe String,serviceUpdateStatus : Maybe (List ServiceUpdateStatus),maxRecords : Maybe Int,marker : Maybe String
    }
...
describeSnapshots setOptions =
    ...
    let
        requestInput = DescribeSnapshotsMessage
...
type alias DescribeSnapshotsOptions =
    {
    replicationGroupId : Maybe String,cacheClusterId : Maybe String,snapshotName : Maybe String,snapshotSource : Maybe String,marker : Maybe String,maxRecords : Maybe Int,showNodeGroupConfig : Maybe Bool
    }
...
describeUpdateActions setOptions =
    ...
    let
        requestInput = DescribeUpdateActionsMessage
        ...
        options = setOptions (DescribeUpdateActionsOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
...
type alias DescribeUpdateActionsOptions =
    {
    serviceUpdateName : Maybe String,replicationGroupIds : Maybe (List String),serviceUpdateStatus : Maybe (List ServiceUpdateStatus),serviceUpdateTimeRange : Maybe TimeRangeFilter,updateActionStatus : Maybe (List UpdateActionStatus),showNodeLevelUpdateStatus : Maybe Bool,maxRecords : Maybe Int,marker : Maybe String
    }
...
increaseReplicaCount replicationGroupId applyImmediately setOptions =
    ...
    let
        requestInput = IncreaseReplicaCountMessage
        ...
        options = setOptions (IncreaseReplicaCountOptions Nothing Nothing)
...
type alias IncreaseReplicaCountOptions =
    {
    newReplicaCount : Maybe Int,replicaConfiguration : Maybe (List ConfigureShard)
    }
...
listAllowedNodeTypeModifications setOptions =
    ...
    let
        requestInput = ListAllowedNodeTypeModificationsMessage
...
type alias ListAllowedNodeTypeModificationsOptions =
    {
    cacheClusterId : Maybe String,replicationGroupId : Maybe String
    }
...
modifyCacheCluster cacheClusterId setOptions =
    ...
    let
        requestInput = ModifyCacheClusterMessage
...
type alias ModifyCacheClusterOptions =
    {
    numCacheNodes : Maybe Int,cacheNodeIdsToRemove : Maybe (List String),aZMode : Maybe AZMode,newAvailabilityZones : Maybe (List String),cacheSecurityGroupNames : Maybe (List String),securityGroupIds : Maybe (List String),preferredMaintenanceWindow : Maybe String,notificationTopicArn : Maybe String,cacheParameterGroupName : Maybe String,notificationTopicStatus : Maybe String,applyImmediately : Maybe Bool,engineVersion : Maybe String,autoMinorVersionUpgrade : Maybe Bool,snapshotRetentionLimit : Maybe Int,snapshotWindow : Maybe String,cacheNodeType : Maybe String
    }
...
modifyCacheParameterGroup cacheParameterGroupName parameterNameValues =
    ...
    let
        requestInput = ModifyCacheParameterGroupMessage
...
modifyCacheSubnetGroup cacheSubnetGroupName setOptions =
    ...
    let
        requestInput = ModifyCacheSubnetGroupMessage
...
type alias ModifyCacheSubnetGroupOptions =
    {
    cacheSubnetGroupDescription : Maybe String,subnetIds : Maybe (List String)
    }
...
modifyReplicationGroup replicationGroupId setOptions =
    ...
    let
        requestInput = ModifyReplicationGroupMessage
        ...
        options = setOptions (ModifyReplicationGroupOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
...
type alias ModifyReplicationGroupOptions =
    {
    replicationGroupDescription : Maybe String,primaryClusterId : Maybe String,snapshottingClusterId : Maybe String,automaticFailoverEnabled : Maybe Bool,cacheSecurityGroupNames : Maybe (List String),securityGroupIds : Maybe (List String),preferredMaintenanceWindow : Maybe String,notificationTopicArn : Maybe String,cacheParameterGroupName : Maybe String,notificationTopicStatus : Maybe String,applyImmediately : Maybe Bool,engineVersion : Maybe String,autoMinorVersionUpgrade : Maybe Bool,snapshotRetentionLimit : Maybe Int,snapshotWindow : Maybe String,cacheNodeType : Maybe String,nodeGroupId : Maybe String
    }
...
modifyReplicationGroupShardConfiguration replicationGroupId nodeGroupCount applyImmediately setOptions =
    ...
    let
        requestInput = ModifyReplicationGroupShardConfigurationMessage
        ...
        options = setOptions (ModifyReplicationGroupShardConfigurationOptions Nothing Nothing Nothing)
...
type alias ModifyReplicationGroupShardConfigurationOptions =
    {
    reshardingConfiguration : Maybe (List ReshardingConfiguration),nodeGroupsToRemove : Maybe (List String),nodeGroupsToRetain : Maybe (List String)
    }
...
purchaseReservedCacheNodesOffering reservedCacheNodesOfferingId setOptions =
    ...
    let
        requestInput = PurchaseReservedCacheNodesOfferingMessage
...
type alias PurchaseReservedCacheNodesOfferingOptions =
    {
    reservedCacheNodeId : Maybe String,cacheNodeCount : Maybe Int
    }
...
rebootCacheCluster cacheClusterId cacheNodeIdsToReboot =
    ...
    let
        requestInput = RebootCacheClusterMessage
...
resetCacheParameterGroup cacheParameterGroupName setOptions =
    ...
    let
        requestInput = ResetCacheParameterGroupMessage
...
type alias ResetCacheParameterGroupOptions =
    {
    resetAllParameters : Maybe Bool,parameterNameValues : Maybe (List ParameterNameValue)
    }
...
revokeCacheSecurityGroupIngress cacheSecurityGroupName eC2SecurityGroupName eC2SecurityGroupOwnerId =
    ...
    let
        requestInput = RevokeCacheSecurityGroupIngressMessage
...
testFailover replicationGroupId nodeGroupId =
    ...
    let
        requestInput = TestFailoverMessage
...
allowedNodeTypeModificationsMessageToString : AllowedNodeTypeModificationsMessage -> String -- List (String, String)
allowedNodeTypeModificationsMessageToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "scaleUpModifications" "" -- val.scaleUpModifications
...
authorizeCacheSecurityGroupIngressResultToString : AuthorizeCacheSecurityGroupIngressResult -> String -- List (String, String)
authorizeCacheSecurityGroupIngressResultToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "cacheSecurityGroup" "" -- val.cacheSecurityGroup
...
cacheClusterToString : CacheCluster -> String -- List (String, String)
cacheClusterToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "cacheClusterId" "" -- val.cacheClusterId
        
    --     |> Dict.insert
    --         "configurationEndpoint" "" -- val.configurationEndpoint
        
    --     |> Dict.insert
    --         "clientDownloadLandingPage" "" -- val.clientDownloadLandingPage
        
    --     |> Dict.insert
    --         "cacheNodeType" "" -- val.cacheNodeType
    ...
    --     |> Dict.insert
    --         "cacheClusterStatus" "" -- val.cacheClusterStatus
        
    --     |> Dict.insert
    --         "numCacheNodes" "" -- val.numCacheNodes
        
    --     |> Dict.insert
    --         "preferredAvailabilityZone" "" -- val.preferredAvailabilityZone
        
    --     |> Dict.insert
    --         "cacheClusterCreateTime" "" -- val.cacheClusterCreateTime
    ...
    --     |> Dict.insert
    --         "notificationConfiguration" "" -- val.notificationConfiguration
        
    --     |> Dict.insert
    --         "cacheSecurityGroups" "" -- val.cacheSecurityGroups
        
    --     |> Dict.insert
    --         "cacheParameterGroup" "" -- val.cacheParameterGroup
        
    --     |> Dict.insert
    --         "cacheSubnetGroupName" "" -- val.cacheSubnetGroupName
        
    --     |> Dict.insert
    --         "cacheNodes" "" -- val.cacheNodes
    ...
    --     |> Dict.insert
    --         "replicationGroupId" "" -- val.replicationGroupId
        
    --     |> Dict.insert
    --         "snapshotRetentionLimit" "" -- val.snapshotRetentionLimit
        
    --     |> Dict.insert
    --         "snapshotWindow" "" -- val.snapshotWindow
        
    --     |> Dict.insert
    --         "authTokenEnabled" "" -- val.authTokenEnabled
        
    --     |> Dict.insert
    --         "transitEncryptionEnabled" "" -- val.transitEncryptionEnabled
        
    --     |> Dict.insert
    --         "atRestEncryptionEnabled" "" -- val.atRestEncryptionEnabled
...
cacheClusterMessageToString : CacheClusterMessage -> String -- List (String, String)
cacheClusterMessageToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "cacheClusters" "" -- val.cacheClusters
...
cacheEngineVersionToString : CacheEngineVersion -> String -- List (String, String)
cacheEngineVersionToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "cacheParameterGroupFamily" "" -- val.cacheParameterGroupFamily
        
    --     |> Dict.insert
    --         "cacheEngineDescription" "" -- val.cacheEngineDescription
        
    --     |> Dict.insert
    --         "cacheEngineVersionDescription" "" -- val.cacheEngineVersionDescription
...
cacheEngineVersionMessageToString : CacheEngineVersionMessage -> String -- List (String, String)
cacheEngineVersionMessageToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "cacheEngineVersions" "" -- val.cacheEngineVersions
...
cacheNodeToString : CacheNode -> String -- List (String, String)
cacheNodeToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "cacheNodeId" "" -- val.cacheNodeId
        
    --     |> Dict.insert
    --         "cacheNodeStatus" "" -- val.cacheNodeStatus
        
    --     |> Dict.insert
    --         "cacheNodeCreateTime" "" -- val.cacheNodeCreateTime
    ...
    --     |> Dict.insert
    --         "sourceCacheNodeId" "" -- val.sourceCacheNodeId
        
    --     |> Dict.insert
    --         "customerAvailabilityZone" "" -- val.customerAvailabilityZone
...
cacheNodeTypeSpecificParameterToString : CacheNodeTypeSpecificParameter -> String -- List (String, String)
cacheNodeTypeSpecificParameterToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "cacheNodeTypeSpecificValues" "" -- val.cacheNodeTypeSpecificValues
...
cacheNodeTypeSpecificValueToString : CacheNodeTypeSpecificValue -> String -- List (String, String)
cacheNodeTypeSpecificValueToString val =
    -- Dict.empty
...
cacheParameterGroupToString : CacheParameterGroup -> String -- List (String, String)
cacheParameterGroupToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "cacheParameterGroupName" "" -- val.cacheParameterGroupName
...
cacheParameterGroupDetailsToString : CacheParameterGroupDetails -> String -- List (String, String)
cacheParameterGroupDetailsToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "cacheNodeTypeSpecificParameters" "" -- val.cacheNodeTypeSpecificParameters
...
cacheParameterGroupNameMessageToString : CacheParameterGroupNameMessage -> String -- List (String, String)
cacheParameterGroupNameMessageToString val =
    -- Dict.empty
...
cacheParameterGroupStatusToString : CacheParameterGroupStatus -> String -- List (String, String)
cacheParameterGroupStatusToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "cacheNodeIdsToReboot" "" -- val.cacheNodeIdsToReboot
...
cacheParameterGroupsMessageToString : CacheParameterGroupsMessage -> String -- List (String, String)
cacheParameterGroupsMessageToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "cacheParameterGroups" "" -- val.cacheParameterGroups
...
cacheSecurityGroupToString : CacheSecurityGroup -> String -- List (String, String)
cacheSecurityGroupToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "cacheSecurityGroupName" "" -- val.cacheSecurityGroupName
...
cacheSecurityGroupMembershipToString : CacheSecurityGroupMembership -> String -- List (String, String)
cacheSecurityGroupMembershipToString val =
    -- Dict.empty
...
cacheSecurityGroupMessageToString : CacheSecurityGroupMessage -> String -- List (String, String)
cacheSecurityGroupMessageToString val =
    -- Dict.empty
...
cacheSubnetGroupToString : CacheSubnetGroup -> String -- List (String, String)
cacheSubnetGroupToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "cacheSubnetGroupDescription" "" -- val.cacheSubnetGroupDescription
...
cacheSubnetGroupMessageToString : CacheSubnetGroupMessage -> String -- List (String, String)
cacheSubnetGroupMessageToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "cacheSubnetGroups" "" -- val.cacheSubnetGroups
...
configureShardToString : ConfigureShard -> String -- List (String, String)
configureShardToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "newReplicaCount" "" -- val.newReplicaCount
        
    --     |> Dict.insert
    --         "preferredAvailabilityZones" "" -- val.preferredAvailabilityZones
...
createCacheClusterResultToString : CreateCacheClusterResult -> String -- List (String, String)
createCacheClusterResultToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "cacheCluster" "" -- val.cacheCluster
...
createCacheParameterGroupResultToString : CreateCacheParameterGroupResult -> String -- List (String, String)
createCacheParameterGroupResultToString val =
    -- Dict.empty
...
createCacheSecurityGroupResultToString : CreateCacheSecurityGroupResult -> String -- List (String, String)
createCacheSecurityGroupResultToString val =
    -- Dict.empty
...
createCacheSubnetGroupResultToString : CreateCacheSubnetGroupResult -> String -- List (String, String)
createCacheSubnetGroupResultToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "cacheSubnetGroup" "" -- val.cacheSubnetGroup
...
createReplicationGroupResultToString : CreateReplicationGroupResult -> String -- List (String, String)
createReplicationGroupResultToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "replicationGroup" "" -- val.replicationGroup
...
createSnapshotResultToString : CreateSnapshotResult -> String -- List (String, String)
createSnapshotResultToString val =
    -- Dict.empty
...
decreaseReplicaCountResultToString : DecreaseReplicaCountResult -> String -- List (String, String)
decreaseReplicaCountResultToString val =
    -- Dict.empty
...
deleteCacheClusterResultToString : DeleteCacheClusterResult -> String -- List (String, String)
deleteCacheClusterResultToString val =
    -- Dict.empty
...
deleteReplicationGroupResultToString : DeleteReplicationGroupResult -> String -- List (String, String)
deleteReplicationGroupResultToString val =
    -- Dict.empty
...
deleteSnapshotResultToString : DeleteSnapshotResult -> String -- List (String, String)
deleteSnapshotResultToString val =
    -- Dict.empty
...
describeSnapshotsListMessageToString : DescribeSnapshotsListMessage -> String -- List (String, String)
describeSnapshotsListMessageToString val =
    -- Dict.empty
...
increaseReplicaCountResultToString : IncreaseReplicaCountResult -> String -- List (String, String)
increaseReplicaCountResultToString val =
    -- Dict.empty
...
modifyCacheClusterResultToString : ModifyCacheClusterResult -> String -- List (String, String)
modifyCacheClusterResultToString val =
    -- Dict.empty
...
modifyCacheSubnetGroupResultToString : ModifyCacheSubnetGroupResult -> String -- List (String, String)
modifyCacheSubnetGroupResultToString val =
    -- Dict.empty
...
modifyReplicationGroupResultToString : ModifyReplicationGroupResult -> String -- List (String, String)
modifyReplicationGroupResultToString val =
    -- Dict.empty
...
modifyReplicationGroupShardConfigurationResultToString : ModifyReplicationGroupShardConfigurationResult -> String -- List (String, String)
modifyReplicationGroupShardConfigurationResultToString val =
    -- Dict.empty
...
nodeGroupToString : NodeGroup -> String -- List (String, String)
nodeGroupToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "primaryEndpoint" "" -- val.primaryEndpoint
    ...
    --     |> Dict.insert
    --         "nodeGroupMembers" "" -- val.nodeGroupMembers
...
nodeGroupConfigurationToString : NodeGroupConfiguration -> String -- List (String, String)
nodeGroupConfigurationToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "replicaCount" "" -- val.replicaCount
        
    --     |> Dict.insert
    --         "primaryAvailabilityZone" "" -- val.primaryAvailabilityZone
        
    --     |> Dict.insert
    --         "replicaAvailabilityZones" "" -- val.replicaAvailabilityZones
...
nodeGroupMemberToString : NodeGroupMember -> String -- List (String, String)
nodeGroupMemberToString val =
    -- Dict.empty
...
nodeGroupMemberUpdateStatusToString : NodeGroupMemberUpdateStatus -> String -- List (String, String)
nodeGroupMemberUpdateStatusToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "nodeUpdateStatus" "" -- val.nodeUpdateStatus
        
    --     |> Dict.insert
    --         "nodeDeletionDate" "" -- val.nodeDeletionDate
        
    --     |> Dict.insert
    --         "nodeUpdateStartDate" "" -- val.nodeUpdateStartDate
        
    --     |> Dict.insert
    --         "nodeUpdateEndDate" "" -- val.nodeUpdateEndDate
        
    --     |> Dict.insert
    --         "nodeUpdateInitiatedBy" "" -- val.nodeUpdateInitiatedBy
        
    --     |> Dict.insert
    --         "nodeUpdateInitiatedDate" "" -- val.nodeUpdateInitiatedDate
        
    --     |> Dict.insert
    --         "nodeUpdateStatusModifiedDate" "" -- val.nodeUpdateStatusModifiedDate
...
nodeGroupUpdateStatusToString : NodeGroupUpdateStatus -> String -- List (String, String)
nodeGroupUpdateStatusToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "nodeGroupMemberUpdateStatus" "" -- val.nodeGroupMemberUpdateStatus
...
nodeSnapshotToString : NodeSnapshot -> String -- List (String, String)
nodeSnapshotToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "nodeGroupConfiguration" "" -- val.nodeGroupConfiguration
...
notificationConfigurationToString : NotificationConfiguration -> String -- List (String, String)
notificationConfigurationToString val =
    -- Dict.empty
...
parameterNameValueToString : ParameterNameValue -> String -- List (String, String)
parameterNameValueToString val =
    -- Dict.empty
...
pendingModifiedValuesToString val =
    ...
    --     |> Dict.insert
    --         "cacheNodeIdsToRemove" "" -- val.cacheNodeIdsToRemove
...
processedUpdateActionToString : ProcessedUpdateAction -> String -- List (String, String)
processedUpdateActionToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "serviceUpdateName" "" -- val.serviceUpdateName
        
    --     |> Dict.insert
    --         "updateActionStatus" "" -- val.updateActionStatus
...
purchaseReservedCacheNodesOfferingResultToString : PurchaseReservedCacheNodesOfferingResult -> String -- List (String, String)
purchaseReservedCacheNodesOfferingResultToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "reservedCacheNode" "" -- val.reservedCacheNode
...
rebootCacheClusterResultToString : RebootCacheClusterResult -> String -- List (String, String)
rebootCacheClusterResultToString val =
    -- Dict.empty
...
replicationGroupToString : ReplicationGroup -> String -- List (String, String)
replicationGroupToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "memberClusters" "" -- val.memberClusters
        
    --     |> Dict.insert
    --         "nodeGroups" "" -- val.nodeGroups
        
    --     |> Dict.insert
    --         "snapshottingClusterId" "" -- val.snapshottingClusterId
        
    --     |> Dict.insert
    --         "automaticFailover" "" -- val.automaticFailover
    ...
    --     |> Dict.insert
    --         "clusterEnabled" "" -- val.clusterEnabled
...
replicationGroupMessageToString : ReplicationGroupMessage -> String -- List (String, String)
replicationGroupMessageToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "replicationGroups" "" -- val.replicationGroups
...
replicationGroupPendingModifiedValuesToString : ReplicationGroupPendingModifiedValues -> String -- List (String, String)
replicationGroupPendingModifiedValuesToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "primaryClusterId" "" -- val.primaryClusterId
        
    --     |> Dict.insert
    --         "automaticFailoverStatus" "" -- val.automaticFailoverStatus
        
    --     |> Dict.insert
    --         "resharding" "" -- val.resharding
...
reservedCacheNodeToString : ReservedCacheNode -> String -- List (String, String)
reservedCacheNodeToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "reservedCacheNodeId" "" -- val.reservedCacheNodeId
        
    --     |> Dict.insert
    --         "reservedCacheNodesOfferingId" "" -- val.reservedCacheNodesOfferingId
    ...
    --     |> Dict.insert
    --         "cacheNodeCount" "" -- val.cacheNodeCount
    ...
    --     |> Dict.insert
    --         "reservationARN" "" -- val.reservationARN
...
reservedCacheNodeMessageToString : ReservedCacheNodeMessage -> String -- List (String, String)
reservedCacheNodeMessageToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "reservedCacheNodes" "" -- val.reservedCacheNodes
...
reservedCacheNodesOfferingToString : ReservedCacheNodesOffering -> String -- List (String, String)
reservedCacheNodesOfferingToString val =
    -- Dict.empty
...
reservedCacheNodesOfferingMessageToString : ReservedCacheNodesOfferingMessage -> String -- List (String, String)
reservedCacheNodesOfferingMessageToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "reservedCacheNodesOfferings" "" -- val.reservedCacheNodesOfferings
...
reshardingConfigurationToString : ReshardingConfiguration -> String -- List (String, String)
reshardingConfigurationToString val =
    -- Dict.empty
...
reshardingStatusToString : ReshardingStatus -> String -- List (String, String)
reshardingStatusToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "slotMigration" "" -- val.slotMigration
...
revokeCacheSecurityGroupIngressResultToString : RevokeCacheSecurityGroupIngressResult -> String -- List (String, String)
revokeCacheSecurityGroupIngressResultToString val =
    -- Dict.empty
...
securityGroupMembershipToString : SecurityGroupMembership -> String -- List (String, String)
securityGroupMembershipToString val =
    -- Dict.empty
...
serviceUpdateToString : ServiceUpdate -> String -- List (String, String)
serviceUpdateToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "serviceUpdateReleaseDate" "" -- val.serviceUpdateReleaseDate
        
    --     |> Dict.insert
    --         "serviceUpdateEndDate" "" -- val.serviceUpdateEndDate
        
    --     |> Dict.insert
    --         "serviceUpdateSeverity" "" -- val.serviceUpdateSeverity
        
    --     |> Dict.insert
    --         "serviceUpdateRecommendedApplyByDate" "" -- val.serviceUpdateRecommendedApplyByDate
        
    --     |> Dict.insert
    --         "serviceUpdateStatus" "" -- val.serviceUpdateStatus
        
    --     |> Dict.insert
    --         "serviceUpdateDescription" "" -- val.serviceUpdateDescription
        
    --     |> Dict.insert
    --         "serviceUpdateType" "" -- val.serviceUpdateType
    ...
    --     |> Dict.insert
    --         "autoUpdateAfterRecommendedApplyByDate" "" -- val.autoUpdateAfterRecommendedApplyByDate
        
    --     |> Dict.insert
    --         "estimatedUpdateTime" "" -- val.estimatedUpdateTime
...
serviceUpdatesMessageToString : ServiceUpdatesMessage -> String -- List (String, String)
serviceUpdatesMessageToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "serviceUpdates" "" -- val.serviceUpdates
...
slotMigrationToString : SlotMigration -> String -- List (String, String)
slotMigrationToString val =
    -- Dict.empty
...
snapshotToString val =
    ...
    --     |> Dict.insert
    --         "snapshotName" "" -- val.snapshotName
        
    --     |> Dict.insert
    --         "replicationGroupId" "" -- val.replicationGroupId
        
    --     |> Dict.insert
    --         "replicationGroupDescription" "" -- val.replicationGroupDescription
        
    --     |> Dict.insert
    --         "cacheClusterId" "" -- val.cacheClusterId
        
    --     |> Dict.insert
    --         "snapshotStatus" "" -- val.snapshotStatus
        
    --     |> Dict.insert
    --         "snapshotSource" "" -- val.snapshotSource
    ...
    --     |> Dict.insert
    --         "numNodeGroups" "" -- val.numNodeGroups
        
    --     |> Dict.insert
    --         "automaticFailover" "" -- val.automaticFailover
        
    --     |> Dict.insert
    --         "nodeSnapshots" "" -- val.nodeSnapshots
...
testFailoverResultToString : TestFailoverResult -> String -- List (String, String)
testFailoverResultToString val =
    -- Dict.empty
...
timeRangeFilterToString : TimeRangeFilter -> String -- List (String, String)
timeRangeFilterToString val =
    -- Dict.empty
...
unprocessedUpdateActionToString : UnprocessedUpdateAction -> String -- List (String, String)
unprocessedUpdateActionToString val =
    -- Dict.empty
...
updateActionToString : UpdateAction -> String -- List (String, String)
updateActionToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "updateActionAvailableDate" "" -- val.updateActionAvailableDate
        
    --     |> Dict.insert
    --         "updateActionStatus" "" -- val.updateActionStatus
        
    --     |> Dict.insert
    --         "nodesUpdated" "" -- val.nodesUpdated
        
    --     |> Dict.insert
    --         "updateActionStatusModifiedDate" "" -- val.updateActionStatusModifiedDate
        
    --     |> Dict.insert
    --         "slaMet" "" -- val.slaMet
        
    --     |> Dict.insert
    --         "nodeGroupUpdateStatus" "" -- val.nodeGroupUpdateStatus
...
updateActionResultsMessageToString : UpdateActionResultsMessage -> String -- List (String, String)
updateActionResultsMessageToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "processedUpdateActions" "" -- val.processedUpdateActions
        
    --     |> Dict.insert
    --         "unprocessedUpdateActions" "" -- val.unprocessedUpdateActions
...
updateActionsMessageToString : UpdateActionsMessage -> String -- List (String, String)
updateActionsMessageToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "updateActions" "" -- val.updateActions
