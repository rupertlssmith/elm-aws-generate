...
createTrail name s3BucketName setOptions =
    ...
    let
        requestInput = CreateTrailRequest
        ...
        options = setOptions (CreateTrailOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
...
type alias CreateTrailOptions =
    {
    s3KeyPrefix : Maybe String,snsTopicName : Maybe String,includeGlobalServiceEvents : Maybe Bool,isMultiRegionTrail : Maybe Bool,enableLogFileValidation : Maybe Bool,cloudWatchLogsLogGroupArn : Maybe String,cloudWatchLogsRoleArn : Maybe String,kmsKeyId : Maybe String,isOrganizationTrail : Maybe Bool
    }
...
deleteTrail name =
    ...
    let
        requestInput = DeleteTrailRequest
...
describeTrails setOptions =
    ...
    let
        requestInput = DescribeTrailsRequest
...
type alias DescribeTrailsOptions =
    {
    trailNameList : Maybe (List String),includeShadowTrails : Maybe Bool
    }
...
getEventSelectors trailName =
    ...
    let
        requestInput = GetEventSelectorsRequest
...
getTrailStatus name =
    ...
    let
        requestInput = GetTrailStatusRequest
...
listPublicKeys setOptions =
    ...
    let
        requestInput = ListPublicKeysRequest
...
type alias ListPublicKeysOptions =
    {
    startTime : Maybe Posix,endTime : Maybe Posix,nextToken : Maybe String
    }
...
lookupEvents setOptions =
    ...
    let
        requestInput = LookupEventsRequest
...
type alias LookupEventsOptions =
    {
    lookupAttributes : Maybe (List LookupAttribute),startTime : Maybe Posix,endTime : Maybe Posix,maxResults : Maybe Int,nextToken : Maybe String
    }
...
* `trailName` __:__ `String`
* `eventSelectors` __:__ `(List EventSelector)`
...
putEventSelectors trailName eventSelectors =
    ...
    let
        requestInput = PutEventSelectorsRequest
...
removeTags resourceId setOptions =
    ...
    let
        requestInput = RemoveTagsRequest
...
startLogging name =
    ...
    let
        requestInput = StartLoggingRequest
...
stopLogging name =
    ...
    let
        requestInput = StopLoggingRequest
...
updateTrail name setOptions =
    ...
    let
        requestInput = UpdateTrailRequest
        ...
        options = setOptions (UpdateTrailOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
...
type alias UpdateTrailOptions =
    {
    s3BucketName : Maybe String,s3KeyPrefix : Maybe String,snsTopicName : Maybe String,includeGlobalServiceEvents : Maybe Bool,isMultiRegionTrail : Maybe Bool,enableLogFileValidation : Maybe Bool,cloudWatchLogsLogGroupArn : Maybe String,cloudWatchLogsRoleArn : Maybe String,kmsKeyId : Maybe String,isOrganizationTrail : Maybe Bool
    }
...
addTagsResponseToString : AddTagsResponse -> String -- List (String, String)
addTagsResponseToString val =
    -- Dict.empty
...
createTrailResponseToString : CreateTrailResponse -> String -- List (String, String)
createTrailResponseToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "snsTopicName" "" -- val.snsTopicName
        
    --     |> Dict.insert
    --         "snsTopicARN" "" -- val.snsTopicARN
        
    --     |> Dict.insert
    --         "includeGlobalServiceEvents" "" -- val.includeGlobalServiceEvents
        
    --     |> Dict.insert
    --         "isMultiRegionTrail" "" -- val.isMultiRegionTrail
        
    --     |> Dict.insert
    --         "trailARN" "" -- val.trailARN
        
    --     |> Dict.insert
    --         "logFileValidationEnabled" "" -- val.logFileValidationEnabled
        
    --     |> Dict.insert
    --         "cloudWatchLogsLogGroupArn" "" -- val.cloudWatchLogsLogGroupArn
    ...
    --     |> Dict.insert
    --         "isOrganizationTrail" "" -- val.isOrganizationTrail
...
dataResourceToString : DataResource -> String -- List (String, String)
dataResourceToString val =
    -- Dict.empty
...
deleteTrailResponseToString : DeleteTrailResponse -> String -- List (String, String)
deleteTrailResponseToString val =
    -- Dict.empty
...
describeTrailsResponseToString : DescribeTrailsResponse -> String -- List (String, String)
describeTrailsResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "trailList" "" -- val.trailList
...
eventToString val =
    ...
    --     |> Dict.insert
    --         "cloudTrailEvent" "" -- val.cloudTrailEvent
...
eventSelectorToString : EventSelector -> String -- List (String, String)
eventSelectorToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "includeManagementEvents" "" -- val.includeManagementEvents
        
    --     |> Dict.insert
    --         "dataResources" "" -- val.dataResources
...
getEventSelectorsResponseToString : GetEventSelectorsResponse -> String -- List (String, String)
getEventSelectorsResponseToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "eventSelectors" "" -- val.eventSelectors
...
getTrailStatusResponseToString : GetTrailStatusResponse -> String -- List (String, String)
getTrailStatusResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "isLogging" "" -- val.isLogging
        
    --     |> Dict.insert
    --         "latestDeliveryError" "" -- val.latestDeliveryError
        
    --     |> Dict.insert
    --         "latestNotificationError" "" -- val.latestNotificationError
        
    --     |> Dict.insert
    --         "latestDeliveryTime" "" -- val.latestDeliveryTime
        
    --     |> Dict.insert
    --         "latestNotificationTime" "" -- val.latestNotificationTime
        
    --     |> Dict.insert
    --         "startLoggingTime" "" -- val.startLoggingTime
        
    --     |> Dict.insert
    --         "stopLoggingTime" "" -- val.stopLoggingTime
        
    --     |> Dict.insert
    --         "latestCloudWatchLogsDeliveryError" "" -- val.latestCloudWatchLogsDeliveryError
        
    --     |> Dict.insert
    --         "latestCloudWatchLogsDeliveryTime" "" -- val.latestCloudWatchLogsDeliveryTime
        
    --     |> Dict.insert
    --         "latestDigestDeliveryTime" "" -- val.latestDigestDeliveryTime
        
    --     |> Dict.insert
    --         "latestDigestDeliveryError" "" -- val.latestDigestDeliveryError
        
    --     |> Dict.insert
    --         "latestDeliveryAttemptTime" "" -- val.latestDeliveryAttemptTime
        
    --     |> Dict.insert
    --         "latestNotificationAttemptTime" "" -- val.latestNotificationAttemptTime
        
    --     |> Dict.insert
    --         "latestNotificationAttemptSucceeded" "" -- val.latestNotificationAttemptSucceeded
        
    --     |> Dict.insert
    --         "latestDeliveryAttemptSucceeded" "" -- val.latestDeliveryAttemptSucceeded
        
    --     |> Dict.insert
    --         "timeLoggingStarted" "" -- val.timeLoggingStarted
        
    --     |> Dict.insert
    --         "timeLoggingStopped" "" -- val.timeLoggingStopped
...
listPublicKeysResponseToString : ListPublicKeysResponse -> String -- List (String, String)
listPublicKeysResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "publicKeyList" "" -- val.publicKeyList
...
listTagsResponseToString val =
    ...
    --     |> Dict.insert
    --         "resourceTagList" "" -- val.resourceTagList
...
lookupAttributeToString : LookupAttribute -> String -- List (String, String)
lookupAttributeToString val =
    -- Dict.empty
...
lookupEventsResponseToString : LookupEventsResponse -> String -- List (String, String)
lookupEventsResponseToString val =
    -- Dict.empty
...
publicKeyToString : PublicKey -> String -- List (String, String)
publicKeyToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "validityStartTime" "" -- val.validityStartTime
        
    --     |> Dict.insert
    --         "validityEndTime" "" -- val.validityEndTime
...
putEventSelectorsResponseToString : PutEventSelectorsResponse -> String -- List (String, String)
putEventSelectorsResponseToString val =
    -- Dict.empty
...
removeTagsResponseToString : RemoveTagsResponse -> String -- List (String, String)
removeTagsResponseToString val =
    -- Dict.empty
...
startLoggingResponseToString : StartLoggingResponse -> String -- List (String, String)
startLoggingResponseToString val =
    -- Dict.empty
...
stopLoggingResponseToString : StopLoggingResponse -> String -- List (String, String)
stopLoggingResponseToString val =
    -- Dict.empty
...
trailToString : Trail -> String -- List (String, String)
trailToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "hasCustomEventSelectors" "" -- val.hasCustomEventSelectors
...
updateTrailResponseToString : UpdateTrailResponse -> String -- List (String, String)
updateTrailResponseToString val =
    -- Dict.empty
