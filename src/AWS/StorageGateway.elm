module AWS.StorageGateway
    exposing
        ...
        , CreateTapeWithBarcodeOptions
        , createTapes
        , CreateTapesOptions
        , deleteBandwidthRateLimit
        , deleteChapCredentials
        , deleteFileShare
        , DeleteFileShareOptions
        , deleteGateway
        ...
        , UpdateMaintenanceStartTimeOptions
        , updateNFSFileShare
        , UpdateNFSFileShareOptions
        , updateSMBFileShare
        , UpdateSMBFileShareOptions
...
activateGateway activationKey gatewayName gatewayTimezone gatewayRegion setOptions =
    ...
    let
        requestInput = ActivateGatewayInput
        ...
        options = setOptions (ActivateGatewayOptions Nothing Nothing Nothing Nothing)
...
type alias ActivateGatewayOptions =
    {
    gatewayType : Maybe String,tapeDriveType : Maybe String,mediumChangerType : Maybe String,tags : Maybe (List Tag)
    }
...
addTagsToResource resourceARN tags =
    ...
    let
        requestInput = AddTagsToResourceInput
...
addUploadBuffer gatewayARN diskIds =
    ...
    let
        requestInput = AddUploadBufferInput
...
addWorkingStorage gatewayARN diskIds =
    ...
    let
        requestInput = AddWorkingStorageInput
...
assignTapePool tapeARN poolId =
    ...
    let
        requestInput = AssignTapePoolInput
...
attachVolume gatewayARN volumeARN networkInterfaceId setOptions =
    ...
    let
        requestInput = AttachVolumeInput
        ...
        options = setOptions (AttachVolumeOptions Nothing Nothing)
...
type alias AttachVolumeOptions =
    {
    targetName : Maybe String,diskId : Maybe String
    }
...
cancelArchival gatewayARN tapeARN =
    ...
    let
        requestInput = CancelArchivalInput
...
cancelRetrieval gatewayARN tapeARN =
    ...
    let
        requestInput = CancelRetrievalInput
...
createCachediSCSIVolume gatewayARN volumeSizeInBytes targetName networkInterfaceId clientToken setOptions =
    ...
    let
        requestInput = CreateCachediSCSIVolumeInput
        ...
        options = setOptions (CreateCachediSCSIVolumeOptions Nothing Nothing Nothing Nothing Nothing)
...
type alias CreateCachediSCSIVolumeOptions =
    {
    snapshotId : Maybe String,sourceVolumeARN : Maybe String,kMSEncrypted : Maybe Bool,kMSKey : Maybe String,tags : Maybe (List Tag)
    }
...
createNFSFileShare clientToken gatewayARN role locationARN setOptions =
    ...
    let
        requestInput = CreateNFSFileShareInput
        ...
        options = setOptions (CreateNFSFileShareOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
...
type alias CreateNFSFileShareOptions =
    {
    nFSFileShareDefaults : Maybe NFSFileShareDefaults,kMSEncrypted : Maybe Bool,kMSKey : Maybe String,defaultStorageClass : Maybe String,objectACL : Maybe ObjectACL,clientList : Maybe (List String),squash : Maybe String,readOnly : Maybe Bool,guessMIMETypeEnabled : Maybe Bool,requesterPays : Maybe Bool,tags : Maybe (List Tag)
    }
...
createSMBFileShare clientToken gatewayARN role locationARN setOptions =
    ...
    let
        requestInput = CreateSMBFileShareInput
        ...
        options = setOptions (CreateSMBFileShareOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
...
type alias CreateSMBFileShareOptions =
    {
    kMSEncrypted : Maybe Bool,kMSKey : Maybe String,defaultStorageClass : Maybe String,objectACL : Maybe ObjectACL,readOnly : Maybe Bool,guessMIMETypeEnabled : Maybe Bool,requesterPays : Maybe Bool,sMBACLEnabled : Maybe Bool,adminUserList : Maybe (List String),validUserList : Maybe (List String),invalidUserList : Maybe (List String),authentication : Maybe String,tags : Maybe (List Tag)
    }
...
createSnapshot volumeARN snapshotDescription setOptions =
    ...
    let
        requestInput = CreateSnapshotInput
...
createSnapshotFromVolumeRecoveryPoint volumeARN snapshotDescription =
    ...
    let
        requestInput = CreateSnapshotFromVolumeRecoveryPointInput
...
createStorediSCSIVolume gatewayARN diskId preserveExistingData targetName networkInterfaceId setOptions =
    ...
    let
        requestInput = CreateStorediSCSIVolumeInput
        ...
        options = setOptions (CreateStorediSCSIVolumeOptions Nothing Nothing Nothing Nothing)
...
type alias CreateStorediSCSIVolumeOptions =
    {
    snapshotId : Maybe String,kMSEncrypted : Maybe Bool,kMSKey : Maybe String,tags : Maybe (List Tag)
    }
...
createTapeWithBarcode gatewayARN tapeSizeInBytes tapeBarcode setOptions =
    ...
    let
        requestInput = CreateTapeWithBarcodeInput
        ...
        options = setOptions (CreateTapeWithBarcodeOptions Nothing Nothing Nothing Nothing)
...
type alias CreateTapeWithBarcodeOptions =
    {
    kMSEncrypted : Maybe Bool,kMSKey : Maybe String,poolId : Maybe String,tags : Maybe (List Tag)
    }
...
createTapes gatewayARN tapeSizeInBytes clientToken numTapesToCreate tapeBarcodePrefix setOptions =
    ...
    let
        ...
        options = setOptions (CreateTapesOptions Nothing Nothing Nothing Nothing)
...
deleteBandwidthRateLimit gatewayARN bandwidthType =
    ...
    let
        requestInput = DeleteBandwidthRateLimitInput
...
deleteChapCredentials targetARN initiatorName =
    ...
    let
        requestInput = DeleteChapCredentialsInput
...
deleteFileShare fileShareARN setOptions =
    ...
    let
        requestInput = DeleteFileShareInput
        ...
        options = setOptions (DeleteFileShareOptions Nothing)
...
deleteGateway gatewayARN =
    ...
    let
        requestInput = DeleteGatewayInput
...
deleteSnapshotSchedule volumeARN =
    ...
    let
        requestInput = DeleteSnapshotScheduleInput
...
deleteTapeArchive tapeARN =
    ...
    let
        requestInput = DeleteTapeArchiveInput
...
deleteVolume volumeARN =
    ...
    let
        requestInput = DeleteVolumeInput
...
describeBandwidthRateLimit gatewayARN =
    ...
    let
        requestInput = DescribeBandwidthRateLimitInput
...
describeCache gatewayARN =
    ...
    let
        requestInput = DescribeCacheInput
...
describeCachediSCSIVolumes volumeARNs =
    ...
    let
        requestInput = DescribeCachediSCSIVolumesInput
...
describeChapCredentials targetARN =
    ...
    let
        requestInput = DescribeChapCredentialsInput
...
describeGatewayInformation gatewayARN =
    ...
    let
        requestInput = DescribeGatewayInformationInput
...
describeMaintenanceStartTime gatewayARN =
    ...
    let
        requestInput = DescribeMaintenanceStartTimeInput
...
describeNFSFileShares fileShareARNList =
    ...
    let
        requestInput = DescribeNFSFileSharesInput
...
describeSMBFileShares fileShareARNList =
    ...
    let
        requestInput = DescribeSMBFileSharesInput
...
describeSMBSettings gatewayARN =
    ...
    let
        requestInput = DescribeSMBSettingsInput
...
describeSnapshotSchedule volumeARN =
    ...
    let
        requestInput = DescribeSnapshotScheduleInput
...
describeStorediSCSIVolumes volumeARNs =
    ...
    let
        requestInput = DescribeStorediSCSIVolumesInput
...
describeTapeArchives setOptions =
    ...
    let
        requestInput = DescribeTapeArchivesInput
...
type alias DescribeTapeArchivesOptions =
    {
    tapeARNs : Maybe (List String),marker : Maybe String,limit : Maybe Int
    }
...
describeTapeRecoveryPoints gatewayARN setOptions =
    ...
    let
        requestInput = DescribeTapeRecoveryPointsInput
...
type alias DescribeTapeRecoveryPointsOptions =
    {
    marker : Maybe String,limit : Maybe Int
    }
...
describeTapes gatewayARN setOptions =
    ...
    let
        requestInput = DescribeTapesInput
...
describeUploadBuffer gatewayARN =
    ...
    let
        requestInput = DescribeUploadBufferInput
...
describeVTLDevices gatewayARN setOptions =
    ...
    let
        requestInput = DescribeVTLDevicesInput
...
type alias DescribeVTLDevicesOptions =
    {
    vTLDeviceARNs : Maybe (List String),marker : Maybe String,limit : Maybe Int
    }
...
describeWorkingStorage gatewayARN =
    ...
    let
        requestInput = DescribeWorkingStorageInput
...
detachVolume volumeARN setOptions =
    ...
    let
        requestInput = DetachVolumeInput
        ...
        options = setOptions (DetachVolumeOptions Nothing)
...
disableGateway gatewayARN =
    ...
    let
        requestInput = DisableGatewayInput
...
joinDomain gatewayARN domainName userName password setOptions =
    ...
    let
        ...
        options = setOptions (JoinDomainOptions Nothing Nothing)
...
type alias JoinDomainOptions =
    {
    organizationalUnit : Maybe String,domainControllers : Maybe (List String)
    }
...
listFileShares setOptions =
    ...
    let
        requestInput = ListFileSharesInput
...
type alias ListFileSharesOptions =
    {
    gatewayARN : Maybe String,limit : Maybe Int,marker : Maybe String
    }
...
listGateways setOptions =
    ...
    let
        requestInput = ListGatewaysInput
...
listLocalDisks gatewayARN =
    ...
    let
        requestInput = ListLocalDisksInput
...
listVolumeInitiators volumeARN =
    ...
    let
        requestInput = ListVolumeInitiatorsInput
...
listVolumeRecoveryPoints gatewayARN =
    ...
    let
        requestInput = ListVolumeRecoveryPointsInput
...
type alias ListVolumesOptions =
    {
    gatewayARN : Maybe String,marker : Maybe String,limit : Maybe Int
    }
...
notifyWhenUploaded fileShareARN =
    ...
    let
        requestInput = NotifyWhenUploadedInput
...
refreshCache fileShareARN setOptions =
    ...
    let
        requestInput = RefreshCacheInput
        ...
        options = setOptions (RefreshCacheOptions Nothing Nothing)
...
type alias RefreshCacheOptions =
    {
    folderList : Maybe (List String),recursive : Maybe Bool
    }
...
removeTagsFromResource resourceARN tagKeys =
    ...
    let
        requestInput = RemoveTagsFromResourceInput
...
retrieveTapeArchive tapeARN gatewayARN =
    ...
    let
        requestInput = RetrieveTapeArchiveInput
...
retrieveTapeRecoveryPoint tapeARN gatewayARN =
    ...
    let
        requestInput = RetrieveTapeRecoveryPointInput
...
setLocalConsolePassword gatewayARN localConsolePassword =
    ...
    let
        requestInput = SetLocalConsolePasswordInput
...
setSMBGuestPassword gatewayARN password =
    ...
    let
        requestInput = SetSMBGuestPasswordInput
...
shutdownGateway gatewayARN =
    ...
    let
        requestInput = ShutdownGatewayInput
...
startGateway gatewayARN =
    ...
    let
        requestInput = StartGatewayInput
...
updateBandwidthRateLimit gatewayARN setOptions =
    ...
    let
        requestInput = UpdateBandwidthRateLimitInput
...
type alias UpdateBandwidthRateLimitOptions =
    {
    averageUploadRateLimitInBitsPerSec : Maybe Int,averageDownloadRateLimitInBitsPerSec : Maybe Int
    }
...
updateChapCredentials targetARN secretToAuthenticateInitiator initiatorName setOptions =
    ...
    let
        requestInput = UpdateChapCredentialsInput
...
updateGatewayInformation gatewayARN setOptions =
    ...
    let
        requestInput = UpdateGatewayInformationInput
...
type alias UpdateGatewayInformationOptions =
    {
    gatewayName : Maybe String,gatewayTimezone : Maybe String
    }
...
updateGatewaySoftwareNow gatewayARN =
    ...
    let
        requestInput = UpdateGatewaySoftwareNowInput
...
updateMaintenanceStartTime gatewayARN hourOfDay minuteOfHour setOptions =
    ...
    let
        requestInput = UpdateMaintenanceStartTimeInput
        ...
        options = setOptions (UpdateMaintenanceStartTimeOptions Nothing Nothing)
...
type alias UpdateMaintenanceStartTimeOptions =
    {
    dayOfWeek : Maybe Int,dayOfMonth : Maybe Int
    }
...
updateNFSFileShare fileShareARN setOptions =
    ...
    let
        requestInput = UpdateNFSFileShareInput
        ...
        options = setOptions (UpdateNFSFileShareOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
...
type alias UpdateNFSFileShareOptions =
    {
    kMSEncrypted : Maybe Bool,kMSKey : Maybe String,nFSFileShareDefaults : Maybe NFSFileShareDefaults,defaultStorageClass : Maybe String,objectACL : Maybe ObjectACL,clientList : Maybe (List String),squash : Maybe String,readOnly : Maybe Bool,guessMIMETypeEnabled : Maybe Bool,requesterPays : Maybe Bool
    }
...
updateSMBFileShare fileShareARN setOptions =
    ...
    let
        requestInput = UpdateSMBFileShareInput
        ...
        options = setOptions (UpdateSMBFileShareOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
...
type alias UpdateSMBFileShareOptions =
    {
    kMSEncrypted : Maybe Bool,kMSKey : Maybe String,defaultStorageClass : Maybe String,objectACL : Maybe ObjectACL,readOnly : Maybe Bool,guessMIMETypeEnabled : Maybe Bool,requesterPays : Maybe Bool,sMBACLEnabled : Maybe Bool,adminUserList : Maybe (List String),validUserList : Maybe (List String),invalidUserList : Maybe (List String)
    }
...
* `gatewayARN` __:__ `String`
* `sMBSecurityStrategy` __:__ `SMBSecurityStrategy`
...
updateSMBSecurityStrategy gatewayARN sMBSecurityStrategy =
    ...
    let
        requestInput = UpdateSMBSecurityStrategyInput
...
updateSnapshotSchedule volumeARN startAt recurrenceInHours setOptions =
    ...
    let
        requestInput = UpdateSnapshotScheduleInput
        ...
        options = setOptions (UpdateSnapshotScheduleOptions Nothing Nothing)
...
updateVTLDeviceType vTLDeviceARN deviceType =
    ...
    let
        requestInput = UpdateVTLDeviceTypeInput
...
activateGatewayOutputToString : ActivateGatewayOutput -> String -- List (String, String)
activateGatewayOutputToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "gatewayARN" "" -- val.gatewayARN
...
addCacheOutputToString : AddCacheOutput -> String -- List (String, String)
addCacheOutputToString val =
    -- Dict.empty
...
addTagsToResourceOutputToString : AddTagsToResourceOutput -> String -- List (String, String)
addTagsToResourceOutputToString val =
    -- Dict.empty
...
addUploadBufferOutputToString : AddUploadBufferOutput -> String -- List (String, String)
addUploadBufferOutputToString val =
    -- Dict.empty
...
addWorkingStorageOutputToString : AddWorkingStorageOutput -> String -- List (String, String)
addWorkingStorageOutputToString val =
    -- Dict.empty
...
assignTapePoolOutputToString : AssignTapePoolOutput -> String -- List (String, String)
assignTapePoolOutputToString val =
    -- Dict.empty
...
attachVolumeOutputToString : AttachVolumeOutput -> String -- List (String, String)
attachVolumeOutputToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "volumeARN" "" -- val.volumeARN
...
cachediSCSIVolumeToString : CachediSCSIVolume -> String -- List (String, String)
cachediSCSIVolumeToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "volumeStatus" "" -- val.volumeStatus
        
    --     |> Dict.insert
    --         "volumeAttachmentStatus" "" -- val.volumeAttachmentStatus
        
    --     |> Dict.insert
    --         "volumeSizeInBytes" "" -- val.volumeSizeInBytes
        
    --     |> Dict.insert
    --         "volumeProgress" "" -- val.volumeProgress
        
    --     |> Dict.insert
    --         "sourceSnapshotId" "" -- val.sourceSnapshotId
        
    --     |> Dict.insert
    --         "volumeiSCSIAttributes" "" -- val.volumeiSCSIAttributes
        
    --     |> Dict.insert
    --         "createdDate" "" -- val.createdDate
        
    --     |> Dict.insert
    --         "volumeUsedInBytes" "" -- val.volumeUsedInBytes
...
cancelArchivalOutputToString : CancelArchivalOutput -> String -- List (String, String)
cancelArchivalOutputToString val =
    -- Dict.empty
...
cancelRetrievalOutputToString : CancelRetrievalOutput -> String -- List (String, String)
cancelRetrievalOutputToString val =
    -- Dict.empty
...
chapInfoToString : ChapInfo -> String -- List (String, String)
chapInfoToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "secretToAuthenticateInitiator" "" -- val.secretToAuthenticateInitiator
        
    --     |> Dict.insert
    --         "initiatorName" "" -- val.initiatorName
        
    --     |> Dict.insert
    --         "secretToAuthenticateTarget" "" -- val.secretToAuthenticateTarget
...
createCachediSCSIVolumeOutputToString : CreateCachediSCSIVolumeOutput -> String -- List (String, String)
createCachediSCSIVolumeOutputToString val =
    -- Dict.empty
...
createNFSFileShareOutputToString : CreateNFSFileShareOutput -> String -- List (String, String)
createNFSFileShareOutputToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "fileShareARN" "" -- val.fileShareARN
...
createSMBFileShareOutputToString : CreateSMBFileShareOutput -> String -- List (String, String)
createSMBFileShareOutputToString val =
    -- Dict.empty
...
createSnapshotFromVolumeRecoveryPointOutputToString : CreateSnapshotFromVolumeRecoveryPointOutput -> String -- List (String, String)
createSnapshotFromVolumeRecoveryPointOutputToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "volumeRecoveryPointTime" "" -- val.volumeRecoveryPointTime
...
createSnapshotOutputToString : CreateSnapshotOutput -> String -- List (String, String)
createSnapshotOutputToString val =
    -- Dict.empty
...
createStorediSCSIVolumeOutputToString : CreateStorediSCSIVolumeOutput -> String -- List (String, String)
createStorediSCSIVolumeOutputToString val =
    -- Dict.empty
...
createTapeWithBarcodeOutputToString : CreateTapeWithBarcodeOutput -> String -- List (String, String)
createTapeWithBarcodeOutputToString val =
    -- Dict.empty
...
createTapesOutputToString : CreateTapesOutput -> String -- List (String, String)
createTapesOutputToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "tapeARNs" "" -- val.tapeARNs
...
deleteBandwidthRateLimitOutputToString : DeleteBandwidthRateLimitOutput -> String -- List (String, String)
deleteBandwidthRateLimitOutputToString val =
    -- Dict.empty
...
deleteChapCredentialsOutputToString : DeleteChapCredentialsOutput -> String -- List (String, String)
deleteChapCredentialsOutputToString val =
    -- Dict.empty
...
deleteFileShareOutputToString : DeleteFileShareOutput -> String -- List (String, String)
deleteFileShareOutputToString val =
    -- Dict.empty
...
deleteGatewayOutputToString : DeleteGatewayOutput -> String -- List (String, String)
deleteGatewayOutputToString val =
    -- Dict.empty
...
deleteSnapshotScheduleOutputToString : DeleteSnapshotScheduleOutput -> String -- List (String, String)
deleteSnapshotScheduleOutputToString val =
    -- Dict.empty
...
deleteTapeArchiveOutputToString : DeleteTapeArchiveOutput -> String -- List (String, String)
deleteTapeArchiveOutputToString val =
    -- Dict.empty
...
deleteTapeOutputToString : DeleteTapeOutput -> String -- List (String, String)
deleteTapeOutputToString val =
    -- Dict.empty
...
deleteVolumeOutputToString : DeleteVolumeOutput -> String -- List (String, String)
deleteVolumeOutputToString val =
    -- Dict.empty
...
describeBandwidthRateLimitOutputToString : DescribeBandwidthRateLimitOutput -> String -- List (String, String)
describeBandwidthRateLimitOutputToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "averageUploadRateLimitInBitsPerSec" "" -- val.averageUploadRateLimitInBitsPerSec
        
    --     |> Dict.insert
    --         "averageDownloadRateLimitInBitsPerSec" "" -- val.averageDownloadRateLimitInBitsPerSec
...
describeCacheOutputToString : DescribeCacheOutput -> String -- List (String, String)
describeCacheOutputToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "cacheAllocatedInBytes" "" -- val.cacheAllocatedInBytes
        
    --     |> Dict.insert
    --         "cacheUsedPercentage" "" -- val.cacheUsedPercentage
        
    --     |> Dict.insert
    --         "cacheDirtyPercentage" "" -- val.cacheDirtyPercentage
        
    --     |> Dict.insert
    --         "cacheHitPercentage" "" -- val.cacheHitPercentage
        
    --     |> Dict.insert
    --         "cacheMissPercentage" "" -- val.cacheMissPercentage
...
describeCachediSCSIVolumesOutputToString : DescribeCachediSCSIVolumesOutput -> String -- List (String, String)
describeCachediSCSIVolumesOutputToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "cachediSCSIVolumes" "" -- val.cachediSCSIVolumes
...
describeChapCredentialsOutputToString : DescribeChapCredentialsOutput -> String -- List (String, String)
describeChapCredentialsOutputToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "chapCredentials" "" -- val.chapCredentials
...
describeGatewayInformationOutputToString : DescribeGatewayInformationOutput -> String -- List (String, String)
describeGatewayInformationOutputToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "gatewayTimezone" "" -- val.gatewayTimezone
        
    --     |> Dict.insert
    --         "gatewayState" "" -- val.gatewayState
        
    --     |> Dict.insert
    --         "gatewayNetworkInterfaces" "" -- val.gatewayNetworkInterfaces
        
    --     |> Dict.insert
    --         "gatewayType" "" -- val.gatewayType
        
    --     |> Dict.insert
    --         "nextUpdateAvailabilityDate" "" -- val.nextUpdateAvailabilityDate
        
    --     |> Dict.insert
    --         "lastSoftwareUpdate" "" -- val.lastSoftwareUpdate
        
    --     |> Dict.insert
    --         "ec2InstanceId" "" -- val.ec2InstanceId
        
    --     |> Dict.insert
    --         "ec2InstanceRegion" "" -- val.ec2InstanceRegion
        
    --     |> Dict.insert
    --         "tags" "" -- val.tags
        
    --     |> Dict.insert
    --         "vPCEndpoint" "" -- val.vPCEndpoint
...
describeMaintenanceStartTimeOutputToString : DescribeMaintenanceStartTimeOutput -> String -- List (String, String)
describeMaintenanceStartTimeOutputToString val =
    -- Dict.empty
...
describeNFSFileSharesOutputToString : DescribeNFSFileSharesOutput -> String -- List (String, String)
describeNFSFileSharesOutputToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "nFSFileShareInfoList" "" -- val.nFSFileShareInfoList
...
describeSMBFileSharesOutputToString : DescribeSMBFileSharesOutput -> String -- List (String, String)
describeSMBFileSharesOutputToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "sMBFileShareInfoList" "" -- val.sMBFileShareInfoList
...
describeSMBSettingsOutputToString : DescribeSMBSettingsOutput -> String -- List (String, String)
describeSMBSettingsOutputToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "sMBGuestPasswordSet" "" -- val.sMBGuestPasswordSet
        
    --     |> Dict.insert
    --         "sMBSecurityStrategy" "" -- val.sMBSecurityStrategy
...
describeSnapshotScheduleOutputToString : DescribeSnapshotScheduleOutput -> String -- List (String, String)
describeSnapshotScheduleOutputToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "recurrenceInHours" "" -- val.recurrenceInHours
...
describeStorediSCSIVolumesOutputToString : DescribeStorediSCSIVolumesOutput -> String -- List (String, String)
describeStorediSCSIVolumesOutputToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "storediSCSIVolumes" "" -- val.storediSCSIVolumes
...
describeTapeArchivesOutputToString : DescribeTapeArchivesOutput -> String -- List (String, String)
describeTapeArchivesOutputToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "tapeArchives" "" -- val.tapeArchives
...
describeTapeRecoveryPointsOutputToString : DescribeTapeRecoveryPointsOutput -> String -- List (String, String)
describeTapeRecoveryPointsOutputToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "tapeRecoveryPointInfos" "" -- val.tapeRecoveryPointInfos
...
describeTapesOutputToString : DescribeTapesOutput -> String -- List (String, String)
describeTapesOutputToString val =
    -- Dict.empty
...
describeUploadBufferOutputToString : DescribeUploadBufferOutput -> String -- List (String, String)
describeUploadBufferOutputToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "uploadBufferUsedInBytes" "" -- val.uploadBufferUsedInBytes
        
    --     |> Dict.insert
    --         "uploadBufferAllocatedInBytes" "" -- val.uploadBufferAllocatedInBytes
...
describeVTLDevicesOutputToString : DescribeVTLDevicesOutput -> String -- List (String, String)
describeVTLDevicesOutputToString val =
    -- Dict.empty
...
describeWorkingStorageOutputToString : DescribeWorkingStorageOutput -> String -- List (String, String)
describeWorkingStorageOutputToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "workingStorageUsedInBytes" "" -- val.workingStorageUsedInBytes
        
    --     |> Dict.insert
    --         "workingStorageAllocatedInBytes" "" -- val.workingStorageAllocatedInBytes
...
detachVolumeOutputToString : DetachVolumeOutput -> String -- List (String, String)
detachVolumeOutputToString val =
    -- Dict.empty
...
deviceiSCSIAttributesToString : DeviceiSCSIAttributes -> String -- List (String, String)
deviceiSCSIAttributesToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "networkInterfacePort" "" -- val.networkInterfacePort
        
    --     |> Dict.insert
    --         "chapEnabled" "" -- val.chapEnabled
...
disableGatewayOutputToString : DisableGatewayOutput -> String -- List (String, String)
disableGatewayOutputToString val =
    -- Dict.empty
...
diskToString val =
    ...
    --     |> Dict.insert
    --         "diskNode" "" -- val.diskNode
        
    --     |> Dict.insert
    --         "diskStatus" "" -- val.diskStatus
        
    --     |> Dict.insert
    --         "diskSizeInBytes" "" -- val.diskSizeInBytes
        
    --     |> Dict.insert
    --         "diskAllocationType" "" -- val.diskAllocationType
        
    --     |> Dict.insert
    --         "diskAllocationResource" "" -- val.diskAllocationResource
        
    --     |> Dict.insert
    --         "diskAttributeList" "" -- val.diskAttributeList
...
fileShareInfoToString : FileShareInfo -> String -- List (String, String)
fileShareInfoToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "fileShareType" "" -- val.fileShareType
        
    --     |> Dict.insert
    --         "fileShareARN" "" -- val.fileShareARN
        
    --     |> Dict.insert
    --         "fileShareId" "" -- val.fileShareId
        
    --     |> Dict.insert
    --         "fileShareStatus" "" -- val.fileShareStatus
...
gatewayInfoToString : GatewayInfo -> String -- List (String, String)
gatewayInfoToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "gatewayOperationalState" "" -- val.gatewayOperationalState
...
joinDomainOutputToString : JoinDomainOutput -> String -- List (String, String)
joinDomainOutputToString val =
    -- Dict.empty
...
listFileSharesOutputToString : ListFileSharesOutput -> String -- List (String, String)
listFileSharesOutputToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "fileShareInfoList" "" -- val.fileShareInfoList
...
listGatewaysOutputToString : ListGatewaysOutput -> String -- List (String, String)
listGatewaysOutputToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "gateways" "" -- val.gateways
...
listLocalDisksOutputToString : ListLocalDisksOutput -> String -- List (String, String)
listLocalDisksOutputToString val =
    -- Dict.empty
...
listTapesOutputToString : ListTapesOutput -> String -- List (String, String)
listTapesOutputToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "tapeInfos" "" -- val.tapeInfos
...
listVolumeInitiatorsOutputToString : ListVolumeInitiatorsOutput -> String -- List (String, String)
listVolumeInitiatorsOutputToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "initiators" "" -- val.initiators
...
listVolumeRecoveryPointsOutputToString : ListVolumeRecoveryPointsOutput -> String -- List (String, String)
listVolumeRecoveryPointsOutputToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "volumeRecoveryPointInfos" "" -- val.volumeRecoveryPointInfos
...
listVolumesOutputToString : ListVolumesOutput -> String -- List (String, String)
listVolumesOutputToString val =
    -- Dict.empty
...
nFSFileShareDefaultsToString : NFSFileShareDefaults -> String -- List (String, String)
nFSFileShareDefaultsToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "directoryMode" "" -- val.directoryMode
...
nFSFileShareInfoToString : NFSFileShareInfo -> String -- List (String, String)
nFSFileShareInfoToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "nFSFileShareDefaults" "" -- val.nFSFileShareDefaults
    ...
    --     |> Dict.insert
    --         "locationARN" "" -- val.locationARN
        
    --     |> Dict.insert
    --         "defaultStorageClass" "" -- val.defaultStorageClass
        
    --     |> Dict.insert
    --         "objectACL" "" -- val.objectACL
    ...
    --     |> Dict.insert
    --         "guessMIMETypeEnabled" "" -- val.guessMIMETypeEnabled
        
    --     |> Dict.insert
    --         "requesterPays" "" -- val.requesterPays
...
notifyWhenUploadedOutputToString : NotifyWhenUploadedOutput -> String -- List (String, String)
notifyWhenUploadedOutputToString val =
    -- Dict.empty
...
refreshCacheOutputToString : RefreshCacheOutput -> String -- List (String, String)
refreshCacheOutputToString val =
    -- Dict.empty
...
removeTagsFromResourceOutputToString : RemoveTagsFromResourceOutput -> String -- List (String, String)
removeTagsFromResourceOutputToString val =
    -- Dict.empty
...
resetCacheOutputToString : ResetCacheOutput -> String -- List (String, String)
resetCacheOutputToString val =
    -- Dict.empty
...
retrieveTapeArchiveOutputToString : RetrieveTapeArchiveOutput -> String -- List (String, String)
retrieveTapeArchiveOutputToString val =
    -- Dict.empty
...
retrieveTapeRecoveryPointOutputToString : RetrieveTapeRecoveryPointOutput -> String -- List (String, String)
retrieveTapeRecoveryPointOutputToString val =
    -- Dict.empty
...
sMBFileShareInfoToString : SMBFileShareInfo -> String -- List (String, String)
sMBFileShareInfoToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "sMBACLEnabled" "" -- val.sMBACLEnabled
        
    --     |> Dict.insert
    --         "adminUserList" "" -- val.adminUserList
        
    --     |> Dict.insert
    --         "validUserList" "" -- val.validUserList
        
    --     |> Dict.insert
    --         "invalidUserList" "" -- val.invalidUserList
...
setLocalConsolePasswordOutputToString : SetLocalConsolePasswordOutput -> String -- List (String, String)
setLocalConsolePasswordOutputToString val =
    -- Dict.empty
...
setSMBGuestPasswordOutputToString : SetSMBGuestPasswordOutput -> String -- List (String, String)
setSMBGuestPasswordOutputToString val =
    -- Dict.empty
...
shutdownGatewayOutputToString : ShutdownGatewayOutput -> String -- List (String, String)
shutdownGatewayOutputToString val =
    -- Dict.empty
...
startGatewayOutputToString : StartGatewayOutput -> String -- List (String, String)
startGatewayOutputToString val =
    -- Dict.empty
...
storediSCSIVolumeToString : StorediSCSIVolume -> String -- List (String, String)
storediSCSIVolumeToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "volumeDiskId" "" -- val.volumeDiskId
        
    --     |> Dict.insert
    --         "sourceSnapshotId" "" -- val.sourceSnapshotId
        
    --     |> Dict.insert
    --         "preservedExistingData" "" -- val.preservedExistingData
...
tapeToString : Tape -> String -- List (String, String)
tapeToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "tapeBarcode" "" -- val.tapeBarcode
        
    --     |> Dict.insert
    --         "tapeCreatedDate" "" -- val.tapeCreatedDate
        
    --     |> Dict.insert
    --         "tapeSizeInBytes" "" -- val.tapeSizeInBytes
        
    --     |> Dict.insert
    --         "tapeStatus" "" -- val.tapeStatus
        
    --     |> Dict.insert
    --         "vTLDevice" "" -- val.vTLDevice
        
    --     |> Dict.insert
    --         "progress" "" -- val.progress
        
    --     |> Dict.insert
    --         "tapeUsedInBytes" "" -- val.tapeUsedInBytes
...
tapeArchiveToString : TapeArchive -> String -- List (String, String)
tapeArchiveToString val =
    -- Dict.empty
...
tapeInfoToString : TapeInfo -> String -- List (String, String)
tapeInfoToString val =
    -- Dict.empty
...
tapeRecoveryPointInfoToString : TapeRecoveryPointInfo -> String -- List (String, String)
tapeRecoveryPointInfoToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "tapeRecoveryPointTime" "" -- val.tapeRecoveryPointTime
...
updateBandwidthRateLimitOutputToString : UpdateBandwidthRateLimitOutput -> String -- List (String, String)
updateBandwidthRateLimitOutputToString val =
    -- Dict.empty
...
updateChapCredentialsOutputToString : UpdateChapCredentialsOutput -> String -- List (String, String)
updateChapCredentialsOutputToString val =
    -- Dict.empty
...
updateGatewayInformationOutputToString : UpdateGatewayInformationOutput -> String -- List (String, String)
updateGatewayInformationOutputToString val =
    -- Dict.empty
...
updateGatewaySoftwareNowOutputToString : UpdateGatewaySoftwareNowOutput -> String -- List (String, String)
updateGatewaySoftwareNowOutputToString val =
    -- Dict.empty
...
updateMaintenanceStartTimeOutputToString : UpdateMaintenanceStartTimeOutput -> String -- List (String, String)
updateMaintenanceStartTimeOutputToString val =
    -- Dict.empty
...
updateNFSFileShareOutputToString : UpdateNFSFileShareOutput -> String -- List (String, String)
updateNFSFileShareOutputToString val =
    -- Dict.empty
...
updateSMBFileShareOutputToString : UpdateSMBFileShareOutput -> String -- List (String, String)
updateSMBFileShareOutputToString val =
    -- Dict.empty
...
updateSMBSecurityStrategyOutputToString : UpdateSMBSecurityStrategyOutput -> String -- List (String, String)
updateSMBSecurityStrategyOutputToString val =
    -- Dict.empty
...
updateSnapshotScheduleOutputToString : UpdateSnapshotScheduleOutput -> String -- List (String, String)
updateSnapshotScheduleOutputToString val =
    -- Dict.empty
...
updateVTLDeviceTypeOutputToString : UpdateVTLDeviceTypeOutput -> String -- List (String, String)
updateVTLDeviceTypeOutputToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "vTLDeviceARN" "" -- val.vTLDeviceARN
...
vTLDeviceToString : VTLDevice -> String -- List (String, String)
vTLDeviceToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "vTLDeviceType" "" -- val.vTLDeviceType
        
    --     |> Dict.insert
    --         "vTLDeviceVendor" "" -- val.vTLDeviceVendor
        
    --     |> Dict.insert
    --         "vTLDeviceProductIdentifier" "" -- val.vTLDeviceProductIdentifier
        
    --     |> Dict.insert
    --         "deviceiSCSIAttributes" "" -- val.deviceiSCSIAttributes
...
volumeInfoToString : VolumeInfo -> String -- List (String, String)
volumeInfoToString val =
    -- Dict.empty
...
volumeRecoveryPointInfoToString : VolumeRecoveryPointInfo -> String -- List (String, String)
volumeRecoveryPointInfoToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "volumeUsageInBytes" "" -- val.volumeUsageInBytes
...
volumeiSCSIAttributesToString : VolumeiSCSIAttributes -> String -- List (String, String)
volumeiSCSIAttributesToString val =
    -- Dict.empty
