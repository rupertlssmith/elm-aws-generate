module AWS.CodeDeploy
    exposing
        ...
        , BatchGetDeploymentTargetsOptions
        , batchGetDeployments
        ...
        , DeleteGitHubAccountTokenOptions
        ...
        , ListDeploymentTargetsOptions
        , listDeployments
        , ListDeploymentsOptions
        , listGitHubAccountTokenNames
        , ListGitHubAccountTokenNamesOptions
        , listOnPremisesInstances
        , ListOnPremisesInstancesOptions
        , listTagsForResource
        , ListTagsForResourceOptions
        , putLifecycleEventHookExecutionStatus
        , PutLifecycleEventHookExecutionStatusOptions
...
addTagsToOnPremisesInstances tags instanceNames =
    ...
    let
        requestInput = AddTagsToOnPremisesInstancesInput
...
batchGetApplicationRevisions applicationName revisions =
    ...
    let
        requestInput = BatchGetApplicationRevisionsInput
...
* `applicationNames` __:__ `(List String)`
...
batchGetApplications applicationNames =
    ...
    let
        requestInput = BatchGetApplicationsInput
...
batchGetDeploymentGroups applicationName deploymentGroupNames =
    ...
    let
        requestInput = BatchGetDeploymentGroupsInput
...
batchGetDeploymentInstances deploymentId instanceIds =
    ...
    let
        requestInput = BatchGetDeploymentInstancesInput
...
batchGetDeploymentTargets setOptions =
    ...
    let
        requestInput = BatchGetDeploymentTargetsInput
        ...
        options = setOptions (BatchGetDeploymentTargetsOptions Nothing Nothing)
...
type alias BatchGetDeploymentTargetsOptions =
    {
    deploymentId : Maybe String,targetIds : Maybe (List String)
    }
...
* `deploymentIds` __:__ `(List String)`
...
batchGetDeployments deploymentIds =
    ...
    let
        requestInput = BatchGetDeploymentsInput
...
batchGetOnPremisesInstances instanceNames =
    ...
    let
        requestInput = BatchGetOnPremisesInstancesInput
...
continueDeployment setOptions =
    ...
    let
        requestInput = ContinueDeploymentInput
        ...
        options = setOptions (ContinueDeploymentOptions Nothing Nothing)
...
type alias ContinueDeploymentOptions =
    {
    deploymentId : Maybe String,deploymentWaitType : Maybe DeploymentWaitType
    }
...
createApplication applicationName setOptions =
    ...
    let
        requestInput = CreateApplicationInput
...
type alias CreateApplicationOptions =
    {
    computePlatform : Maybe ComputePlatform,tags : Maybe (List Tag)
    }
...
createDeployment applicationName setOptions =
    ...
    let
        requestInput = CreateDeploymentInput
        ...
        options = setOptions (CreateDeploymentOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
...
type alias CreateDeploymentOptions =
    {
    deploymentGroupName : Maybe String,revision : Maybe RevisionLocation,deploymentConfigName : Maybe String,description : Maybe String,ignoreApplicationStopFailures : Maybe Bool,targetInstances : Maybe TargetInstances,autoRollbackConfiguration : Maybe AutoRollbackConfiguration,updateOutdatedInstancesOnly : Maybe Bool,fileExistsBehavior : Maybe FileExistsBehavior
    }
...
createDeploymentConfig deploymentConfigName setOptions =
    ...
    let
        requestInput = CreateDeploymentConfigInput
        ...
        options = setOptions (CreateDeploymentConfigOptions Nothing Nothing Nothing)
...
type alias CreateDeploymentConfigOptions =
    {
    minimumHealthyHosts : Maybe MinimumHealthyHosts,trafficRoutingConfig : Maybe TrafficRoutingConfig,computePlatform : Maybe ComputePlatform
    }
...
createDeploymentGroup applicationName deploymentGroupName serviceRoleArn setOptions =
    ...
    let
        requestInput = CreateDeploymentGroupInput
        ...
        options = setOptions (CreateDeploymentGroupOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
...
type alias CreateDeploymentGroupOptions =
    {
    deploymentConfigName : Maybe String,ec2TagFilters : Maybe (List EC2TagFilter),onPremisesInstanceTagFilters : Maybe (List TagFilter),autoScalingGroups : Maybe (List String),triggerConfigurations : Maybe (List TriggerConfig),alarmConfiguration : Maybe AlarmConfiguration,autoRollbackConfiguration : Maybe AutoRollbackConfiguration,deploymentStyle : Maybe DeploymentStyle,blueGreenDeploymentConfiguration : Maybe BlueGreenDeploymentConfiguration,loadBalancerInfo : Maybe LoadBalancerInfo,ec2TagSet : Maybe EC2TagSet,ecsServices : Maybe (List ECSService),onPremisesTagSet : Maybe OnPremisesTagSet,tags : Maybe (List Tag)
    }
...
deleteApplication applicationName =
    ...
    let
        requestInput = DeleteApplicationInput
...
deleteDeploymentConfig deploymentConfigName =
    ...
    let
        requestInput = DeleteDeploymentConfigInput
...
deleteDeploymentGroup applicationName deploymentGroupName =
    ...
    let
        requestInput = DeleteDeploymentGroupInput
...
deleteGitHubAccountToken setOptions =
    ...
    let
        requestInput = DeleteGitHubAccountTokenInput
            
            options.tokenName
            
        
        options = setOptions (DeleteGitHubAccountTokenOptions Nothing)
...
deregisterOnPremisesInstance instanceName =
    ...
    let
        requestInput = DeregisterOnPremisesInstanceInput
...
getApplication applicationName =
    ...
    let
        requestInput = GetApplicationInput
...
getApplicationRevision applicationName revision =
    ...
    let
        requestInput = GetApplicationRevisionInput
...
getDeployment deploymentId =
    ...
    let
        requestInput = GetDeploymentInput
...
getDeploymentConfig deploymentConfigName =
    ...
    let
        requestInput = GetDeploymentConfigInput
...
getDeploymentGroup applicationName deploymentGroupName =
    ...
    let
        requestInput = GetDeploymentGroupInput
...
getDeploymentInstance deploymentId instanceId =
    ...
    let
        requestInput = GetDeploymentInstanceInput
...
getDeploymentTarget setOptions =
    ...
    let
        requestInput = GetDeploymentTargetInput
        ...
        options = setOptions (GetDeploymentTargetOptions Nothing Nothing)
...
type alias GetDeploymentTargetOptions =
    {
    deploymentId : Maybe String,targetId : Maybe String
    }
...
getOnPremisesInstance instanceName =
    ...
    let
        requestInput = GetOnPremisesInstanceInput
...
listApplicationRevisions applicationName setOptions =
    ...
    let
        requestInput = ListApplicationRevisionsInput
...
type alias ListApplicationRevisionsOptions =
    {
    sortBy : Maybe ApplicationRevisionSortBy,sortOrder : Maybe SortOrder,s3Bucket : Maybe String,s3KeyPrefix : Maybe String,deployed : Maybe ListStateFilterAction,nextToken : Maybe String
    }
...
listApplications setOptions =
    ...
    let
        requestInput = ListApplicationsInput
...
listDeploymentConfigs setOptions =
    ...
    let
        requestInput = ListDeploymentConfigsInput
...
listDeploymentGroups applicationName setOptions =
    ...
    let
        requestInput = ListDeploymentGroupsInput
...
listDeploymentInstances deploymentId setOptions =
    ...
    let
        requestInput = ListDeploymentInstancesInput
...
type alias ListDeploymentInstancesOptions =
    {
    nextToken : Maybe String,instanceStatusFilter : Maybe (List InstanceStatus),instanceTypeFilter : Maybe (List InstanceType)
    }
...
listDeploymentTargets setOptions =
    ...
    let
        requestInput = ListDeploymentTargetsInput
        ...
        options = setOptions (ListDeploymentTargetsOptions Nothing Nothing Nothing)
...
type alias ListDeploymentTargetsOptions =
    {
    deploymentId : Maybe String,nextToken : Maybe String,targetFilters : Maybe (Dict String (List String))
    }
...
listDeployments setOptions =
    ...
    let
        requestInput = ListDeploymentsInput
...
type alias ListDeploymentsOptions =
    {
    applicationName : Maybe String,deploymentGroupName : Maybe String,includeOnlyStatuses : Maybe (List DeploymentStatus),createTimeRange : Maybe TimeRange,nextToken : Maybe String
    }
...
listGitHubAccountTokenNames setOptions =
    ...
    let
        requestInput = ListGitHubAccountTokenNamesInput
            
            options.nextToken
            
        
        options = setOptions (ListGitHubAccountTokenNamesOptions Nothing)
...
listOnPremisesInstances setOptions =
    ...
    let
        requestInput = ListOnPremisesInstancesInput
...
type alias ListOnPremisesInstancesOptions =
    {
    registrationStatus : Maybe RegistrationStatus,tagFilters : Maybe (List TagFilter),nextToken : Maybe String
    }
...
putLifecycleEventHookExecutionStatus setOptions =
    ...
    let
        requestInput = PutLifecycleEventHookExecutionStatusInput
        ...
        options = setOptions (PutLifecycleEventHookExecutionStatusOptions Nothing Nothing Nothing)
...
type alias PutLifecycleEventHookExecutionStatusOptions =
    {
    deploymentId : Maybe String,lifecycleEventHookExecutionId : Maybe String,status : Maybe LifecycleEventStatus
    }
...
registerApplicationRevision applicationName revision setOptions =
    ...
    let
        requestInput = RegisterApplicationRevisionInput
...
registerOnPremisesInstance instanceName setOptions =
    ...
    let
        requestInput = RegisterOnPremisesInstanceInput
...
type alias RegisterOnPremisesInstanceOptions =
    {
    iamSessionArn : Maybe String,iamUserArn : Maybe String
    }
...
removeTagsFromOnPremisesInstances tags instanceNames =
    ...
    let
        requestInput = RemoveTagsFromOnPremisesInstancesInput
...
skipWaitTimeForInstanceTermination setOptions =
    ...
    let
        requestInput = SkipWaitTimeForInstanceTerminationInput
...
stopDeployment deploymentId setOptions =
    ...
    let
        requestInput = StopDeploymentInput
...
updateApplication setOptions =
    ...
    let
        requestInput = UpdateApplicationInput
...
type alias UpdateApplicationOptions =
    {
    applicationName : Maybe String,newApplicationName : Maybe String
    }
...
updateDeploymentGroup applicationName currentDeploymentGroupName setOptions =
    ...
    let
        requestInput = UpdateDeploymentGroupInput
        ...
        options = setOptions (UpdateDeploymentGroupOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
...
type alias UpdateDeploymentGroupOptions =
    {
    newDeploymentGroupName : Maybe String,deploymentConfigName : Maybe String,ec2TagFilters : Maybe (List EC2TagFilter),onPremisesInstanceTagFilters : Maybe (List TagFilter),autoScalingGroups : Maybe (List String),serviceRoleArn : Maybe String,triggerConfigurations : Maybe (List TriggerConfig),alarmConfiguration : Maybe AlarmConfiguration,autoRollbackConfiguration : Maybe AutoRollbackConfiguration,deploymentStyle : Maybe DeploymentStyle,blueGreenDeploymentConfiguration : Maybe BlueGreenDeploymentConfiguration,loadBalancerInfo : Maybe LoadBalancerInfo,ec2TagSet : Maybe EC2TagSet,ecsServices : Maybe (List ECSService),onPremisesTagSet : Maybe OnPremisesTagSet
    }
...
alarmConfigurationToString : AlarmConfiguration -> String -- List (String, String)
...
appSpecContentToString : AppSpecContent -> String -- List (String, String)
...
applicationInfoToString : ApplicationInfo -> String -- List (String, String)
...
autoRollbackConfigurationToString : AutoRollbackConfiguration -> String -- List (String, String)
...
batchGetApplicationRevisionsOutputToString : BatchGetApplicationRevisionsOutput -> String -- List (String, String)
...
batchGetApplicationsOutputToString : BatchGetApplicationsOutput -> String -- List (String, String)
...
batchGetDeploymentGroupsOutputToString : BatchGetDeploymentGroupsOutput -> String -- List (String, String)
...
batchGetDeploymentInstancesOutputToString : BatchGetDeploymentInstancesOutput -> String -- List (String, String)
...
batchGetDeploymentTargetsOutputToString : BatchGetDeploymentTargetsOutput -> String -- List (String, String)
...
batchGetDeploymentsOutputToString : BatchGetDeploymentsOutput -> String -- List (String, String)
...
batchGetOnPremisesInstancesOutputToString : BatchGetOnPremisesInstancesOutput -> String -- List (String, String)
...
blueGreenDeploymentConfigurationToString : BlueGreenDeploymentConfiguration -> String -- List (String, String)
...
blueInstanceTerminationOptionToString : BlueInstanceTerminationOption -> String -- List (String, String)
...
createApplicationOutputToString : CreateApplicationOutput -> String -- List (String, String)
...
createDeploymentConfigOutputToString : CreateDeploymentConfigOutput -> String -- List (String, String)
...
createDeploymentGroupOutputToString : CreateDeploymentGroupOutput -> String -- List (String, String)
...
createDeploymentOutputToString : CreateDeploymentOutput -> String -- List (String, String)
...
deleteDeploymentGroupOutputToString : DeleteDeploymentGroupOutput -> String -- List (String, String)
...
deleteGitHubAccountTokenOutputToString : DeleteGitHubAccountTokenOutput -> String -- List (String, String)
...
deploymentConfigInfoToString : DeploymentConfigInfo -> String -- List (String, String)
...
deploymentGroupInfoToString : DeploymentGroupInfo -> String -- List (String, String)
...
deploymentInfoToString : DeploymentInfo -> String -- List (String, String)
...
deploymentOverviewToString : DeploymentOverview -> String -- List (String, String)
...
deploymentReadyOptionToString : DeploymentReadyOption -> String -- List (String, String)
...
deploymentStyleToString : DeploymentStyle -> String -- List (String, String)
...
deploymentTargetToString : DeploymentTarget -> String -- List (String, String)
...
diagnosticsToString : Diagnostics -> String -- List (String, String)
...
eC2TagFilterToString : EC2TagFilter -> String -- List (String, String)
...
eC2TagSetToString : EC2TagSet -> String -- List (String, String)
...
eCSServiceToString : ECSService -> String -- List (String, String)
...
eCSTargetToString : ECSTarget -> String -- List (String, String)
...
eCSTaskSetToString : ECSTaskSet -> String -- List (String, String)
...
eLBInfoToString : ELBInfo -> String -- List (String, String)
eLBInfoToString val =
    -- Dict.empty
...
errorInformationToString : ErrorInformation -> String -- List (String, String)
...
genericRevisionInfoToString : GenericRevisionInfo -> String -- List (String, String)
...
getApplicationOutputToString : GetApplicationOutput -> String -- List (String, String)
...
getApplicationRevisionOutputToString : GetApplicationRevisionOutput -> String -- List (String, String)
...
getDeploymentConfigOutputToString : GetDeploymentConfigOutput -> String -- List (String, String)
...
getDeploymentGroupOutputToString : GetDeploymentGroupOutput -> String -- List (String, String)
...
getDeploymentInstanceOutputToString : GetDeploymentInstanceOutput -> String -- List (String, String)
...
getDeploymentOutputToString : GetDeploymentOutput -> String -- List (String, String)
...
getDeploymentTargetOutputToString : GetDeploymentTargetOutput -> String -- List (String, String)
...
getOnPremisesInstanceOutputToString : GetOnPremisesInstanceOutput -> String -- List (String, String)
...
gitHubLocationToString : GitHubLocation -> String -- List (String, String)
...
greenFleetProvisioningOptionToString : GreenFleetProvisioningOption -> String -- List (String, String)
...
instanceInfoToString : InstanceInfo -> String -- List (String, String)
...
instanceSummaryToString : InstanceSummary -> String -- List (String, String)
...
instanceTargetToString : InstanceTarget -> String -- List (String, String)
...
lambdaFunctionInfoToString : LambdaFunctionInfo -> String -- List (String, String)
...
lambdaTargetToString : LambdaTarget -> String -- List (String, String)
...
lastDeploymentInfoToString : LastDeploymentInfo -> String -- List (String, String)
...
lifecycleEventToString : LifecycleEvent -> String -- List (String, String)
...
listApplicationRevisionsOutputToString : ListApplicationRevisionsOutput -> String -- List (String, String)
...
listApplicationsOutputToString : ListApplicationsOutput -> String -- List (String, String)
...
listDeploymentConfigsOutputToString : ListDeploymentConfigsOutput -> String -- List (String, String)
...
listDeploymentGroupsOutputToString : ListDeploymentGroupsOutput -> String -- List (String, String)
...
listDeploymentInstancesOutputToString : ListDeploymentInstancesOutput -> String -- List (String, String)
...
listDeploymentTargetsOutputToString : ListDeploymentTargetsOutput -> String -- List (String, String)
...
listDeploymentsOutputToString : ListDeploymentsOutput -> String -- List (String, String)
...
listGitHubAccountTokenNamesOutputToString : ListGitHubAccountTokenNamesOutput -> String -- List (String, String)
...
listOnPremisesInstancesOutputToString : ListOnPremisesInstancesOutput -> String -- List (String, String)
...
loadBalancerInfoToString : LoadBalancerInfo -> String -- List (String, String)
...
minimumHealthyHostsToString : MinimumHealthyHosts -> String -- List (String, String)
...
onPremisesTagSetToString : OnPremisesTagSet -> String -- List (String, String)
...
putLifecycleEventHookExecutionStatusOutputToString : PutLifecycleEventHookExecutionStatusOutput -> String -- List (String, String)
...
rawStringToString : RawString -> String -- List (String, String)
...
revisionInfoToString : RevisionInfo -> String -- List (String, String)
...
revisionLocationToString : RevisionLocation -> String -- List (String, String)
...
rollbackInfoToString : RollbackInfo -> String -- List (String, String)
...
stopDeploymentOutputToString : StopDeploymentOutput -> String -- List (String, String)
...
targetGroupInfoToString : TargetGroupInfo -> String -- List (String, String)
...
targetGroupPairInfoToString : TargetGroupPairInfo -> String -- List (String, String)
...
targetInstancesToString : TargetInstances -> String -- List (String, String)
...
timeBasedCanaryToString : TimeBasedCanary -> String -- List (String, String)
...
timeBasedLinearToString : TimeBasedLinear -> String -- List (String, String)
...
timeRangeToString : TimeRange -> String -- List (String, String)
...
trafficRouteToString : TrafficRoute -> String -- List (String, String)
...
trafficRoutingConfigToString : TrafficRoutingConfig -> String -- List (String, String)
...
triggerConfigToString : TriggerConfig -> String -- List (String, String)
...
updateDeploymentGroupOutputToString : UpdateDeploymentGroupOutput -> String -- List (String, String)
