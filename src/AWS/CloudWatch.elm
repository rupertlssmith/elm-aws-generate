module AWS.CloudWatch
    exposing
        ...
        , DescribeAnomalyDetectorsOptions
        , disableAlarmActions
        , enableAlarmActions
        , getDashboard
        , getMetricData
...
deleteAlarms alarmNames =
    ...
    let
        requestInput = DeleteAlarmsInput
...
deleteAnomalyDetector namespace metricName stat setOptions =
    ...
    let
        requestInput = DeleteAnomalyDetectorInput
        ...
        options = setOptions (DeleteAnomalyDetectorOptions Nothing)
...
* `dashboardNames` __:__ `(List String)`
...
deleteDashboards dashboardNames =
    ...
    let
        requestInput = DeleteDashboardsInput
...
describeAlarmHistory setOptions =
    ...
    let
        requestInput = DescribeAlarmHistoryInput
...
type alias DescribeAlarmHistoryOptions =
    {
    alarmName : Maybe String,historyItemType : Maybe HistoryItemType,startDate : Maybe Posix,endDate : Maybe Posix,maxRecords : Maybe Int,nextToken : Maybe String
    }
...
describeAlarms setOptions =
    ...
    let
        requestInput = DescribeAlarmsInput
...
type alias DescribeAlarmsOptions =
    {
    alarmNames : Maybe (List String),alarmNamePrefix : Maybe String,stateValue : Maybe StateValue,actionPrefix : Maybe String,maxRecords : Maybe Int,nextToken : Maybe String
    }
...
describeAlarmsForMetric metricName namespace setOptions =
    ...
    let
        requestInput = DescribeAlarmsForMetricInput
...
type alias DescribeAlarmsForMetricOptions =
    {
    statistic : Maybe Statistic,extendedStatistic : Maybe String,dimensions : Maybe (List Dimension),period : Maybe Int,unit : Maybe StandardUnit
    }
...
describeAnomalyDetectors setOptions =
    ...
    let
        requestInput = DescribeAnomalyDetectorsInput
        ...
        options = setOptions (DescribeAnomalyDetectorsOptions Nothing Nothing Nothing Nothing Nothing)
...
type alias DescribeAnomalyDetectorsOptions =
    {
    nextToken : Maybe String,maxResults : Maybe Int,namespace : Maybe String,metricName : Maybe String,dimensions : Maybe (List Dimension)
    }
...
disableAlarmActions alarmNames =
    ...
    let
        requestInput = DisableAlarmActionsInput
...
enableAlarmActions alarmNames =
    ...
    let
        requestInput = EnableAlarmActionsInput
...
getDashboard dashboardName =
    ...
    let
        requestInput = GetDashboardInput
...
* `metricDataQueries` __:__ `(List MetricDataQuery)`
...
getMetricData metricDataQueries startTime endTime setOptions =
    ...
    let
        requestInput = GetMetricDataInput
        ...
        options = setOptions (GetMetricDataOptions Nothing Nothing Nothing)
...
type alias GetMetricDataOptions =
    {
    nextToken : Maybe String,scanBy : Maybe ScanBy,maxDatapoints : Maybe Int
    }
...
getMetricStatistics namespace metricName startTime endTime period setOptions =
    ...
    let
        requestInput = GetMetricStatisticsInput
...
type alias GetMetricStatisticsOptions =
    {
    dimensions : Maybe (List Dimension),statistics : Maybe (List Statistic),extendedStatistics : Maybe (List String),unit : Maybe StandardUnit
    }
...
getMetricWidgetImage metricWidget setOptions =
    ...
    let
        requestInput = GetMetricWidgetImageInput
        ...
        options = setOptions (GetMetricWidgetImageOptions Nothing)
...
listDashboards setOptions =
    ...
    let
        requestInput = ListDashboardsInput
        ...
        options = setOptions (ListDashboardsOptions Nothing Nothing)
...
type alias ListDashboardsOptions =
    {
    dashboardNamePrefix : Maybe String,nextToken : Maybe String
    }
...
type alias ListMetricsOptions =
    {
    namespace : Maybe String,metricName : Maybe String,dimensions : Maybe (List DimensionFilter),nextToken : Maybe String
    }
...
putAnomalyDetector namespace metricName stat setOptions =
    ...
    let
        requestInput = PutAnomalyDetectorInput
        ...
        options = setOptions (PutAnomalyDetectorOptions Nothing Nothing)
...
type alias PutAnomalyDetectorOptions =
    {
    dimensions : Maybe (List Dimension),configuration : Maybe AnomalyDetectorConfiguration
    }
...
putDashboard dashboardName dashboardBody =
    ...
    let
        requestInput = PutDashboardInput
...
putMetricAlarm alarmName evaluationPeriods comparisonOperator setOptions =
    ...
    let
        requestInput = PutMetricAlarmInput
        ...
        options = setOptions (PutMetricAlarmOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
...
type alias PutMetricAlarmOptions =
    {
    alarmDescription : Maybe String,actionsEnabled : Maybe Bool,oKActions : Maybe (List String),alarmActions : Maybe (List String),insufficientDataActions : Maybe (List String),metricName : Maybe String,namespace : Maybe String,statistic : Maybe Statistic,extendedStatistic : Maybe String,dimensions : Maybe (List Dimension),period : Maybe Int,unit : Maybe StandardUnit,datapointsToAlarm : Maybe Int,threshold : Maybe Float,treatMissingData : Maybe String,evaluateLowSampleCountPercentile : Maybe String,metrics : Maybe (List MetricDataQuery),tags : Maybe (List Tag),thresholdMetricId : Maybe String
    }
...
putMetricData namespace metricData =
    ...
    let
        requestInput = PutMetricDataInput
...
setAlarmState alarmName stateValue stateReason setOptions =
    ...
    let
        requestInput = SetAlarmStateInput
...
alarmHistoryItemToString : AlarmHistoryItem -> String -- List (String, String)
...
anomalyDetectorToString : AnomalyDetector -> String -- List (String, String)
...
anomalyDetectorConfigurationToString : AnomalyDetectorConfiguration -> String -- List (String, String)
...
dashboardEntryToString : DashboardEntry -> String -- List (String, String)
...
dashboardValidationMessageToString : DashboardValidationMessage -> String -- List (String, String)
...
datapointToString : Datapoint -> String -- List (String, String)
...
deleteAnomalyDetectorOutputToString : DeleteAnomalyDetectorOutput -> String -- List (String, String)
...
deleteDashboardsOutputToString : DeleteDashboardsOutput -> String -- List (String, String)
...
describeAlarmHistoryOutputToString : DescribeAlarmHistoryOutput -> String -- List (String, String)
...
describeAlarmsForMetricOutputToString : DescribeAlarmsForMetricOutput -> String -- List (String, String)
...
describeAlarmsOutputToString : DescribeAlarmsOutput -> String -- List (String, String)
...
describeAnomalyDetectorsOutputToString : DescribeAnomalyDetectorsOutput -> String -- List (String, String)
...
dimensionToString : Dimension -> String -- List (String, String)
...
dimensionFilterToString : DimensionFilter -> String -- List (String, String)
...
getDashboardOutputToString : GetDashboardOutput -> String -- List (String, String)
...
getMetricDataOutputToString : GetMetricDataOutput -> String -- List (String, String)
...
getMetricStatisticsOutputToString : GetMetricStatisticsOutput -> String -- List (String, String)
...
getMetricWidgetImageOutputToString : GetMetricWidgetImageOutput -> String -- List (String, String)
...
listDashboardsOutputToString : ListDashboardsOutput -> String -- List (String, String)
...
listMetricsOutputToString : ListMetricsOutput -> String -- List (String, String)
...
messageDataToString : MessageData -> String -- List (String, String)
...
metricToString : Metric -> String -- List (String, String)
metricToString val =
    -- Dict.empty
...
metricAlarmToString : MetricAlarm -> String -- List (String, String)
...
metricDataQueryToString : MetricDataQuery -> String -- List (String, String)
...
metricDataResultToString : MetricDataResult -> String -- List (String, String)
...
metricDatumToString : MetricDatum -> String -- List (String, String)
...
metricStatToString : MetricStat -> String -- List (String, String)
...
putAnomalyDetectorOutputToString : PutAnomalyDetectorOutput -> String -- List (String, String)
...
putDashboardOutputToString : PutDashboardOutput -> String -- List (String, String)
...
statisticSetToString : StatisticSet -> String -- List (String, String)
