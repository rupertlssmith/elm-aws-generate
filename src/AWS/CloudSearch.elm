module AWS.CloudSearch exposing
    ( service
...
describeAnalysisSchemes domainName setOptions =
    let
        ...
        options =
            setOptions (DescribeAnalysisSchemesOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeAvailabilityOptions domainName setOptions =
    let
        ...
        options =
            setOptions (DescribeAvailabilityOptionsOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeDomains setOptions =
    let
        ...
        options =
            setOptions (DescribeDomainsOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeExpressions domainName setOptions =
    let
        ...
        options =
            setOptions (DescribeExpressionsOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeIndexFields domainName setOptions =
    let
        ...
        options =
            setOptions (DescribeIndexFieldsOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeServiceAccessPolicies domainName setOptions =
    let
        ...
        options =
            setOptions (DescribeServiceAccessPoliciesOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeSuggesters domainName setOptions =
    let
        ...
        options =
            setOptions (DescribeSuggestersOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
-}
listDomainNames : AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper ListDomainNamesResponse)
listDomainNames =
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
