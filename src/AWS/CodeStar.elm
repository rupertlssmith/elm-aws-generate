module AWS.CodeStar exposing
    ( service
    , associateTeamMember, AssociateTeamMemberOptions, createProject, CreateProjectOptions, createUserProfile, CreateUserProfileOptions, deleteProject, DeleteProjectOptions, deleteUserProfile, describeProject, describeUserProfile, disassociateTeamMember, listProjects, ListProjectsOptions, listResources, ListResourcesOptions, listTagsForProject, ListTagsForProjectOptions, listTeamMembers, ListTeamMembersOptions, listUserProfiles, ListUserProfilesOptions, tagProject, untagProject, updateProject, UpdateProjectOptions, updateTeamMember, UpdateTeamMemberOptions, updateUserProfile, UpdateUserProfileOptions
    , AssociateTeamMemberResult, CreateProjectResult, CreateUserProfileResult, DeleteProjectResult, DeleteUserProfileResult, DescribeProjectResult, DescribeUserProfileResult, DisassociateTeamMemberResult, ListProjectsResult, ListResourcesResult, ListTagsForProjectResult, ListTeamMembersResult, ListUserProfilesResult, TagProjectResult, UntagProjectResult, UpdateProjectResult, UpdateTeamMemberResult, UpdateUserProfileResult
    , Code, CodeCommitCodeDestination, CodeDestination, CodeSource, GitHubCodeDestination, ProjectStatus, ProjectSummary, Resource, S3Location, TeamMember, Toolchain, ToolchainSource, UserProfileSummary
    )
...
associateTeamMember projectId userArn projectRole setOptions =
    let
        ...
        options =
            setOptions (AssociateTeamMemberOptions Nothing Nothing)
    in
...
createProject name id setOptions =
    let
        ...
        options =
            setOptions (CreateProjectOptions Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createUserProfile userArn displayName emailAddress setOptions =
    let
        ...
        options =
            setOptions (CreateUserProfileOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
deleteProject id setOptions =
    let
        ...
        options =
            setOptions (DeleteProjectOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listProjects setOptions =
    let
        ...
        options =
            setOptions (ListProjectsOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listResources projectId setOptions =
    let
        ...
        options =
            setOptions (ListResourcesOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listTagsForProject id setOptions =
    let
        ...
        options =
            setOptions (ListTagsForProjectOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listTeamMembers projectId setOptions =
    let
        ...
        options =
            setOptions (ListTeamMembersOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listUserProfiles setOptions =
    let
        ...
        options =
            setOptions (ListUserProfilesOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
updateProject id setOptions =
    let
        ...
        options =
            setOptions (UpdateProjectOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
updateTeamMember projectId userArn setOptions =
    let
        ...
        options =
            setOptions (UpdateTeamMemberOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
updateUserProfile userArn setOptions =
    let
        ...
        options =
            setOptions (UpdateUserProfileOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
associateTeamMemberResultToString :
...
codeCommitCodeDestinationToString :
...
createUserProfileResultToString :
...
deleteUserProfileResultToString :
...
describeUserProfileResultToString :
...
disassociateTeamMemberResultToString :
...
listTagsForProjectResultToString :
...
listUserProfilesResultToString :
...
updateTeamMemberResultToString :
...
updateUserProfileResultToString :
