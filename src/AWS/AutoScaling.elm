...
attachInstances autoScalingGroupName setOptions =
    ...
    let
        requestInput = AttachInstancesQuery
...
attachLoadBalancerTargetGroups autoScalingGroupName targetGroupARNs =
    ...
    let
        requestInput = AttachLoadBalancerTargetGroupsType
...
attachLoadBalancers autoScalingGroupName loadBalancerNames =
    ...
    let
        requestInput = AttachLoadBalancersType
...
* `autoScalingGroupName` __:__ `String`
* `scheduledActionNames` __:__ `(List String)`
...
batchDeleteScheduledAction autoScalingGroupName scheduledActionNames =
    ...
    let
        requestInput = BatchDeleteScheduledActionType
...
* `autoScalingGroupName` __:__ `String`
* `scheduledUpdateGroupActions` __:__ `(List ScheduledUpdateGroupActionRequest)`
...
batchPutScheduledUpdateGroupAction autoScalingGroupName scheduledUpdateGroupActions =
    ...
    let
        requestInput = BatchPutScheduledUpdateGroupActionType
...
completeLifecycleAction lifecycleHookName autoScalingGroupName lifecycleActionResult setOptions =
    ...
    let
        requestInput = CompleteLifecycleActionType
...
type alias CompleteLifecycleActionOptions =
    {
    lifecycleActionToken : Maybe String,instanceId : Maybe String
    }
...
createAutoScalingGroup autoScalingGroupName minSize maxSize setOptions =
    ...
    let
        requestInput = CreateAutoScalingGroupType
        ...
        options = setOptions (CreateAutoScalingGroupOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
...
type alias CreateAutoScalingGroupOptions =
    {
    launchConfigurationName : Maybe String,launchTemplate : Maybe LaunchTemplateSpecification,mixedInstancesPolicy : Maybe MixedInstancesPolicy,instanceId : Maybe String,desiredCapacity : Maybe Int,defaultCooldown : Maybe Int,availabilityZones : Maybe (List String),loadBalancerNames : Maybe (List String),targetGroupARNs : Maybe (List String),healthCheckType : Maybe String,healthCheckGracePeriod : Maybe Int,placementGroup : Maybe String,vPCZoneIdentifier : Maybe String,terminationPolicies : Maybe (List String),newInstancesProtectedFromScaleIn : Maybe Bool,lifecycleHookSpecificationList : Maybe (List LifecycleHookSpecification),tags : Maybe (List Tag),serviceLinkedRoleARN : Maybe String
    }
...
createLaunchConfiguration launchConfigurationName setOptions =
    ...
    let
        requestInput = CreateLaunchConfigurationType
...
type alias CreateLaunchConfigurationOptions =
    {
    imageId : Maybe String,keyName : Maybe String,securityGroups : Maybe (List String),classicLinkVPCId : Maybe String,classicLinkVPCSecurityGroups : Maybe (List String),userData : Maybe String,instanceId : Maybe String,instanceType : Maybe String,kernelId : Maybe String,ramdiskId : Maybe String,blockDeviceMappings : Maybe (List BlockDeviceMapping),instanceMonitoring : Maybe InstanceMonitoring,spotPrice : Maybe String,iamInstanceProfile : Maybe String,ebsOptimized : Maybe Bool,associatePublicIpAddress : Maybe Bool,placementTenancy : Maybe String
    }
...
createOrUpdateTags tags =
    ...
    let
        requestInput = CreateOrUpdateTagsType
...
deleteAutoScalingGroup autoScalingGroupName setOptions =
    ...
    let
        requestInput = DeleteAutoScalingGroupType
...
deleteLaunchConfiguration launchConfigurationName =
    ...
    let
        requestInput = LaunchConfigurationNameType
...
deleteLifecycleHook lifecycleHookName autoScalingGroupName =
    ...
    let
        requestInput = DeleteLifecycleHookType
...
deleteNotificationConfiguration autoScalingGroupName topicARN =
    ...
    let
        requestInput = DeleteNotificationConfigurationType
...
deleteScheduledAction autoScalingGroupName scheduledActionName =
    ...
    let
        requestInput = DeleteScheduledActionType
...
describeAccountLimits :
    ...
    AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper DescribeAccountLimitsAnswer)
...
describeAdjustmentTypes :
    ...
    AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper DescribeAdjustmentTypesAnswer)
...
describeAutoScalingGroups setOptions =
    ...
    let
        requestInput = AutoScalingGroupNamesType
...
type alias DescribeAutoScalingGroupsOptions =
    {
    autoScalingGroupNames : Maybe (List String),nextToken : Maybe String,maxRecords : Maybe Int
    }
...
describeAutoScalingInstances setOptions =
    ...
    let
        requestInput = DescribeAutoScalingInstancesType
...
type alias DescribeAutoScalingInstancesOptions =
    {
    instanceIds : Maybe (List String),maxRecords : Maybe Int,nextToken : Maybe String
    }
...
describeAutoScalingNotificationTypes :
    ...
    AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper DescribeAutoScalingNotificationTypesAnswer)
...
describeLaunchConfigurations setOptions =
    ...
    let
        requestInput = LaunchConfigurationNamesType
...
type alias DescribeLaunchConfigurationsOptions =
    {
    launchConfigurationNames : Maybe (List String),nextToken : Maybe String,maxRecords : Maybe Int
    }
...
describeLifecycleHookTypes :
    ...
    AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper DescribeLifecycleHookTypesAnswer)
...
describeLifecycleHooks autoScalingGroupName setOptions =
    ...
    let
        requestInput = DescribeLifecycleHooksType
...
describeLoadBalancerTargetGroups autoScalingGroupName setOptions =
    ...
    let
        requestInput = DescribeLoadBalancerTargetGroupsRequest
...
type alias DescribeLoadBalancerTargetGroupsOptions =
    {
    nextToken : Maybe String,maxRecords : Maybe Int
    }
...
describeLoadBalancers autoScalingGroupName setOptions =
    ...
    let
        requestInput = DescribeLoadBalancersRequest
...
describeMetricCollectionTypes :
    ...
    AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper DescribeMetricCollectionTypesAnswer)
...
describeNotificationConfigurations setOptions =
    ...
    let
        requestInput = DescribeNotificationConfigurationsType
...
describePolicies setOptions =
    ...
    let
        requestInput = DescribePoliciesType
...
type alias DescribePoliciesOptions =
    {
    autoScalingGroupName : Maybe String,policyNames : Maybe (List String),policyTypes : Maybe (List String),nextToken : Maybe String,maxRecords : Maybe Int
    }
...
describeScalingActivities setOptions =
    ...
    let
        requestInput = DescribeScalingActivitiesType
...
type alias DescribeScalingActivitiesOptions =
    {
    activityIds : Maybe (List String),autoScalingGroupName : Maybe String,maxRecords : Maybe Int,nextToken : Maybe String
    }
...
describeScalingProcessTypes :
    ...
    AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper ProcessesType)
...
describeScheduledActions setOptions =
    ...
    let
        requestInput = DescribeScheduledActionsType
...
type alias DescribeScheduledActionsOptions =
    {
    autoScalingGroupName : Maybe String,scheduledActionNames : Maybe (List String),startTime : Maybe Posix,endTime : Maybe Posix,nextToken : Maybe String,maxRecords : Maybe Int
    }
...
type alias DescribeTagsOptions =
    {
    filters : Maybe (List Filter),nextToken : Maybe String,maxRecords : Maybe Int
    }
...
describeTerminationPolicyTypes :
    ...
    AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper DescribeTerminationPolicyTypesAnswer)
...
detachInstances autoScalingGroupName shouldDecrementDesiredCapacity setOptions =
    ...
    let
        requestInput = DetachInstancesQuery
...
detachLoadBalancerTargetGroups autoScalingGroupName targetGroupARNs =
    ...
    let
        requestInput = DetachLoadBalancerTargetGroupsType
...
detachLoadBalancers autoScalingGroupName loadBalancerNames =
    ...
    let
        requestInput = DetachLoadBalancersType
...
disableMetricsCollection autoScalingGroupName setOptions =
    ...
    let
        requestInput = DisableMetricsCollectionQuery
...
enableMetricsCollection autoScalingGroupName granularity setOptions =
    ...
    let
        requestInput = EnableMetricsCollectionQuery
...
enterStandby autoScalingGroupName shouldDecrementDesiredCapacity setOptions =
    ...
    let
        requestInput = EnterStandbyQuery
...
executePolicy policyName setOptions =
    ...
    let
        requestInput = ExecutePolicyType
...
type alias ExecutePolicyOptions =
    {
    autoScalingGroupName : Maybe String,honorCooldown : Maybe Bool,metricValue : Maybe Float,breachThreshold : Maybe Float
    }
...
putLifecycleHook lifecycleHookName autoScalingGroupName setOptions =
    ...
    let
        requestInput = PutLifecycleHookType
...
type alias PutLifecycleHookOptions =
    {
    lifecycleTransition : Maybe String,roleARN : Maybe String,notificationTargetARN : Maybe String,notificationMetadata : Maybe String,heartbeatTimeout : Maybe Int,defaultResult : Maybe String
    }
...
putNotificationConfiguration autoScalingGroupName topicARN notificationTypes =
    ...
    let
        requestInput = PutNotificationConfigurationType
...
putScalingPolicy autoScalingGroupName policyName setOptions =
    ...
    let
        requestInput = PutScalingPolicyType
        ...
        options = setOptions (PutScalingPolicyOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
...
type alias PutScalingPolicyOptions =
    {
    policyType : Maybe String,adjustmentType : Maybe String,minAdjustmentStep : Maybe Int,minAdjustmentMagnitude : Maybe Int,scalingAdjustment : Maybe Int,cooldown : Maybe Int,metricAggregationType : Maybe String,stepAdjustments : Maybe (List StepAdjustment),estimatedInstanceWarmup : Maybe Int,targetTrackingConfiguration : Maybe TargetTrackingConfiguration
    }
...
putScheduledUpdateGroupAction autoScalingGroupName scheduledActionName setOptions =
    ...
    let
        requestInput = PutScheduledUpdateGroupActionType
...
type alias PutScheduledUpdateGroupActionOptions =
    {
    time : Maybe Posix,startTime : Maybe Posix,endTime : Maybe Posix,recurrence : Maybe String,minSize : Maybe Int,maxSize : Maybe Int,desiredCapacity : Maybe Int
    }
...
recordLifecycleActionHeartbeat lifecycleHookName autoScalingGroupName setOptions =
    ...
    let
        requestInput = RecordLifecycleActionHeartbeatType
...
resumeProcesses autoScalingGroupName setOptions =
    ...
    let
        requestInput = ScalingProcessQuery
...
setDesiredCapacity autoScalingGroupName desiredCapacity setOptions =
    ...
    let
        requestInput = SetDesiredCapacityType
...
setInstanceHealth instanceId healthStatus setOptions =
    ...
    let
        requestInput = SetInstanceHealthQuery
...
setInstanceProtection instanceIds autoScalingGroupName protectedFromScaleIn =
    ...
    let
        requestInput = SetInstanceProtectionQuery
...
terminateInstanceInAutoScalingGroup instanceId shouldDecrementDesiredCapacity =
    ...
    let
        requestInput = TerminateInstanceInAutoScalingGroupType
...
updateAutoScalingGroup autoScalingGroupName setOptions =
    ...
    let
        requestInput = UpdateAutoScalingGroupType
        ...
        options = setOptions (UpdateAutoScalingGroupOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
...
type alias UpdateAutoScalingGroupOptions =
    {
    launchConfigurationName : Maybe String,launchTemplate : Maybe LaunchTemplateSpecification,mixedInstancesPolicy : Maybe MixedInstancesPolicy,minSize : Maybe Int,maxSize : Maybe Int,desiredCapacity : Maybe Int,defaultCooldown : Maybe Int,availabilityZones : Maybe (List String),healthCheckType : Maybe String,healthCheckGracePeriod : Maybe Int,placementGroup : Maybe String,vPCZoneIdentifier : Maybe String,terminationPolicies : Maybe (List String),newInstancesProtectedFromScaleIn : Maybe Bool,serviceLinkedRoleARN : Maybe String
    }
...
activitiesTypeToString : ActivitiesType -> String -- List (String, String)
activitiesTypeToString val =
    -- Dict.empty
...
activityToString : Activity -> String -- List (String, String)
activityToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "autoScalingGroupName" "" -- val.autoScalingGroupName
...
adjustmentTypeToString : AdjustmentType -> String -- List (String, String)
...
attachLoadBalancerTargetGroupsResultTypeToString : AttachLoadBalancerTargetGroupsResultType -> String -- List (String, String)
attachLoadBalancerTargetGroupsResultTypeToString val =
    -- Dict.empty
...
attachLoadBalancersResultTypeToString : AttachLoadBalancersResultType -> String -- List (String, String)
attachLoadBalancersResultTypeToString val =
    -- Dict.empty
...
autoScalingGroupToString val =
    ...
    --     |> Dict.insert
    --         "autoScalingGroupARN" "" -- val.autoScalingGroupARN
        
    --     |> Dict.insert
    --         "launchConfigurationName" "" -- val.launchConfigurationName
        
    --     |> Dict.insert
    --         "launchTemplate" "" -- val.launchTemplate
        
    --     |> Dict.insert
    --         "mixedInstancesPolicy" "" -- val.mixedInstancesPolicy
    ...
    --     |> Dict.insert
    --         "defaultCooldown" "" -- val.defaultCooldown
        
    --     |> Dict.insert
    --         "availabilityZones" "" -- val.availabilityZones
        
    --     |> Dict.insert
    --         "loadBalancerNames" "" -- val.loadBalancerNames
        
    --     |> Dict.insert
    --         "targetGroupARNs" "" -- val.targetGroupARNs
        
    --     |> Dict.insert
    --         "healthCheckType" "" -- val.healthCheckType
        
    --     |> Dict.insert
    --         "healthCheckGracePeriod" "" -- val.healthCheckGracePeriod
    ...
    --     |> Dict.insert
    --         "suspendedProcesses" "" -- val.suspendedProcesses
        
    --     |> Dict.insert
    --         "placementGroup" "" -- val.placementGroup
        
    --     |> Dict.insert
    --         "vPCZoneIdentifier" "" -- val.vPCZoneIdentifier
        
    --     |> Dict.insert
    --         "enabledMetrics" "" -- val.enabledMetrics
    ...
    --     |> Dict.insert
    --         "terminationPolicies" "" -- val.terminationPolicies
        
    --     |> Dict.insert
    --         "newInstancesProtectedFromScaleIn" "" -- val.newInstancesProtectedFromScaleIn
        
    --     |> Dict.insert
    --         "serviceLinkedRoleARN" "" -- val.serviceLinkedRoleARN
...
autoScalingGroupsTypeToString : AutoScalingGroupsType -> String -- List (String, String)
autoScalingGroupsTypeToString val =
    -- Dict.empty
...
autoScalingInstanceDetailsToString : AutoScalingInstanceDetails -> String -- List (String, String)
autoScalingInstanceDetailsToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "protectedFromScaleIn" "" -- val.protectedFromScaleIn
...
autoScalingInstancesTypeToString : AutoScalingInstancesType -> String -- List (String, String)
autoScalingInstancesTypeToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "autoScalingInstances" "" -- val.autoScalingInstances
...
batchDeleteScheduledActionAnswerToString : BatchDeleteScheduledActionAnswer -> String -- List (String, String)
batchDeleteScheduledActionAnswerToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "failedScheduledActions" "" -- val.failedScheduledActions
...
batchPutScheduledUpdateGroupActionAnswerToString : BatchPutScheduledUpdateGroupActionAnswer -> String -- List (String, String)
batchPutScheduledUpdateGroupActionAnswerToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "failedScheduledUpdateGroupActions" "" -- val.failedScheduledUpdateGroupActions
...
completeLifecycleActionAnswerToString : CompleteLifecycleActionAnswer -> String -- List (String, String)
completeLifecycleActionAnswerToString val =
    -- Dict.empty
...
deleteLifecycleHookAnswerToString : DeleteLifecycleHookAnswer -> String -- List (String, String)
deleteLifecycleHookAnswerToString val =
    -- Dict.empty
...
describeAccountLimitsAnswerToString : DescribeAccountLimitsAnswer -> String -- List (String, String)
describeAccountLimitsAnswerToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "maxNumberOfAutoScalingGroups" "" -- val.maxNumberOfAutoScalingGroups
        
    --     |> Dict.insert
    --         "maxNumberOfLaunchConfigurations" "" -- val.maxNumberOfLaunchConfigurations
        
    --     |> Dict.insert
    --         "numberOfAutoScalingGroups" "" -- val.numberOfAutoScalingGroups
        
    --     |> Dict.insert
    --         "numberOfLaunchConfigurations" "" -- val.numberOfLaunchConfigurations
...
describeAdjustmentTypesAnswerToString : DescribeAdjustmentTypesAnswer -> String -- List (String, String)
describeAdjustmentTypesAnswerToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "adjustmentTypes" "" -- val.adjustmentTypes
...
describeAutoScalingNotificationTypesAnswerToString : DescribeAutoScalingNotificationTypesAnswer -> String -- List (String, String)
describeAutoScalingNotificationTypesAnswerToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "autoScalingNotificationTypes" "" -- val.autoScalingNotificationTypes
...
describeLifecycleHookTypesAnswerToString : DescribeLifecycleHookTypesAnswer -> String -- List (String, String)
describeLifecycleHookTypesAnswerToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "lifecycleHookTypes" "" -- val.lifecycleHookTypes
...
describeLifecycleHooksAnswerToString : DescribeLifecycleHooksAnswer -> String -- List (String, String)
describeLifecycleHooksAnswerToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "lifecycleHooks" "" -- val.lifecycleHooks
...
describeLoadBalancerTargetGroupsResponseToString : DescribeLoadBalancerTargetGroupsResponse -> String -- List (String, String)
describeLoadBalancerTargetGroupsResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "loadBalancerTargetGroups" "" -- val.loadBalancerTargetGroups
...
describeLoadBalancersResponseToString : DescribeLoadBalancersResponse -> String -- List (String, String)
describeLoadBalancersResponseToString val =
    -- Dict.empty
...
describeMetricCollectionTypesAnswerToString : DescribeMetricCollectionTypesAnswer -> String -- List (String, String)
describeMetricCollectionTypesAnswerToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "granularities" "" -- val.granularities
...
describeNotificationConfigurationsAnswerToString : DescribeNotificationConfigurationsAnswer -> String -- List (String, String)
describeNotificationConfigurationsAnswerToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "notificationConfigurations" "" -- val.notificationConfigurations
...
describeTerminationPolicyTypesAnswerToString : DescribeTerminationPolicyTypesAnswer -> String -- List (String, String)
describeTerminationPolicyTypesAnswerToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "terminationPolicyTypes" "" -- val.terminationPolicyTypes
...
detachInstancesAnswerToString : DetachInstancesAnswer -> String -- List (String, String)
detachInstancesAnswerToString val =
    -- Dict.empty
...
detachLoadBalancerTargetGroupsResultTypeToString : DetachLoadBalancerTargetGroupsResultType -> String -- List (String, String)
detachLoadBalancerTargetGroupsResultTypeToString val =
    -- Dict.empty
...
detachLoadBalancersResultTypeToString : DetachLoadBalancersResultType -> String -- List (String, String)
detachLoadBalancersResultTypeToString val =
    -- Dict.empty
...
ebsToString : Ebs -> String -- List (String, String)
ebsToString val =
    -- Dict.empty
...
enabledMetricToString : EnabledMetric -> String -- List (String, String)
enabledMetricToString val =
    -- Dict.empty
...
enterStandbyAnswerToString : EnterStandbyAnswer -> String -- List (String, String)
enterStandbyAnswerToString val =
    -- Dict.empty
...
exitStandbyAnswerToString : ExitStandbyAnswer -> String -- List (String, String)
exitStandbyAnswerToString val =
    -- Dict.empty
...
failedScheduledUpdateGroupActionRequestToString : FailedScheduledUpdateGroupActionRequest -> String -- List (String, String)
failedScheduledUpdateGroupActionRequestToString val =
    -- Dict.empty
...
instanceMonitoringToString : InstanceMonitoring -> String -- List (String, String)
instanceMonitoringToString val =
    -- Dict.empty
...
instancesDistributionToString : InstancesDistribution -> String -- List (String, String)
instancesDistributionToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "onDemandAllocationStrategy" "" -- val.onDemandAllocationStrategy
        
    --     |> Dict.insert
    --         "onDemandBaseCapacity" "" -- val.onDemandBaseCapacity
        
    --     |> Dict.insert
    --         "onDemandPercentageAboveBaseCapacity" "" -- val.onDemandPercentageAboveBaseCapacity
        
    --     |> Dict.insert
    --         "spotAllocationStrategy" "" -- val.spotAllocationStrategy
        
    --     |> Dict.insert
    --         "spotInstancePools" "" -- val.spotInstancePools
        
    --     |> Dict.insert
    --         "spotMaxPrice" "" -- val.spotMaxPrice
...
launchConfigurationToString val =
    ...
    --     |> Dict.insert
    --         "launchConfigurationARN" "" -- val.launchConfigurationARN
    ...
    --     |> Dict.insert
    --         "classicLinkVPCId" "" -- val.classicLinkVPCId
        
    --     |> Dict.insert
    --         "classicLinkVPCSecurityGroups" "" -- val.classicLinkVPCSecurityGroups
    ...
    --     |> Dict.insert
    --         "kernelId" "" -- val.kernelId
        
    --     |> Dict.insert
    --         "ramdiskId" "" -- val.ramdiskId
        
    --     |> Dict.insert
    --         "blockDeviceMappings" "" -- val.blockDeviceMappings
        
    --     |> Dict.insert
    --         "instanceMonitoring" "" -- val.instanceMonitoring
        
    --     |> Dict.insert
    --         "spotPrice" "" -- val.spotPrice
        
    --     |> Dict.insert
    --         "iamInstanceProfile" "" -- val.iamInstanceProfile
    ...
    --     |> Dict.insert
    --         "placementTenancy" "" -- val.placementTenancy
...
launchConfigurationsTypeToString : LaunchConfigurationsType -> String -- List (String, String)
launchConfigurationsTypeToString val =
    -- Dict.empty
...
launchTemplateToString val =
    ...
    --     |> Dict.insert
    --         "launchTemplateSpecification" "" -- val.launchTemplateSpecification
...
launchTemplateOverridesToString : LaunchTemplateOverrides -> String -- List (String, String)
launchTemplateOverridesToString val =
    -- Dict.empty
...
launchTemplateSpecificationToString : LaunchTemplateSpecification -> String -- List (String, String)
launchTemplateSpecificationToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "launchTemplateId" "" -- val.launchTemplateId
        
    --     |> Dict.insert
    --         "launchTemplateName" "" -- val.launchTemplateName
...
lifecycleHookToString : LifecycleHook -> String -- List (String, String)
lifecycleHookToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "lifecycleHookName" "" -- val.lifecycleHookName
        
    --     |> Dict.insert
    --         "autoScalingGroupName" "" -- val.autoScalingGroupName
        
    --     |> Dict.insert
    --         "lifecycleTransition" "" -- val.lifecycleTransition
        
    --     |> Dict.insert
    --         "notificationTargetARN" "" -- val.notificationTargetARN
        
    --     |> Dict.insert
    --         "roleARN" "" -- val.roleARN
        
    --     |> Dict.insert
    --         "notificationMetadata" "" -- val.notificationMetadata
    ...
    --     |> Dict.insert
    --         "defaultResult" "" -- val.defaultResult
...
lifecycleHookSpecificationToString : LifecycleHookSpecification -> String -- List (String, String)
lifecycleHookSpecificationToString val =
    -- Dict.empty
...
loadBalancerTargetGroupStateToString : LoadBalancerTargetGroupState -> String -- List (String, String)
loadBalancerTargetGroupStateToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "loadBalancerTargetGroupARN" "" -- val.loadBalancerTargetGroupARN
...
metricCollectionTypeToString : MetricCollectionType -> String -- List (String, String)
metricCollectionTypeToString val =
    -- Dict.empty
...
metricGranularityTypeToString : MetricGranularityType -> String -- List (String, String)
metricGranularityTypeToString val =
    -- Dict.empty
...
mixedInstancesPolicyToString : MixedInstancesPolicy -> String -- List (String, String)
mixedInstancesPolicyToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "instancesDistribution" "" -- val.instancesDistribution
...
policiesTypeToString : PoliciesType -> String -- List (String, String)
policiesTypeToString val =
    -- Dict.empty
...
policyARNTypeToString : PolicyARNType -> String -- List (String, String)
policyARNTypeToString val =
    -- Dict.empty
...
processTypeToString : ProcessType -> String -- List (String, String)
processTypeToString val =
    -- Dict.empty
...
processesTypeToString : ProcessesType -> String -- List (String, String)
processesTypeToString val =
    -- Dict.empty
...
putLifecycleHookAnswerToString : PutLifecycleHookAnswer -> String -- List (String, String)
putLifecycleHookAnswerToString val =
    -- Dict.empty
...
recordLifecycleActionHeartbeatAnswerToString : RecordLifecycleActionHeartbeatAnswer -> String -- List (String, String)
recordLifecycleActionHeartbeatAnswerToString val =
    -- Dict.empty
...
scalingPolicyToString val =
    ...
    --     |> Dict.insert
    --         "minAdjustmentStep" "" -- val.minAdjustmentStep
    ...
    --     |> Dict.insert
    --         "estimatedInstanceWarmup" "" -- val.estimatedInstanceWarmup
        
    --     |> Dict.insert
    --         "alarms" "" -- val.alarms
        
    --     |> Dict.insert
    --         "targetTrackingConfiguration" "" -- val.targetTrackingConfiguration
...
scheduledActionsTypeToString : ScheduledActionsType -> String -- List (String, String)
scheduledActionsTypeToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "scheduledUpdateGroupActions" "" -- val.scheduledUpdateGroupActions
...
scheduledUpdateGroupActionToString : ScheduledUpdateGroupAction -> String -- List (String, String)
scheduledUpdateGroupActionToString val =
    -- Dict.empty
...
scheduledUpdateGroupActionRequestToString : ScheduledUpdateGroupActionRequest -> String -- List (String, String)
scheduledUpdateGroupActionRequestToString val =
    -- Dict.empty
...
setInstanceProtectionAnswerToString : SetInstanceProtectionAnswer -> String -- List (String, String)
setInstanceProtectionAnswerToString val =
    -- Dict.empty
...
suspendedProcessToString : SuspendedProcess -> String -- List (String, String)
suspendedProcessToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "suspensionReason" "" -- val.suspensionReason
...
tagToString val =
    ...
    --     |> Dict.insert
    --         "propagateAtLaunch" "" -- val.propagateAtLaunch
...
tagsTypeToString : TagsType -> String -- List (String, String)
tagsTypeToString val =
    -- Dict.empty
...
targetTrackingConfigurationToString : TargetTrackingConfiguration -> String -- List (String, String)
targetTrackingConfigurationToString val =
    -- Dict.empty
