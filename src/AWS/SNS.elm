...
confirmSubscription topicArn token setOptions =
    let
        ...
        options =
            setOptions (ConfirmSubscriptionOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createPlatformEndpoint platformApplicationArn token setOptions =
    let
        ...
        options =
            setOptions (CreatePlatformEndpointOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createTopic name setOptions =
    let
        ...
        options =
            setOptions (CreateTopicOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
getSMSAttributes setOptions =
    let
        ...
        options =
            setOptions (GetSMSAttributesOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listEndpointsByPlatformApplication platformApplicationArn setOptions =
    let
        ...
        options =
            setOptions (ListEndpointsByPlatformApplicationOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listPhoneNumbersOptedOut setOptions =
    let
        ...
        options =
            setOptions (ListPhoneNumbersOptedOutOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listPlatformApplications setOptions =
    let
        ...
        options =
            setOptions (ListPlatformApplicationsOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listSubscriptions setOptions =
    let
        ...
        options =
            setOptions (ListSubscriptionsOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listSubscriptionsByTopic topicArn setOptions =
    let
        ...
        options =
            setOptions (ListSubscriptionsByTopicOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listTopics setOptions =
    let
        ...
        options =
            setOptions (ListTopicsOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
publish message setOptions =
    let
        ...
        options =
            setOptions (PublishOptions Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
setSubscriptionAttributes subscriptionArn attributeName setOptions =
    let
        ...
        options =
            setOptions (SetSubscriptionAttributesOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
setTopicAttributes topicArn attributeName setOptions =
    let
        ...
        options =
            setOptions (SetTopicAttributesOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
subscribe topicArn protocol setOptions =
    let
        ...
        options =
            setOptions (SubscribeOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
