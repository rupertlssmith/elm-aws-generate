module AWS.DatabaseMigrationService
    exposing
        ...
        , RebootReplicationInstanceOptions
        , refreshSchemas
        , reloadTables
        , ReloadTablesOptions
...
createEndpoint endpointIdentifier endpointType engineName setOptions =
    ...
    let
        requestInput = CreateEndpointMessage
        ...
        options = setOptions (CreateEndpointOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
...
type alias CreateEndpointOptions =
    {
    username : Maybe String,password : Maybe String,serverName : Maybe String,port_ : Maybe Int,databaseName : Maybe String,extraConnectionAttributes : Maybe String,kmsKeyId : Maybe String,tags : Maybe (List Tag),certificateArn : Maybe String,sslMode : Maybe DmsSslModeValue,serviceAccessRoleArn : Maybe String,externalTableDefinition : Maybe String,dynamoDbSettings : Maybe DynamoDbSettings,s3Settings : Maybe S3Settings,dmsTransferSettings : Maybe DmsTransferSettings,mongoDbSettings : Maybe MongoDbSettings,kinesisSettings : Maybe KinesisSettings,elasticsearchSettings : Maybe ElasticsearchSettings,redshiftSettings : Maybe RedshiftSettings
    }
...
createReplicationInstance replicationInstanceIdentifier replicationInstanceClass setOptions =
    ...
    let
        requestInput = CreateReplicationInstanceMessage
        ...
        options = setOptions (CreateReplicationInstanceOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
...
type alias CreateReplicationInstanceOptions =
    {
    allocatedStorage : Maybe Int,vpcSecurityGroupIds : Maybe (List String),availabilityZone : Maybe String,replicationSubnetGroupIdentifier : Maybe String,preferredMaintenanceWindow : Maybe String,multiAZ : Maybe Bool,engineVersion : Maybe String,autoMinorVersionUpgrade : Maybe Bool,tags : Maybe (List Tag),kmsKeyId : Maybe String,publiclyAccessible : Maybe Bool,dnsNameServers : Maybe String
    }
...
createReplicationSubnetGroup replicationSubnetGroupIdentifier replicationSubnetGroupDescription subnetIds setOptions =
    ...
    let
        requestInput = CreateReplicationSubnetGroupMessage
...
createReplicationTask replicationTaskIdentifier sourceEndpointArn targetEndpointArn replicationInstanceArn migrationType tableMappings setOptions =
    ...
    let
        requestInput = CreateReplicationTaskMessage
        ...
        options = setOptions (CreateReplicationTaskOptions Nothing Nothing Nothing Nothing Nothing)
...
type alias CreateReplicationTaskOptions =
    {
    replicationTaskSettings : Maybe String,cdcStartTime : Maybe Posix,cdcStartPosition : Maybe String,cdcStopPosition : Maybe String,tags : Maybe (List Tag)
    }
...
deleteCertificate certificateArn =
    ...
    let
        requestInput = DeleteCertificateMessage
...
deleteEndpoint endpointArn =
    ...
    let
        requestInput = DeleteEndpointMessage
...
deleteReplicationInstance replicationInstanceArn =
    ...
    let
        requestInput = DeleteReplicationInstanceMessage
...
deleteReplicationSubnetGroup replicationSubnetGroupIdentifier =
    ...
    let
        requestInput = DeleteReplicationSubnetGroupMessage
...
deleteReplicationTask replicationTaskArn =
    ...
    let
        requestInput = DeleteReplicationTaskMessage
...
describeAccountAttributes :
    ...
    AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper DescribeAccountAttributesResponse)
...
describeConnections setOptions =
    ...
    let
        requestInput = DescribeConnectionsMessage
...
describeEndpointTypes setOptions =
    ...
    let
        requestInput = DescribeEndpointTypesMessage
...
describeEndpoints setOptions =
    ...
    let
        requestInput = DescribeEndpointsMessage
...
describeOrderableReplicationInstances setOptions =
    ...
    let
        requestInput = DescribeOrderableReplicationInstancesMessage
...
type alias DescribePendingMaintenanceActionsOptions =
    {
    replicationInstanceArn : Maybe String,filters : Maybe (List Filter),marker : Maybe String,maxRecords : Maybe Int
    }
...
describeRefreshSchemasStatus endpointArn =
    ...
    let
        requestInput = DescribeRefreshSchemasStatusMessage
...
describeReplicationInstanceTaskLogs replicationInstanceArn setOptions =
    ...
    let
        requestInput = DescribeReplicationInstanceTaskLogsMessage
        ...
        options = setOptions (DescribeReplicationInstanceTaskLogsOptions Nothing Nothing)
...
describeReplicationInstances setOptions =
    ...
    let
        requestInput = DescribeReplicationInstancesMessage
...
describeReplicationSubnetGroups setOptions =
    ...
    let
        requestInput = DescribeReplicationSubnetGroupsMessage
...
describeReplicationTaskAssessmentResults setOptions =
    ...
    let
        requestInput = DescribeReplicationTaskAssessmentResultsMessage
        ...
        options = setOptions (DescribeReplicationTaskAssessmentResultsOptions Nothing Nothing Nothing)
...
type alias DescribeReplicationTaskAssessmentResultsOptions =
    {
    replicationTaskArn : Maybe String,maxRecords : Maybe Int,marker : Maybe String
    }
...
describeReplicationTasks setOptions =
    ...
    let
        requestInput = DescribeReplicationTasksMessage
        ...
        options = setOptions (DescribeReplicationTasksOptions Nothing Nothing Nothing Nothing)
...
type alias DescribeReplicationTasksOptions =
    {
    filters : Maybe (List Filter),maxRecords : Maybe Int,marker : Maybe String,withoutSettings : Maybe Bool
    }
...
describeSchemas endpointArn setOptions =
    ...
    let
        requestInput = DescribeSchemasMessage
...
describeTableStatistics replicationTaskArn setOptions =
    ...
    let
        requestInput = DescribeTableStatisticsMessage
        ...
        options = setOptions (DescribeTableStatisticsOptions Nothing Nothing Nothing)
...
type alias DescribeTableStatisticsOptions =
    {
    maxRecords : Maybe Int,marker : Maybe String,filters : Maybe (List Filter)
    }
...
importCertificate certificateIdentifier setOptions =
    ...
    let
        requestInput = ImportCertificateMessage
        ...
        options = setOptions (ImportCertificateOptions Nothing Nothing Nothing)
...
type alias ImportCertificateOptions =
    {
    certificatePem : Maybe String,certificateWallet : Maybe String,tags : Maybe (List Tag)
    }
...
modifyEndpoint endpointArn setOptions =
    ...
    let
        requestInput = ModifyEndpointMessage
        ...
        options = setOptions (ModifyEndpointOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
...
type alias ModifyEndpointOptions =
    {
    endpointIdentifier : Maybe String,endpointType : Maybe ReplicationEndpointTypeValue,engineName : Maybe String,username : Maybe String,password : Maybe String,serverName : Maybe String,port_ : Maybe Int,databaseName : Maybe String,extraConnectionAttributes : Maybe String,certificateArn : Maybe String,sslMode : Maybe DmsSslModeValue,serviceAccessRoleArn : Maybe String,externalTableDefinition : Maybe String,dynamoDbSettings : Maybe DynamoDbSettings,s3Settings : Maybe S3Settings,dmsTransferSettings : Maybe DmsTransferSettings,mongoDbSettings : Maybe MongoDbSettings,kinesisSettings : Maybe KinesisSettings,elasticsearchSettings : Maybe ElasticsearchSettings,redshiftSettings : Maybe RedshiftSettings
    }
...
modifyReplicationInstance replicationInstanceArn setOptions =
    ...
    let
        requestInput = ModifyReplicationInstanceMessage
...
type alias ModifyReplicationInstanceOptions =
    {
    allocatedStorage : Maybe Int,applyImmediately : Maybe Bool,replicationInstanceClass : Maybe String,vpcSecurityGroupIds : Maybe (List String),preferredMaintenanceWindow : Maybe String,multiAZ : Maybe Bool,engineVersion : Maybe String,allowMajorVersionUpgrade : Maybe Bool,autoMinorVersionUpgrade : Maybe Bool,replicationInstanceIdentifier : Maybe String
    }
...
modifyReplicationSubnetGroup replicationSubnetGroupIdentifier subnetIds setOptions =
    ...
    let
        requestInput = ModifyReplicationSubnetGroupMessage
...
modifyReplicationTask replicationTaskArn setOptions =
    ...
    let
        requestInput = ModifyReplicationTaskMessage
        ...
        options = setOptions (ModifyReplicationTaskOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
...
type alias ModifyReplicationTaskOptions =
    {
    replicationTaskIdentifier : Maybe String,migrationType : Maybe MigrationTypeValue,tableMappings : Maybe String,replicationTaskSettings : Maybe String,cdcStartTime : Maybe Posix,cdcStartPosition : Maybe String,cdcStopPosition : Maybe String
    }
...
rebootReplicationInstance replicationInstanceArn setOptions =
    ...
    let
        requestInput = RebootReplicationInstanceMessage
        ...
        options = setOptions (RebootReplicationInstanceOptions Nothing)
...
refreshSchemas endpointArn replicationInstanceArn =
    ...
    let
        requestInput = RefreshSchemasMessage
...
* `replicationTaskArn` __:__ `String`
* `tablesToReload` __:__ `(List TableToReload)`
...
reloadTables replicationTaskArn tablesToReload setOptions =
    ...
    let
        requestInput = ReloadTablesMessage
        ...
        options = setOptions (ReloadTablesOptions Nothing)
...
startReplicationTask replicationTaskArn startReplicationTaskType setOptions =
    ...
    let
        requestInput = StartReplicationTaskMessage
        ...
        options = setOptions (StartReplicationTaskOptions Nothing Nothing Nothing)
...
type alias StartReplicationTaskOptions =
    {
    cdcStartTime : Maybe Posix,cdcStartPosition : Maybe String,cdcStopPosition : Maybe String
    }
...
startReplicationTaskAssessment replicationTaskArn =
    ...
    let
        requestInput = StartReplicationTaskAssessmentMessage
...
stopReplicationTask replicationTaskArn =
    ...
    let
        requestInput = StopReplicationTaskMessage
...
testConnection replicationInstanceArn endpointArn =
    ...
    let
        requestInput = TestConnectionMessage
...
applyPendingMaintenanceActionResponseToString : ApplyPendingMaintenanceActionResponse -> String -- List (String, String)
applyPendingMaintenanceActionResponseToString val =
    -- Dict.empty
...
certificateToString val =
    ...
    --     |> Dict.insert
    --         "certificateCreationDate" "" -- val.certificateCreationDate
        
    --     |> Dict.insert
    --         "certificatePem" "" -- val.certificatePem
        
    --     |> Dict.insert
    --         "certificateWallet" "" -- val.certificateWallet
    ...
    --     |> Dict.insert
    --         "signingAlgorithm" "" -- val.signingAlgorithm
...
connectionToString val =
    ...
    --     |> Dict.insert
    --         "replicationInstanceArn" "" -- val.replicationInstanceArn
    ...
    --     |> Dict.insert
    --         "endpointIdentifier" "" -- val.endpointIdentifier
        
    --     |> Dict.insert
    --         "replicationInstanceIdentifier" "" -- val.replicationInstanceIdentifier
...
createEventSubscriptionResponseToString : CreateEventSubscriptionResponse -> String -- List (String, String)
createEventSubscriptionResponseToString val =
    -- Dict.empty
...
createReplicationInstanceResponseToString : CreateReplicationInstanceResponse -> String -- List (String, String)
createReplicationInstanceResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "replicationInstance" "" -- val.replicationInstance
...
createReplicationSubnetGroupResponseToString : CreateReplicationSubnetGroupResponse -> String -- List (String, String)
createReplicationSubnetGroupResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "replicationSubnetGroup" "" -- val.replicationSubnetGroup
...
createReplicationTaskResponseToString : CreateReplicationTaskResponse -> String -- List (String, String)
createReplicationTaskResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "replicationTask" "" -- val.replicationTask
...
deleteCertificateResponseToString : DeleteCertificateResponse -> String -- List (String, String)
deleteCertificateResponseToString val =
    -- Dict.empty
...
deleteEndpointResponseToString : DeleteEndpointResponse -> String -- List (String, String)
deleteEndpointResponseToString val =
    -- Dict.empty
...
deleteEventSubscriptionResponseToString : DeleteEventSubscriptionResponse -> String -- List (String, String)
deleteEventSubscriptionResponseToString val =
    -- Dict.empty
...
deleteReplicationInstanceResponseToString : DeleteReplicationInstanceResponse -> String -- List (String, String)
deleteReplicationInstanceResponseToString val =
    -- Dict.empty
...
deleteReplicationSubnetGroupResponseToString : DeleteReplicationSubnetGroupResponse -> String -- List (String, String)
deleteReplicationSubnetGroupResponseToString val =
    -- Dict.empty
...
deleteReplicationTaskResponseToString : DeleteReplicationTaskResponse -> String -- List (String, String)
deleteReplicationTaskResponseToString val =
    -- Dict.empty
...
describeAccountAttributesResponseToString : DescribeAccountAttributesResponse -> String -- List (String, String)
describeAccountAttributesResponseToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "uniqueAccountIdentifier" "" -- val.uniqueAccountIdentifier
...
describeCertificatesResponseToString : DescribeCertificatesResponse -> String -- List (String, String)
describeCertificatesResponseToString val =
    -- Dict.empty
...
describeConnectionsResponseToString : DescribeConnectionsResponse -> String -- List (String, String)
describeConnectionsResponseToString val =
    -- Dict.empty
...
describeEndpointTypesResponseToString : DescribeEndpointTypesResponse -> String -- List (String, String)
describeEndpointTypesResponseToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "supportedEndpointTypes" "" -- val.supportedEndpointTypes
...
describeEndpointsResponseToString : DescribeEndpointsResponse -> String -- List (String, String)
describeEndpointsResponseToString val =
    -- Dict.empty
...
describeEventCategoriesResponseToString : DescribeEventCategoriesResponse -> String -- List (String, String)
describeEventCategoriesResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "eventCategoryGroupList" "" -- val.eventCategoryGroupList
...
describeEventSubscriptionsResponseToString : DescribeEventSubscriptionsResponse -> String -- List (String, String)
describeEventSubscriptionsResponseToString val =
    -- Dict.empty
...
describeOrderableReplicationInstancesResponseToString : DescribeOrderableReplicationInstancesResponse -> String -- List (String, String)
describeOrderableReplicationInstancesResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "orderableReplicationInstances" "" -- val.orderableReplicationInstances
...
describePendingMaintenanceActionsResponseToString : DescribePendingMaintenanceActionsResponse -> String -- List (String, String)
describePendingMaintenanceActionsResponseToString val =
    -- Dict.empty
...
describeRefreshSchemasStatusResponseToString : DescribeRefreshSchemasStatusResponse -> String -- List (String, String)
describeRefreshSchemasStatusResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "refreshSchemasStatus" "" -- val.refreshSchemasStatus
...
describeReplicationInstanceTaskLogsResponseToString : DescribeReplicationInstanceTaskLogsResponse -> String -- List (String, String)
describeReplicationInstanceTaskLogsResponseToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "replicationInstanceTaskLogs" "" -- val.replicationInstanceTaskLogs
...
describeReplicationInstancesResponseToString : DescribeReplicationInstancesResponse -> String -- List (String, String)
describeReplicationInstancesResponseToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "replicationInstances" "" -- val.replicationInstances
...
describeReplicationSubnetGroupsResponseToString : DescribeReplicationSubnetGroupsResponse -> String -- List (String, String)
describeReplicationSubnetGroupsResponseToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "replicationSubnetGroups" "" -- val.replicationSubnetGroups
...
describeReplicationTaskAssessmentResultsResponseToString : DescribeReplicationTaskAssessmentResultsResponse -> String -- List (String, String)
describeReplicationTaskAssessmentResultsResponseToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "replicationTaskAssessmentResults" "" -- val.replicationTaskAssessmentResults
...
describeReplicationTasksResponseToString : DescribeReplicationTasksResponse -> String -- List (String, String)
describeReplicationTasksResponseToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "replicationTasks" "" -- val.replicationTasks
...
describeSchemasResponseToString : DescribeSchemasResponse -> String -- List (String, String)
describeSchemasResponseToString val =
    -- Dict.empty
...
describeTableStatisticsResponseToString : DescribeTableStatisticsResponse -> String -- List (String, String)
describeTableStatisticsResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "replicationTaskArn" "" -- val.replicationTaskArn
        
    --     |> Dict.insert
    --         "tableStatistics" "" -- val.tableStatistics
...
dmsTransferSettingsToString : DmsTransferSettings -> String -- List (String, String)
dmsTransferSettingsToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "serviceAccessRoleArn" "" -- val.serviceAccessRoleArn
...
dynamoDbSettingsToString : DynamoDbSettings -> String -- List (String, String)
dynamoDbSettingsToString val =
    -- Dict.empty
...
elasticsearchSettingsToString : ElasticsearchSettings -> String -- List (String, String)
elasticsearchSettingsToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "fullLoadErrorPercentage" "" -- val.fullLoadErrorPercentage
        
    --     |> Dict.insert
    --         "errorRetryDuration" "" -- val.errorRetryDuration
...
endpointToString val =
    ...
    --     |> Dict.insert
    --         "engineDisplayName" "" -- val.engineDisplayName
    ...
    --     |> Dict.insert
    --         "extraConnectionAttributes" "" -- val.extraConnectionAttributes
    ...
    --     |> Dict.insert
    --         "externalTableDefinition" "" -- val.externalTableDefinition
        
    --     |> Dict.insert
    --         "externalId" "" -- val.externalId
        
    --     |> Dict.insert
    --         "dynamoDbSettings" "" -- val.dynamoDbSettings
        
    --     |> Dict.insert
    --         "s3Settings" "" -- val.s3Settings
        
    --     |> Dict.insert
    --         "dmsTransferSettings" "" -- val.dmsTransferSettings
        
    --     |> Dict.insert
    --         "mongoDbSettings" "" -- val.mongoDbSettings
        
    --     |> Dict.insert
    --         "kinesisSettings" "" -- val.kinesisSettings
        
    --     |> Dict.insert
    --         "elasticsearchSettings" "" -- val.elasticsearchSettings
        
    --     |> Dict.insert
    --         "redshiftSettings" "" -- val.redshiftSettings
...
eventCategoryGroupToString : EventCategoryGroup -> String -- List (String, String)
eventCategoryGroupToString val =
    -- Dict.empty
...
kinesisSettingsToString : KinesisSettings -> String -- List (String, String)
kinesisSettingsToString val =
    -- Dict.empty
...
modifyEndpointResponseToString : ModifyEndpointResponse -> String -- List (String, String)
modifyEndpointResponseToString val =
    -- Dict.empty
...
modifyEventSubscriptionResponseToString : ModifyEventSubscriptionResponse -> String -- List (String, String)
modifyEventSubscriptionResponseToString val =
    -- Dict.empty
...
modifyReplicationInstanceResponseToString : ModifyReplicationInstanceResponse -> String -- List (String, String)
modifyReplicationInstanceResponseToString val =
    -- Dict.empty
...
modifyReplicationSubnetGroupResponseToString : ModifyReplicationSubnetGroupResponse -> String -- List (String, String)
modifyReplicationSubnetGroupResponseToString val =
    -- Dict.empty
...
modifyReplicationTaskResponseToString : ModifyReplicationTaskResponse -> String -- List (String, String)
modifyReplicationTaskResponseToString val =
    -- Dict.empty
...
mongoDbSettingsToString : MongoDbSettings -> String -- List (String, String)
mongoDbSettingsToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "nestingLevel" "" -- val.nestingLevel
        
    --     |> Dict.insert
    --         "extractDocId" "" -- val.extractDocId
        
    --     |> Dict.insert
    --         "docsToInvestigate" "" -- val.docsToInvestigate
        
    --     |> Dict.insert
    --         "authSource" "" -- val.authSource
...
orderableReplicationInstanceToString : OrderableReplicationInstance -> String -- List (String, String)
orderableReplicationInstanceToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "replicationInstanceClass" "" -- val.replicationInstanceClass
        
    --     |> Dict.insert
    --         "storageType" "" -- val.storageType
        
    --     |> Dict.insert
    --         "minAllocatedStorage" "" -- val.minAllocatedStorage
        
    --     |> Dict.insert
    --         "maxAllocatedStorage" "" -- val.maxAllocatedStorage
        
    --     |> Dict.insert
    --         "defaultAllocatedStorage" "" -- val.defaultAllocatedStorage
        
    --     |> Dict.insert
    --         "includedAllocatedStorage" "" -- val.includedAllocatedStorage
...
rebootReplicationInstanceResponseToString : RebootReplicationInstanceResponse -> String -- List (String, String)
rebootReplicationInstanceResponseToString val =
    -- Dict.empty
...
redshiftSettingsToString : RedshiftSettings -> String -- List (String, String)
redshiftSettingsToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "acceptAnyDate" "" -- val.acceptAnyDate
        
    --     |> Dict.insert
    --         "afterConnectScript" "" -- val.afterConnectScript
        
    --     |> Dict.insert
    --         "bucketFolder" "" -- val.bucketFolder
    ...
    --     |> Dict.insert
    --         "emptyAsNull" "" -- val.emptyAsNull
        
    --     |> Dict.insert
    --         "encryptionMode" "" -- val.encryptionMode
        
    --     |> Dict.insert
    --         "fileTransferUploadStreams" "" -- val.fileTransferUploadStreams
        
    --     |> Dict.insert
    --         "loadTimeout" "" -- val.loadTimeout
    ...
    --     |> Dict.insert
    --         "removeQuotes" "" -- val.removeQuotes
        
    --     |> Dict.insert
    --         "replaceInvalidChars" "" -- val.replaceInvalidChars
        
    --     |> Dict.insert
    --         "replaceChars" "" -- val.replaceChars
    ...
    --     |> Dict.insert
    --         "serverSideEncryptionKmsKeyId" "" -- val.serverSideEncryptionKmsKeyId
        
    --     |> Dict.insert
    --         "timeFormat" "" -- val.timeFormat
        
    --     |> Dict.insert
    --         "trimBlanks" "" -- val.trimBlanks
        
    --     |> Dict.insert
    --         "truncateColumns" "" -- val.truncateColumns
        
    --     |> Dict.insert
    --         "username" "" -- val.username
        
    --     |> Dict.insert
    --         "writeBufferSize" "" -- val.writeBufferSize
...
refreshSchemasResponseToString : RefreshSchemasResponse -> String -- List (String, String)
refreshSchemasResponseToString val =
    -- Dict.empty
...
refreshSchemasStatusToString : RefreshSchemasStatus -> String -- List (String, String)
refreshSchemasStatusToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "lastRefreshDate" "" -- val.lastRefreshDate
...
reloadTablesResponseToString : ReloadTablesResponse -> String -- List (String, String)
reloadTablesResponseToString val =
    -- Dict.empty
...
replicationInstanceToString : ReplicationInstance -> String -- List (String, String)
replicationInstanceToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "replicationInstanceStatus" "" -- val.replicationInstanceStatus
    ...
    --     |> Dict.insert
    --         "replicationInstancePublicIpAddress" "" -- val.replicationInstancePublicIpAddress
        
    --     |> Dict.insert
    --         "replicationInstancePrivateIpAddress" "" -- val.replicationInstancePrivateIpAddress
        
    --     |> Dict.insert
    --         "replicationInstancePublicIpAddresses" "" -- val.replicationInstancePublicIpAddresses
        
    --     |> Dict.insert
    --         "replicationInstancePrivateIpAddresses" "" -- val.replicationInstancePrivateIpAddresses
    ...
    --     |> Dict.insert
    --         "freeUntil" "" -- val.freeUntil
        
    --     |> Dict.insert
    --         "dnsNameServers" "" -- val.dnsNameServers
...
replicationInstanceTaskLogToString : ReplicationInstanceTaskLog -> String -- List (String, String)
replicationInstanceTaskLogToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "replicationTaskName" "" -- val.replicationTaskName
        
    --     |> Dict.insert
    --         "replicationTaskArn" "" -- val.replicationTaskArn
        
    --     |> Dict.insert
    --         "replicationInstanceTaskLogSize" "" -- val.replicationInstanceTaskLogSize
...
replicationPendingModifiedValuesToString : ReplicationPendingModifiedValues -> String -- List (String, String)
replicationPendingModifiedValuesToString val =
    -- Dict.empty
...
replicationSubnetGroupToString : ReplicationSubnetGroup -> String -- List (String, String)
replicationSubnetGroupToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "replicationSubnetGroupIdentifier" "" -- val.replicationSubnetGroupIdentifier
        
    --     |> Dict.insert
    --         "replicationSubnetGroupDescription" "" -- val.replicationSubnetGroupDescription
...
replicationTaskToString : ReplicationTask -> String -- List (String, String)
replicationTaskToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "replicationTaskIdentifier" "" -- val.replicationTaskIdentifier
        
    --     |> Dict.insert
    --         "sourceEndpointArn" "" -- val.sourceEndpointArn
        
    --     |> Dict.insert
    --         "targetEndpointArn" "" -- val.targetEndpointArn
        
    --     |> Dict.insert
    --         "replicationInstanceArn" "" -- val.replicationInstanceArn
        
    --     |> Dict.insert
    --         "migrationType" "" -- val.migrationType
        
    --     |> Dict.insert
    --         "tableMappings" "" -- val.tableMappings
        
    --     |> Dict.insert
    --         "replicationTaskSettings" "" -- val.replicationTaskSettings
    ...
    --     |> Dict.insert
    --         "replicationTaskCreationDate" "" -- val.replicationTaskCreationDate
        
    --     |> Dict.insert
    --         "replicationTaskStartDate" "" -- val.replicationTaskStartDate
        
    --     |> Dict.insert
    --         "cdcStartPosition" "" -- val.cdcStartPosition
        
    --     |> Dict.insert
    --         "cdcStopPosition" "" -- val.cdcStopPosition
        
    --     |> Dict.insert
    --         "recoveryCheckpoint" "" -- val.recoveryCheckpoint
        
    --     |> Dict.insert
    --         "replicationTaskArn" "" -- val.replicationTaskArn
        
    --     |> Dict.insert
    --         "replicationTaskStats" "" -- val.replicationTaskStats
...
replicationTaskAssessmentResultToString : ReplicationTaskAssessmentResult -> String -- List (String, String)
replicationTaskAssessmentResultToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "replicationTaskLastAssessmentDate" "" -- val.replicationTaskLastAssessmentDate
        
    --     |> Dict.insert
    --         "assessmentStatus" "" -- val.assessmentStatus
        
    --     |> Dict.insert
    --         "assessmentResultsFile" "" -- val.assessmentResultsFile
        
    --     |> Dict.insert
    --         "assessmentResults" "" -- val.assessmentResults
        
    --     |> Dict.insert
    --         "s3ObjectUrl" "" -- val.s3ObjectUrl
...
replicationTaskStatsToString : ReplicationTaskStats -> String -- List (String, String)
replicationTaskStatsToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "fullLoadProgressPercent" "" -- val.fullLoadProgressPercent
        
    --     |> Dict.insert
    --         "elapsedTimeMillis" "" -- val.elapsedTimeMillis
        
    --     |> Dict.insert
    --         "tablesLoaded" "" -- val.tablesLoaded
        
    --     |> Dict.insert
    --         "tablesLoading" "" -- val.tablesLoading
        
    --     |> Dict.insert
    --         "tablesQueued" "" -- val.tablesQueued
        
    --     |> Dict.insert
    --         "tablesErrored" "" -- val.tablesErrored
...
s3SettingsToString : S3Settings -> String -- List (String, String)
s3SettingsToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "csvRowDelimiter" "" -- val.csvRowDelimiter
        
    --     |> Dict.insert
    --         "csvDelimiter" "" -- val.csvDelimiter
    ...
    --     |> Dict.insert
    --         "compressionType" "" -- val.compressionType
    ...
    --     |> Dict.insert
    --         "dictPageSizeLimit" "" -- val.dictPageSizeLimit
        
    --     |> Dict.insert
    --         "rowGroupLength" "" -- val.rowGroupLength
        
    --     |> Dict.insert
    --         "dataPageSize" "" -- val.dataPageSize
        
    --     |> Dict.insert
    --         "parquetVersion" "" -- val.parquetVersion
        
    --     |> Dict.insert
    --         "enableStatistics" "" -- val.enableStatistics
        
    --     |> Dict.insert
    --         "includeOpForFullLoad" "" -- val.includeOpForFullLoad
        
    --     |> Dict.insert
    --         "cdcInsertsOnly" "" -- val.cdcInsertsOnly
        
    --     |> Dict.insert
    --         "timestampColumnName" "" -- val.timestampColumnName
...
startReplicationTaskAssessmentResponseToString : StartReplicationTaskAssessmentResponse -> String -- List (String, String)
startReplicationTaskAssessmentResponseToString val =
    -- Dict.empty
...
startReplicationTaskResponseToString : StartReplicationTaskResponse -> String -- List (String, String)
startReplicationTaskResponseToString val =
    -- Dict.empty
...
stopReplicationTaskResponseToString : StopReplicationTaskResponse -> String -- List (String, String)
stopReplicationTaskResponseToString val =
    -- Dict.empty
...
supportedEndpointTypeToString : SupportedEndpointType -> String -- List (String, String)
supportedEndpointTypeToString val =
    -- Dict.empty
...
tableStatisticsToString : TableStatistics -> String -- List (String, String)
tableStatisticsToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "fullLoadRows" "" -- val.fullLoadRows
        
    --     |> Dict.insert
    --         "fullLoadCondtnlChkFailedRows" "" -- val.fullLoadCondtnlChkFailedRows
        
    --     |> Dict.insert
    --         "fullLoadErrorRows" "" -- val.fullLoadErrorRows
        
    --     |> Dict.insert
    --         "lastUpdateTime" "" -- val.lastUpdateTime
        
    --     |> Dict.insert
    --         "tableState" "" -- val.tableState
        
    --     |> Dict.insert
    --         "validationPendingRecords" "" -- val.validationPendingRecords
        
    --     |> Dict.insert
    --         "validationFailedRecords" "" -- val.validationFailedRecords
        
    --     |> Dict.insert
    --         "validationSuspendedRecords" "" -- val.validationSuspendedRecords
        
    --     |> Dict.insert
    --         "validationState" "" -- val.validationState
        
    --     |> Dict.insert
    --         "validationStateDetails" "" -- val.validationStateDetails
...
tableToReloadToString : TableToReload -> String -- List (String, String)
tableToReloadToString val =
    -- Dict.empty
...
testConnectionResponseToString : TestConnectionResponse -> String -- List (String, String)
testConnectionResponseToString val =
    -- Dict.empty
