module AWS.Support exposing
    ...
    , AttachmentIdNotFound, AttachmentLimitExceeded, AttachmentSetExpired, AttachmentSetIdNotFound, AttachmentSetSizeLimitExceeded, CaseCreationLimitExceeded, CaseIdNotFound, DescribeAttachmentLimitExceeded, InternalServerError
    )
...
addAttachmentsToSet attachments setOptions =
    let
        ...
        options =
            setOptions (AddAttachmentsToSetOptions Nothing)
    in
...
addCommunicationToCase communicationBody setOptions =
    let
        ...
        options =
            setOptions (AddCommunicationToCaseOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createCase subject communicationBody setOptions =
    let
        ...
        options =
            setOptions (CreateCaseOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeCases setOptions =
    let
        ...
        options =
            setOptions (DescribeCasesOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeCommunications caseId setOptions =
    let
        ...
        options =
            setOptions (DescribeCommunicationsOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeServices setOptions =
    let
        ...
        options =
            setOptions (DescribeServicesOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeSeverityLevels setOptions =
    let
        ...
        options =
            setOptions (DescribeSeverityLevelsOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeTrustedAdvisorCheckResult checkId setOptions =
    let
        ...
        options =
            setOptions (DescribeTrustedAdvisorCheckResultOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
resolveCase setOptions =
    let
        ...
        options =
            setOptions (ResolveCaseOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
