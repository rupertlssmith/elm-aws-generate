module AWS.ConfigService
    exposing
        ...
        , DeleteRemediationConfigurationOptions
        , deleteRetentionConfiguration
        , deliverConfigSnapshot
        , describeAggregateComplianceByConfigRules
        , DescribeAggregateComplianceByConfigRulesOptions
        , describeAggregationAuthorizations
        , DescribeAggregationAuthorizationsOptions
        ...
        , DescribeConfigurationAggregatorSourcesStatusOptions
        , describeConfigurationAggregators
        , DescribeConfigurationAggregatorsOptions
        ...
        , DescribeOrganizationConfigRuleStatusesOptions
        , describeOrganizationConfigRules
        , DescribeOrganizationConfigRulesOptions
        , describePendingAggregationRequests
        , DescribePendingAggregationRequestsOptions
        , describeRemediationConfigurations
        , describeRemediationExecutionStatus
        , DescribeRemediationExecutionStatusOptions
        , describeRetentionConfigurations
        , DescribeRetentionConfigurationsOptions
        , getAggregateComplianceDetailsByConfigRule
        , GetAggregateComplianceDetailsByConfigRuleOptions
        , getAggregateConfigRuleComplianceSummary
        , GetAggregateConfigRuleComplianceSummaryOptions
        , getAggregateDiscoveredResourceCounts
        , GetAggregateDiscoveredResourceCountsOptions
        ...
        , GetDiscoveredResourceCountsOptions
        , getOrganizationConfigRuleDetailedStatus
        , GetOrganizationConfigRuleDetailedStatusOptions
        , getResourceConfigHistory
        , GetResourceConfigHistoryOptions
        , listAggregateDiscoveredResources
        , ListAggregateDiscoveredResourcesOptions
        , listDiscoveredResources
        , ListDiscoveredResourcesOptions
        , listTagsForResource
        , ListTagsForResourceOptions
        , putAggregationAuthorization
        , PutAggregationAuthorizationOptions
        , putConfigRule
        , PutConfigRuleOptions
        , putConfigurationAggregator
        , PutConfigurationAggregatorOptions
        , putConfigurationRecorder
        , putDeliveryChannel
        , putEvaluations
        , PutEvaluationsOptions
        , putOrganizationConfigRule
        , PutOrganizationConfigRuleOptions
        , putRemediationConfigurations
        , putRetentionConfiguration
        , selectResourceConfig
        , SelectResourceConfigOptions
...
* `configurationAggregatorName` __:__ `String`
* `resourceIdentifiers` __:__ `(List AggregateResourceIdentifier)`
...
batchGetAggregateResourceConfig configurationAggregatorName resourceIdentifiers =
    ...
    let
        requestInput = BatchGetAggregateResourceConfigRequest
...
* `resourceKeys` __:__ `(List ResourceKey)`
...
batchGetResourceConfig resourceKeys =
    ...
    let
        requestInput = BatchGetResourceConfigRequest
...
* `authorizedAccountId` __:__ `String`
* `authorizedAwsRegion` __:__ `String`
...
deleteAggregationAuthorization authorizedAccountId authorizedAwsRegion =
    ...
    let
        requestInput = DeleteAggregationAuthorizationRequest
...
deleteConfigRule configRuleName =
    ...
    let
        requestInput = DeleteConfigRuleRequest
...
deleteConfigurationAggregator configurationAggregatorName =
    ...
    let
        requestInput = DeleteConfigurationAggregatorRequest
...
deleteConfigurationRecorder configurationRecorderName =
    ...
    let
        requestInput = DeleteConfigurationRecorderRequest
...
deleteDeliveryChannel deliveryChannelName =
    ...
    let
        requestInput = DeleteDeliveryChannelRequest
...
deleteEvaluationResults configRuleName =
    ...
    let
        requestInput = DeleteEvaluationResultsRequest
...
* `organizationConfigRuleName` __:__ `String`
...
deleteOrganizationConfigRule organizationConfigRuleName =
    ...
    let
        requestInput = DeleteOrganizationConfigRuleRequest
...
* `requesterAccountId` __:__ `String`
* `requesterAwsRegion` __:__ `String`
...
deletePendingAggregationRequest requesterAccountId requesterAwsRegion =
    ...
    let
        requestInput = DeletePendingAggregationRequestRequest
...
deleteRemediationConfiguration configRuleName setOptions =
    ...
    let
        requestInput = DeleteRemediationConfigurationRequest
        ...
        options = setOptions (DeleteRemediationConfigurationOptions Nothing)
...
* `retentionConfigurationName` __:__ `String`
...
deleteRetentionConfiguration retentionConfigurationName =
    ...
    let
        requestInput = DeleteRetentionConfigurationRequest
...
deliverConfigSnapshot deliveryChannelName =
    ...
    let
        requestInput = DeliverConfigSnapshotRequest
...
describeAggregateComplianceByConfigRules configurationAggregatorName setOptions =
    ...
    let
        requestInput = DescribeAggregateComplianceByConfigRulesRequest
        ...
        options = setOptions (DescribeAggregateComplianceByConfigRulesOptions Nothing Nothing Nothing)
...
type alias DescribeAggregateComplianceByConfigRulesOptions =
    {
    filters : Maybe ConfigRuleComplianceFilters,limit : Maybe Int,nextToken : Maybe String
    }
...
describeAggregationAuthorizations setOptions =
    ...
    let
        requestInput = DescribeAggregationAuthorizationsRequest
        ...
        options = setOptions (DescribeAggregationAuthorizationsOptions Nothing Nothing)
...
describeComplianceByConfigRule setOptions =
    ...
    let
        requestInput = DescribeComplianceByConfigRuleRequest
...
type alias DescribeComplianceByConfigRuleOptions =
    {
    configRuleNames : Maybe (List String),complianceTypes : Maybe (List ComplianceType),nextToken : Maybe String
    }
...
describeComplianceByResource setOptions =
    ...
    let
        requestInput = DescribeComplianceByResourceRequest
...
type alias DescribeComplianceByResourceOptions =
    {
    resourceType : Maybe String,resourceId : Maybe String,complianceTypes : Maybe (List ComplianceType),limit : Maybe Int,nextToken : Maybe String
    }
...
describeConfigRuleEvaluationStatus setOptions =
    ...
    let
        requestInput = DescribeConfigRuleEvaluationStatusRequest
...
type alias DescribeConfigRuleEvaluationStatusOptions =
    {
    configRuleNames : Maybe (List String),nextToken : Maybe String,limit : Maybe Int
    }
...
describeConfigRules setOptions =
    ...
    let
        requestInput = DescribeConfigRulesRequest
...
type alias DescribeConfigRulesOptions =
    {
    configRuleNames : Maybe (List String),nextToken : Maybe String
    }
...
describeConfigurationAggregatorSourcesStatus configurationAggregatorName setOptions =
    ...
    let
        requestInput = DescribeConfigurationAggregatorSourcesStatusRequest
        ...
        options = setOptions (DescribeConfigurationAggregatorSourcesStatusOptions Nothing Nothing Nothing)
...
type alias DescribeConfigurationAggregatorSourcesStatusOptions =
    {
    updateStatus : Maybe (List AggregatedSourceStatusType),nextToken : Maybe String,limit : Maybe Int
    }
...
describeConfigurationAggregators setOptions =
    ...
    let
        requestInput = DescribeConfigurationAggregatorsRequest
        ...
        options = setOptions (DescribeConfigurationAggregatorsOptions Nothing Nothing Nothing)
...
type alias DescribeConfigurationAggregatorsOptions =
    {
    configurationAggregatorNames : Maybe (List String),nextToken : Maybe String,limit : Maybe Int
    }
...
describeConfigurationRecorderStatus setOptions =
    ...
    let
        requestInput = DescribeConfigurationRecorderStatusRequest
...
describeConfigurationRecorders setOptions =
    ...
    let
        requestInput = DescribeConfigurationRecordersRequest
...
describeDeliveryChannelStatus setOptions =
    ...
    let
        requestInput = DescribeDeliveryChannelStatusRequest
...
describeDeliveryChannels setOptions =
    ...
    let
        requestInput = DescribeDeliveryChannelsRequest
...
describeOrganizationConfigRuleStatuses setOptions =
    ...
    let
        requestInput = DescribeOrganizationConfigRuleStatusesRequest
        ...
        options = setOptions (DescribeOrganizationConfigRuleStatusesOptions Nothing Nothing Nothing)
...
type alias DescribeOrganizationConfigRuleStatusesOptions =
    {
    organizationConfigRuleNames : Maybe (List String),limit : Maybe Int,nextToken : Maybe String
    }
...
describeOrganizationConfigRules setOptions =
    ...
    let
        requestInput = DescribeOrganizationConfigRulesRequest
        ...
        options = setOptions (DescribeOrganizationConfigRulesOptions Nothing Nothing Nothing)
...
describePendingAggregationRequests setOptions =
    ...
    let
        requestInput = DescribePendingAggregationRequestsRequest
        ...
        options = setOptions (DescribePendingAggregationRequestsOptions Nothing Nothing)
...
* `configRuleNames` __:__ `(List String)`
...
describeRemediationConfigurations configRuleNames =
    ...
    let
        requestInput = DescribeRemediationConfigurationsRequest
...
describeRemediationExecutionStatus configRuleName setOptions =
    ...
    let
        requestInput = DescribeRemediationExecutionStatusRequest
        ...
        options = setOptions (DescribeRemediationExecutionStatusOptions Nothing Nothing Nothing)
...
type alias DescribeRemediationExecutionStatusOptions =
    {
    resourceKeys : Maybe (List ResourceKey),limit : Maybe Int,nextToken : Maybe String
    }
...
describeRetentionConfigurations setOptions =
    ...
    let
        requestInput = DescribeRetentionConfigurationsRequest
        ...
        options = setOptions (DescribeRetentionConfigurationsOptions Nothing Nothing)
...
type alias DescribeRetentionConfigurationsOptions =
    {
    retentionConfigurationNames : Maybe (List String),nextToken : Maybe String
    }
...
getAggregateComplianceDetailsByConfigRule configurationAggregatorName configRuleName accountId awsRegion setOptions =
    ...
    let
        requestInput = GetAggregateComplianceDetailsByConfigRuleRequest
        ...
        options = setOptions (GetAggregateComplianceDetailsByConfigRuleOptions Nothing Nothing Nothing)
...
type alias GetAggregateComplianceDetailsByConfigRuleOptions =
    {
    complianceType : Maybe ComplianceType,limit : Maybe Int,nextToken : Maybe String
    }
...
getAggregateConfigRuleComplianceSummary configurationAggregatorName setOptions =
    ...
    let
        requestInput = GetAggregateConfigRuleComplianceSummaryRequest
        ...
        options = setOptions (GetAggregateConfigRuleComplianceSummaryOptions Nothing Nothing Nothing Nothing)
...
type alias GetAggregateConfigRuleComplianceSummaryOptions =
    {
    filters : Maybe ConfigRuleComplianceSummaryFilters,groupByKey : Maybe ConfigRuleComplianceSummaryGroupKey,limit : Maybe Int,nextToken : Maybe String
    }
...
getAggregateDiscoveredResourceCounts configurationAggregatorName setOptions =
    ...
    let
        requestInput = GetAggregateDiscoveredResourceCountsRequest
        ...
        options = setOptions (GetAggregateDiscoveredResourceCountsOptions Nothing Nothing Nothing Nothing)
...
type alias GetAggregateDiscoveredResourceCountsOptions =
    {
    filters : Maybe ResourceCountFilters,groupByKey : Maybe ResourceCountGroupKey,limit : Maybe Int,nextToken : Maybe String
    }
...
* `configurationAggregatorName` __:__ `String`
* `resourceIdentifier` __:__ `AggregateResourceIdentifier`
...
getAggregateResourceConfig configurationAggregatorName resourceIdentifier =
    ...
    let
        requestInput = GetAggregateResourceConfigRequest
...
getComplianceDetailsByConfigRule configRuleName setOptions =
    ...
    let
        requestInput = GetComplianceDetailsByConfigRuleRequest
...
type alias GetComplianceDetailsByConfigRuleOptions =
    {
    complianceTypes : Maybe (List ComplianceType),limit : Maybe Int,nextToken : Maybe String
    }
...
getComplianceDetailsByResource resourceType resourceId setOptions =
    ...
    let
        requestInput = GetComplianceDetailsByResourceRequest
...
type alias GetComplianceDetailsByResourceOptions =
    {
    complianceTypes : Maybe (List ComplianceType),nextToken : Maybe String
    }
...
getComplianceSummaryByConfigRule :
    ...
    AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper GetComplianceSummaryByConfigRuleResponse)
...
getComplianceSummaryByResourceType setOptions =
    ...
    let
        requestInput = GetComplianceSummaryByResourceTypeRequest
...
getDiscoveredResourceCounts setOptions =
    ...
    let
        requestInput = GetDiscoveredResourceCountsRequest
        ...
        options = setOptions (GetDiscoveredResourceCountsOptions Nothing Nothing Nothing)
...
type alias GetDiscoveredResourceCountsOptions =
    {
    resourceTypes : Maybe (List String),limit : Maybe Int,nextToken : Maybe String
    }
...
getOrganizationConfigRuleDetailedStatus organizationConfigRuleName setOptions =
    ...
    let
        requestInput = GetOrganizationConfigRuleDetailedStatusRequest
        ...
        options = setOptions (GetOrganizationConfigRuleDetailedStatusOptions Nothing Nothing Nothing)
...
type alias GetOrganizationConfigRuleDetailedStatusOptions =
    {
    filters : Maybe StatusDetailFilters,limit : Maybe Int,nextToken : Maybe String
    }
...
getResourceConfigHistory resourceType resourceId setOptions =
    ...
    let
        requestInput = GetResourceConfigHistoryRequest
...
type alias GetResourceConfigHistoryOptions =
    {
    laterTime : Maybe Posix,earlierTime : Maybe Posix,chronologicalOrder : Maybe ChronologicalOrder,limit : Maybe Int,nextToken : Maybe String
    }
...
listAggregateDiscoveredResources configurationAggregatorName resourceType setOptions =
    ...
    let
        requestInput = ListAggregateDiscoveredResourcesRequest
        ...
        options = setOptions (ListAggregateDiscoveredResourcesOptions Nothing Nothing Nothing)
...
type alias ListAggregateDiscoveredResourcesOptions =
    {
    filters : Maybe ResourceFilters,limit : Maybe Int,nextToken : Maybe String
    }
...
listDiscoveredResources resourceType setOptions =
    ...
    let
        requestInput = ListDiscoveredResourcesRequest
...
type alias ListDiscoveredResourcesOptions =
    {
    resourceIds : Maybe (List String),resourceName : Maybe String,limit : Maybe Int,includeDeletedResources : Maybe Bool,nextToken : Maybe String
    }
...
putAggregationAuthorization authorizedAccountId authorizedAwsRegion setOptions =
    ...
    let
        requestInput = PutAggregationAuthorizationRequest
        ...
        options = setOptions (PutAggregationAuthorizationOptions Nothing)
...
putConfigRule configRule setOptions =
    ...
    let
        requestInput = PutConfigRuleRequest
        ...
        options = setOptions (PutConfigRuleOptions Nothing)
...
putConfigurationAggregator configurationAggregatorName setOptions =
    ...
    let
        requestInput = PutConfigurationAggregatorRequest
        ...
        options = setOptions (PutConfigurationAggregatorOptions Nothing Nothing Nothing)
...
type alias PutConfigurationAggregatorOptions =
    {
    accountAggregationSources : Maybe (List AccountAggregationSource),organizationAggregationSource : Maybe OrganizationAggregationSource,tags : Maybe (List Tag)
    }
...
putConfigurationRecorder configurationRecorder =
    ...
    let
        requestInput = PutConfigurationRecorderRequest
...
putDeliveryChannel deliveryChannel =
    ...
    let
        requestInput = PutDeliveryChannelRequest
...
putEvaluations resultToken setOptions =
    ...
    let
        requestInput = PutEvaluationsRequest
        ...
        options = setOptions (PutEvaluationsOptions Nothing Nothing)
...
type alias PutEvaluationsOptions =
    {
    evaluations : Maybe (List Evaluation),testMode : Maybe Bool
    }
...
putOrganizationConfigRule organizationConfigRuleName setOptions =
    ...
    let
        requestInput = PutOrganizationConfigRuleRequest
        ...
        options = setOptions (PutOrganizationConfigRuleOptions Nothing Nothing Nothing)
...
type alias PutOrganizationConfigRuleOptions =
    {
    organizationManagedRuleMetadata : Maybe OrganizationManagedRuleMetadata,organizationCustomRuleMetadata : Maybe OrganizationCustomRuleMetadata,excludedAccounts : Maybe (List String)
    }
...
* `remediationConfigurations` __:__ `(List RemediationConfiguration)`
...
putRemediationConfigurations remediationConfigurations =
    ...
    let
        requestInput = PutRemediationConfigurationsRequest
...
* `retentionPeriodInDays` __:__ `Int`
...
putRetentionConfiguration retentionPeriodInDays =
    ...
    let
        requestInput = PutRetentionConfigurationRequest
...
selectResourceConfig expression setOptions =
    ...
    let
        requestInput = SelectResourceConfigRequest
        ...
        options = setOptions (SelectResourceConfigOptions Nothing Nothing)
...
startConfigRulesEvaluation setOptions =
    ...
    let
        requestInput = StartConfigRulesEvaluationRequest
...
startConfigurationRecorder configurationRecorderName =
    ...
    let
        requestInput = StartConfigurationRecorderRequest
...
startRemediationExecution configRuleName resourceKeys =
    ...
    let
        requestInput = StartRemediationExecutionRequest
...
stopConfigurationRecorder configurationRecorderName =
    ...
    let
        requestInput = StopConfigurationRecorderRequest
...
accountAggregationSourceToString : AccountAggregationSource -> String -- List (String, String)
...
aggregateComplianceByConfigRuleToString : AggregateComplianceByConfigRule -> String -- List (String, String)
...
aggregateComplianceCountToString : AggregateComplianceCount -> String -- List (String, String)
...
aggregateEvaluationResultToString : AggregateEvaluationResult -> String -- List (String, String)
...
aggregateResourceIdentifierToString : AggregateResourceIdentifier -> String -- List (String, String)
...
aggregatedSourceStatusToString : AggregatedSourceStatus -> String -- List (String, String)
...
aggregationAuthorizationToString : AggregationAuthorization -> String -- List (String, String)
...
baseConfigurationItemToString : BaseConfigurationItem -> String -- List (String, String)
...
batchGetAggregateResourceConfigResponseToString : BatchGetAggregateResourceConfigResponse -> String -- List (String, String)
...
batchGetResourceConfigResponseToString : BatchGetResourceConfigResponse -> String -- List (String, String)
...
complianceToString : Compliance -> String -- List (String, String)
...
complianceByConfigRuleToString : ComplianceByConfigRule -> String -- List (String, String)
...
complianceByResourceToString : ComplianceByResource -> String -- List (String, String)
...
complianceContributorCountToString : ComplianceContributorCount -> String -- List (String, String)
...
complianceSummaryToString : ComplianceSummary -> String -- List (String, String)
...
complianceSummaryByResourceTypeToString : ComplianceSummaryByResourceType -> String -- List (String, String)
...
configExportDeliveryInfoToString : ConfigExportDeliveryInfo -> String -- List (String, String)
...
configRuleToString : ConfigRule -> String -- List (String, String)
...
configRuleComplianceFiltersToString : ConfigRuleComplianceFilters -> String -- List (String, String)
...
configRuleComplianceSummaryFiltersToString : ConfigRuleComplianceSummaryFilters -> String -- List (String, String)
...
configRuleEvaluationStatusToString : ConfigRuleEvaluationStatus -> String -- List (String, String)
...
configSnapshotDeliveryPropertiesToString : ConfigSnapshotDeliveryProperties -> String -- List (String, String)
...
configStreamDeliveryInfoToString : ConfigStreamDeliveryInfo -> String -- List (String, String)
...
configurationAggregatorToString : ConfigurationAggregator -> String -- List (String, String)
...
configurationItemToString : ConfigurationItem -> String -- List (String, String)
...
configurationRecorderToString : ConfigurationRecorder -> String -- List (String, String)
...
configurationRecorderStatusToString : ConfigurationRecorderStatus -> String -- List (String, String)
...
deleteEvaluationResultsResponseToString : DeleteEvaluationResultsResponse -> String -- List (String, String)
...
deleteRemediationConfigurationResponseToString : DeleteRemediationConfigurationResponse -> String -- List (String, String)
...
deliverConfigSnapshotResponseToString : DeliverConfigSnapshotResponse -> String -- List (String, String)
...
deliveryChannelToString : DeliveryChannel -> String -- List (String, String)
...
deliveryChannelStatusToString : DeliveryChannelStatus -> String -- List (String, String)
...
describeAggregateComplianceByConfigRulesResponseToString : DescribeAggregateComplianceByConfigRulesResponse -> String -- List (String, String)
...
describeAggregationAuthorizationsResponseToString : DescribeAggregationAuthorizationsResponse -> String -- List (String, String)
...
describeComplianceByConfigRuleResponseToString : DescribeComplianceByConfigRuleResponse -> String -- List (String, String)
...
describeComplianceByResourceResponseToString : DescribeComplianceByResourceResponse -> String -- List (String, String)
...
describeConfigRuleEvaluationStatusResponseToString : DescribeConfigRuleEvaluationStatusResponse -> String -- List (String, String)
...
describeConfigRulesResponseToString : DescribeConfigRulesResponse -> String -- List (String, String)
...
describeConfigurationAggregatorSourcesStatusResponseToString : DescribeConfigurationAggregatorSourcesStatusResponse -> String -- List (String, String)
...
describeConfigurationAggregatorsResponseToString : DescribeConfigurationAggregatorsResponse -> String -- List (String, String)
...
describeConfigurationRecorderStatusResponseToString : DescribeConfigurationRecorderStatusResponse -> String -- List (String, String)
...
describeConfigurationRecordersResponseToString : DescribeConfigurationRecordersResponse -> String -- List (String, String)
...
describeDeliveryChannelStatusResponseToString : DescribeDeliveryChannelStatusResponse -> String -- List (String, String)
...
describeDeliveryChannelsResponseToString : DescribeDeliveryChannelsResponse -> String -- List (String, String)
...
describeOrganizationConfigRuleStatusesResponseToString : DescribeOrganizationConfigRuleStatusesResponse -> String -- List (String, String)
...
describeOrganizationConfigRulesResponseToString : DescribeOrganizationConfigRulesResponse -> String -- List (String, String)
...
describePendingAggregationRequestsResponseToString : DescribePendingAggregationRequestsResponse -> String -- List (String, String)
...
describeRemediationConfigurationsResponseToString : DescribeRemediationConfigurationsResponse -> String -- List (String, String)
...
describeRemediationExecutionStatusResponseToString : DescribeRemediationExecutionStatusResponse -> String -- List (String, String)
...
describeRetentionConfigurationsResponseToString : DescribeRetentionConfigurationsResponse -> String -- List (String, String)
...
evaluationResultIdentifierToString : EvaluationResultIdentifier -> String -- List (String, String)
...
evaluationResultQualifierToString : EvaluationResultQualifier -> String -- List (String, String)
...
failedRemediationBatchToString : FailedRemediationBatch -> String -- List (String, String)
...
fieldInfoToString : FieldInfo -> String -- List (String, String)
...
getAggregateComplianceDetailsByConfigRuleResponseToString : GetAggregateComplianceDetailsByConfigRuleResponse -> String -- List (String, String)
...
getAggregateConfigRuleComplianceSummaryResponseToString : GetAggregateConfigRuleComplianceSummaryResponse -> String -- List (String, String)
...
getAggregateDiscoveredResourceCountsResponseToString : GetAggregateDiscoveredResourceCountsResponse -> String -- List (String, String)
...
getAggregateResourceConfigResponseToString : GetAggregateResourceConfigResponse -> String -- List (String, String)
...
getComplianceDetailsByConfigRuleResponseToString : GetComplianceDetailsByConfigRuleResponse -> String -- List (String, String)
...
getComplianceDetailsByResourceResponseToString : GetComplianceDetailsByResourceResponse -> String -- List (String, String)
...
getComplianceSummaryByConfigRuleResponseToString : GetComplianceSummaryByConfigRuleResponse -> String -- List (String, String)
...
getComplianceSummaryByResourceTypeResponseToString : GetComplianceSummaryByResourceTypeResponse -> String -- List (String, String)
...
getDiscoveredResourceCountsResponseToString : GetDiscoveredResourceCountsResponse -> String -- List (String, String)
...
getOrganizationConfigRuleDetailedStatusResponseToString : GetOrganizationConfigRuleDetailedStatusResponse -> String -- List (String, String)
...
getResourceConfigHistoryResponseToString : GetResourceConfigHistoryResponse -> String -- List (String, String)
...
groupedResourceCountToString : GroupedResourceCount -> String -- List (String, String)
...
listAggregateDiscoveredResourcesResponseToString : ListAggregateDiscoveredResourcesResponse -> String -- List (String, String)
...
listDiscoveredResourcesResponseToString : ListDiscoveredResourcesResponse -> String -- List (String, String)
...
memberAccountStatusToString : MemberAccountStatus -> String -- List (String, String)
...
organizationAggregationSourceToString : OrganizationAggregationSource -> String -- List (String, String)
...
organizationConfigRuleToString : OrganizationConfigRule -> String -- List (String, String)
...
organizationConfigRuleStatusToString : OrganizationConfigRuleStatus -> String -- List (String, String)
...
organizationCustomRuleMetadataToString : OrganizationCustomRuleMetadata -> String -- List (String, String)
...
organizationManagedRuleMetadataToString : OrganizationManagedRuleMetadata -> String -- List (String, String)
...
pendingAggregationRequestToString : PendingAggregationRequest -> String -- List (String, String)
...
putAggregationAuthorizationResponseToString : PutAggregationAuthorizationResponse -> String -- List (String, String)
...
putConfigurationAggregatorResponseToString : PutConfigurationAggregatorResponse -> String -- List (String, String)
...
putEvaluationsResponseToString : PutEvaluationsResponse -> String -- List (String, String)
...
putOrganizationConfigRuleResponseToString : PutOrganizationConfigRuleResponse -> String -- List (String, String)
...
putRemediationConfigurationsResponseToString : PutRemediationConfigurationsResponse -> String -- List (String, String)
...
putRetentionConfigurationResponseToString : PutRetentionConfigurationResponse -> String -- List (String, String)
...
recordingGroupToString : RecordingGroup -> String -- List (String, String)
...
relationshipToString : Relationship -> String -- List (String, String)
...
remediationConfigurationToString : RemediationConfiguration -> String -- List (String, String)
...
remediationExecutionStatusToString : RemediationExecutionStatus -> String -- List (String, String)
...
remediationExecutionStepToString : RemediationExecutionStep -> String -- List (String, String)
...
remediationParameterValueToString : RemediationParameterValue -> String -- List (String, String)
...
resourceCountToString : ResourceCount -> String -- List (String, String)
...
resourceCountFiltersToString : ResourceCountFilters -> String -- List (String, String)
...
resourceFiltersToString : ResourceFilters -> String -- List (String, String)
...
resourceIdentifierToString : ResourceIdentifier -> String -- List (String, String)
...
resourceKeyToString : ResourceKey -> String -- List (String, String)
...
resourceValueToString : ResourceValue -> String -- List (String, String)
...
retentionConfigurationToString : RetentionConfiguration -> String -- List (String, String)
...
selectResourceConfigResponseToString : SelectResourceConfigResponse -> String -- List (String, String)
...
sourceDetailToString : SourceDetail -> String -- List (String, String)
...
startConfigRulesEvaluationResponseToString : StartConfigRulesEvaluationResponse -> String -- List (String, String)
...
startRemediationExecutionResponseToString : StartRemediationExecutionResponse -> String -- List (String, String)
...
staticValueToString : StaticValue -> String -- List (String, String)
...
statusDetailFiltersToString : StatusDetailFilters -> String -- List (String, String)
...
remediationConfigurationEncoder data =
    []
        ...
        |> AWS.Core.Encode.optionalMember
            (JE.dict identity (remediationParameterValueEncoder))
