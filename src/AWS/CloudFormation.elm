...
cancelUpdateStack stackName setOptions =
    let
        ...
        options =
            setOptions (CancelUpdateStackOptions Nothing)
    in
...
continueUpdateRollback stackName setOptions =
    let
        ...
        options =
            setOptions (ContinueUpdateRollbackOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createChangeSet stackName changeSetName setOptions =
    let
        ...
        options =
            setOptions (CreateChangeSetOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createStack stackName setOptions =
    let
        ...
        options =
            setOptions (CreateStackOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createStackInstances stackSetName accounts regions setOptions =
    let
        ...
        options =
            setOptions (CreateStackInstancesOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createStackSet stackSetName setOptions =
    let
        ...
        options =
            setOptions (CreateStackSetOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
deleteChangeSet changeSetName setOptions =
    let
        ...
        options =
            setOptions (DeleteChangeSetOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
deleteStack stackName setOptions =
    let
        ...
        options =
            setOptions (DeleteStackOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
deleteStackInstances stackSetName accounts regions retainStacks setOptions =
    let
        ...
        options =
            setOptions (DeleteStackInstancesOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeAccountLimits setOptions =
    let
        ...
        options =
            setOptions (DescribeAccountLimitsOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeChangeSet changeSetName setOptions =
    let
        ...
        options =
            setOptions (DescribeChangeSetOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeStackEvents setOptions =
    let
        ...
        options =
            setOptions (DescribeStackEventsOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeStackResourceDrifts stackName setOptions =
    let
        ...
        options =
            setOptions (DescribeStackResourceDriftsOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeStackResources setOptions =
    let
        ...
        options =
            setOptions (DescribeStackResourcesOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeStacks setOptions =
    let
        ...
        options =
            setOptions (DescribeStacksOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
detectStackDrift stackName setOptions =
    let
        ...
        options =
            setOptions (DetectStackDriftOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
estimateTemplateCost setOptions =
    let
        ...
        options =
            setOptions (EstimateTemplateCostOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
executeChangeSet changeSetName setOptions =
    let
        ...
        options =
            setOptions (ExecuteChangeSetOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
getTemplate setOptions =
    let
        ...
        options =
            setOptions (GetTemplateOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
getTemplateSummary setOptions =
    let
        ...
        options =
            setOptions (GetTemplateSummaryOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listChangeSets stackName setOptions =
    let
        ...
        options =
            setOptions (ListChangeSetsOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listExports setOptions =
    let
        ...
        options =
            setOptions (ListExportsOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listImports exportName setOptions =
    let
        ...
        options =
            setOptions (ListImportsOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listStackInstances stackSetName setOptions =
    let
        ...
        options =
            setOptions (ListStackInstancesOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listStackResources stackName setOptions =
    let
        ...
        options =
            setOptions (ListStackResourcesOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listStackSetOperationResults stackSetName operationId setOptions =
    let
        ...
        options =
            setOptions (ListStackSetOperationResultsOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listStackSetOperations stackSetName setOptions =
    let
        ...
        options =
            setOptions (ListStackSetOperationsOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listStackSets setOptions =
    let
        ...
        options =
            setOptions (ListStackSetsOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listStacks setOptions =
    let
        ...
        options =
            setOptions (ListStacksOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
setStackPolicy stackName setOptions =
    let
        ...
        options =
            setOptions (SetStackPolicyOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
updateStack stackName setOptions =
    let
        ...
        options =
            setOptions (UpdateStackOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
updateStackInstances stackSetName accounts regions setOptions =
    let
        ...
        options =
            setOptions (UpdateStackInstancesOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
updateStackSet stackSetName setOptions =
    let
        ...
        options =
            setOptions (UpdateStackSetOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
validateTemplate setOptions =
    let
        ...
        options =
            setOptions (ValidateTemplateOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
