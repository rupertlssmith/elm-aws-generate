module AWS.DAX
    exposing
        ...
        , CreateParameterGroupOptions
        , createSubnetGroup
        , CreateSubnetGroupOptions
        , decreaseReplicationFactor
        , DecreaseReplicationFactorOptions
        , deleteCluster
        ...
        , DescribeDefaultParametersOptions
        , describeEvents
        , DescribeEventsOptions
        , describeParameterGroups
        , DescribeParameterGroupsOptions
        , describeParameters
        , DescribeParametersOptions
        , describeSubnetGroups
        , DescribeSubnetGroupsOptions
        , increaseReplicationFactor
        , IncreaseReplicationFactorOptions
        , listTags
        , ListTagsOptions
        , rebootNode
        , tagResource
...
* `clusterName` __:__ `String`
* `nodeType` __:__ `String`
* `replicationFactor` __:__ `Int`
...
createCluster clusterName nodeType replicationFactor iamRoleArn setOptions =
    ...
    let
        ...
        options = setOptions (CreateClusterOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
...
type alias CreateClusterOptions =
    {
    description : Maybe String,availabilityZones : Maybe (List String),subnetGroupName : Maybe String,securityGroupIds : Maybe (List String),preferredMaintenanceWindow : Maybe String,notificationTopicArn : Maybe String,parameterGroupName : Maybe String,tags : Maybe (List Tag),sSESpecification : Maybe SSESpecification
    }
...
createParameterGroup parameterGroupName setOptions =
    ...
    let
        requestInput = CreateParameterGroupRequest
        ...
        options = setOptions (CreateParameterGroupOptions Nothing)
...
createSubnetGroup subnetGroupName subnetIds setOptions =
    ...
    let
        requestInput = CreateSubnetGroupRequest
        ...
        options = setOptions (CreateSubnetGroupOptions Nothing)
...
* `clusterName` __:__ `String`
* `newReplicationFactor` __:__ `Int`
...
decreaseReplicationFactor clusterName newReplicationFactor setOptions =
    ...
    let
        requestInput = DecreaseReplicationFactorRequest
        ...
        options = setOptions (DecreaseReplicationFactorOptions Nothing Nothing)
...
type alias DecreaseReplicationFactorOptions =
    {
    availabilityZones : Maybe (List String),nodeIdsToRemove : Maybe (List String)
    }
...
deleteParameterGroup parameterGroupName =
    ...
    let
        requestInput = DeleteParameterGroupRequest
...
deleteSubnetGroup subnetGroupName =
    ...
    let
        requestInput = DeleteSubnetGroupRequest
...
type alias DescribeClustersOptions =
    {
    clusterNames : Maybe (List String),maxResults : Maybe Int,nextToken : Maybe String
    }
...
describeDefaultParameters setOptions =
    ...
    let
        requestInput = DescribeDefaultParametersRequest
        ...
        options = setOptions (DescribeDefaultParametersOptions Nothing Nothing)
...
type alias DescribeEventsOptions =
    {
    sourceName : Maybe String,sourceType : Maybe SourceType,startTime : Maybe Posix,endTime : Maybe Posix,duration : Maybe Int,maxResults : Maybe Int,nextToken : Maybe String
    }
...
describeParameterGroups setOptions =
    ...
    let
        requestInput = DescribeParameterGroupsRequest
        ...
        options = setOptions (DescribeParameterGroupsOptions Nothing Nothing Nothing)
...
type alias DescribeParameterGroupsOptions =
    {
    parameterGroupNames : Maybe (List String),maxResults : Maybe Int,nextToken : Maybe String
    }
...
describeParameters parameterGroupName setOptions =
    ...
    let
        requestInput = DescribeParametersRequest
...
type alias DescribeParametersOptions =
    {
    source : Maybe String,maxResults : Maybe Int,nextToken : Maybe String
    }
...
describeSubnetGroups setOptions =
    ...
    let
        requestInput = DescribeSubnetGroupsRequest
        ...
        options = setOptions (DescribeSubnetGroupsOptions Nothing Nothing Nothing)
...
type alias DescribeSubnetGroupsOptions =
    {
    subnetGroupNames : Maybe (List String),maxResults : Maybe Int,nextToken : Maybe String
    }
...
increaseReplicationFactor clusterName newReplicationFactor setOptions =
    ...
    let
        requestInput = IncreaseReplicationFactorRequest
        ...
        options = setOptions (IncreaseReplicationFactorOptions Nothing)
...
rebootNode clusterName nodeId =
    ...
    let
        requestInput = RebootNodeRequest
...
type alias UpdateClusterOptions =
    {
    description : Maybe String,preferredMaintenanceWindow : Maybe String,notificationTopicArn : Maybe String,notificationTopicStatus : Maybe String,parameterGroupName : Maybe String,securityGroupIds : Maybe (List String)
    }
...
updateParameterGroup parameterGroupName parameterNameValues =
    ...
    let
        requestInput = UpdateParameterGroupRequest
...
updateSubnetGroup subnetGroupName setOptions =
    ...
    let
        requestInput = UpdateSubnetGroupRequest
        ...
        options = setOptions (UpdateSubnetGroupOptions Nothing Nothing)
...
type alias UpdateSubnetGroupOptions =
    {
    description : Maybe String,subnetIds : Maybe (List String)
    }
...
clusterToString val =
    ...
    --     |> Dict.insert
    --         "clusterArn" "" -- val.clusterArn
        
    --     |> Dict.insert
    --         "totalNodes" "" -- val.totalNodes
        
    --     |> Dict.insert
    --         "activeNodes" "" -- val.activeNodes
    ...
    --     |> Dict.insert
    --         "clusterDiscoveryEndpoint" "" -- val.clusterDiscoveryEndpoint
        
    --     |> Dict.insert
    --         "nodeIdsToRemove" "" -- val.nodeIdsToRemove
    ...
    --     |> Dict.insert
    --         "sSEDescription" "" -- val.sSEDescription
...
createParameterGroupResponseToString : CreateParameterGroupResponse -> String -- List (String, String)
createParameterGroupResponseToString val =
    -- Dict.empty
...
createSubnetGroupResponseToString : CreateSubnetGroupResponse -> String -- List (String, String)
createSubnetGroupResponseToString val =
    -- Dict.empty
...
decreaseReplicationFactorResponseToString : DecreaseReplicationFactorResponse -> String -- List (String, String)
decreaseReplicationFactorResponseToString val =
    -- Dict.empty
...
deleteParameterGroupResponseToString : DeleteParameterGroupResponse -> String -- List (String, String)
deleteParameterGroupResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "deletionMessage" "" -- val.deletionMessage
...
deleteSubnetGroupResponseToString : DeleteSubnetGroupResponse -> String -- List (String, String)
deleteSubnetGroupResponseToString val =
    -- Dict.empty
...
describeDefaultParametersResponseToString : DescribeDefaultParametersResponse -> String -- List (String, String)
describeDefaultParametersResponseToString val =
    -- Dict.empty
...
describeParameterGroupsResponseToString : DescribeParameterGroupsResponse -> String -- List (String, String)
describeParameterGroupsResponseToString val =
    -- Dict.empty
...
describeParametersResponseToString : DescribeParametersResponse -> String -- List (String, String)
describeParametersResponseToString val =
    -- Dict.empty
...
describeSubnetGroupsResponseToString : DescribeSubnetGroupsResponse -> String -- List (String, String)
describeSubnetGroupsResponseToString val =
    -- Dict.empty
...
increaseReplicationFactorResponseToString : IncreaseReplicationFactorResponse -> String -- List (String, String)
increaseReplicationFactorResponseToString val =
    -- Dict.empty
...
nodeToString val =
    ...
    --     |> Dict.insert
    --         "nodeCreateTime" "" -- val.nodeCreateTime
...
nodeTypeSpecificValueToString : NodeTypeSpecificValue -> String -- List (String, String)
nodeTypeSpecificValueToString val =
    -- Dict.empty
...
parameterToString val =
    ...
    --     |> Dict.insert
    --         "nodeTypeSpecificValues" "" -- val.nodeTypeSpecificValues
...
parameterGroupToString : ParameterGroup -> String -- List (String, String)
parameterGroupToString val =
    -- Dict.empty
...
parameterGroupStatusToString : ParameterGroupStatus -> String -- List (String, String)
parameterGroupStatusToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "nodeIdsToReboot" "" -- val.nodeIdsToReboot
...
rebootNodeResponseToString : RebootNodeResponse -> String -- List (String, String)
rebootNodeResponseToString val =
    -- Dict.empty
...
sSEDescriptionToString : SSEDescription -> String -- List (String, String)
sSEDescriptionToString val =
    -- Dict.empty
...
sSESpecificationToString : SSESpecification -> String -- List (String, String)
sSESpecificationToString val =
    -- Dict.empty
...
securityGroupMembershipToString val =
    ...
    --     |> Dict.insert
    --         "securityGroupIdentifier" "" -- val.securityGroupIdentifier
...
subnetGroupToString : SubnetGroup -> String -- List (String, String)
subnetGroupToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "subnetGroupName" "" -- val.subnetGroupName
...
updateClusterResponseToString : UpdateClusterResponse -> String -- List (String, String)
updateClusterResponseToString val =
    -- Dict.empty
...
updateParameterGroupResponseToString : UpdateParameterGroupResponse -> String -- List (String, String)
updateParameterGroupResponseToString val =
    -- Dict.empty
...
updateSubnetGroupResponseToString : UpdateSubnetGroupResponse -> String -- List (String, String)
updateSubnetGroupResponseToString val =
    -- Dict.empty
