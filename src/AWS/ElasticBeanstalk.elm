...
abortEnvironmentUpdate setOptions =
    let
        ...
        options =
            setOptions (AbortEnvironmentUpdateOptions Nothing Nothing)
    in
...
applyEnvironmentManagedAction actionId setOptions =
    let
        ...
        options =
            setOptions (ApplyEnvironmentManagedActionOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
composeEnvironments setOptions =
    let
        ...
        options =
            setOptions (ComposeEnvironmentsOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createApplication applicationName setOptions =
    let
        ...
        options =
            setOptions (CreateApplicationOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createApplicationVersion applicationName versionLabel setOptions =
    let
        ...
        options =
            setOptions (CreateApplicationVersionOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createConfigurationTemplate applicationName templateName setOptions =
    let
        ...
        options =
            setOptions (CreateConfigurationTemplateOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createEnvironment applicationName setOptions =
    let
        ...
        options =
            setOptions (CreateEnvironmentOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createPlatformVersion platformName platformVersion platformDefinitionBundle setOptions =
    let
        ...
        options =
            setOptions (CreatePlatformVersionOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
-}
createStorageLocation : AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper CreateStorageLocationResultMessage)
...
deleteApplication applicationName setOptions =
    let
        ...
        options =
            setOptions (DeleteApplicationOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
deleteApplicationVersion applicationName versionLabel setOptions =
    let
        ...
        options =
            setOptions (DeleteApplicationVersionOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
deletePlatformVersion setOptions =
    let
        ...
        options =
            setOptions (DeletePlatformVersionOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
-}
describeAccountAttributes : AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper DescribeAccountAttributesResult)
describeAccountAttributes =
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeApplicationVersions setOptions =
    let
        ...
        options =
            setOptions (DescribeApplicationVersionsOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeApplications setOptions =
    let
        ...
        options =
            setOptions (DescribeApplicationsOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeConfigurationOptions setOptions =
    let
        ...
        options =
            setOptions (DescribeConfigurationOptionsOptions Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeConfigurationSettings applicationName setOptions =
    let
        ...
        options =
            setOptions (DescribeConfigurationSettingsOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeEnvironmentHealth setOptions =
    let
        ...
        options =
            setOptions (DescribeEnvironmentHealthOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeEnvironmentManagedActionHistory setOptions =
    let
        ...
        options =
            setOptions (DescribeEnvironmentManagedActionHistoryOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeEnvironmentManagedActions setOptions =
    let
        ...
        options =
            setOptions (DescribeEnvironmentManagedActionsOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeEnvironmentResources setOptions =
    let
        ...
        options =
            setOptions (DescribeEnvironmentResourcesOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeEnvironments setOptions =
    let
        ...
        options =
            setOptions (DescribeEnvironmentsOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeEvents setOptions =
    let
        ...
        options =
            setOptions (DescribeEventsOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeInstancesHealth setOptions =
    let
        ...
        options =
            setOptions (DescribeInstancesHealthOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describePlatformVersion setOptions =
    let
        ...
        options =
            setOptions (DescribePlatformVersionOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
-}
listAvailableSolutionStacks : AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper ListAvailableSolutionStacksResultMessage)
...
listPlatformVersions setOptions =
    let
        ...
        options =
            setOptions (ListPlatformVersionsOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
rebuildEnvironment setOptions =
    let
        ...
        options =
            setOptions (RebuildEnvironmentOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
requestEnvironmentInfo infoType setOptions =
    let
        ...
        options =
            setOptions (RequestEnvironmentInfoOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
restartAppServer setOptions =
    let
        ...
        options =
            setOptions (RestartAppServerOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
retrieveEnvironmentInfo infoType setOptions =
    let
        ...
        options =
            setOptions (RetrieveEnvironmentInfoOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
swapEnvironmentCNAMEs setOptions =
    let
        ...
        options =
            setOptions (SwapEnvironmentCNAMEsOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
terminateEnvironment setOptions =
    let
        ...
        options =
            setOptions (TerminateEnvironmentOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
updateApplication applicationName setOptions =
    let
        ...
        options =
            setOptions (UpdateApplicationOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
updateApplicationVersion applicationName versionLabel setOptions =
    let
        ...
        options =
            setOptions (UpdateApplicationVersionOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
updateConfigurationTemplate applicationName templateName setOptions =
    let
        ...
        options =
            setOptions (UpdateConfigurationTemplateOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
updateEnvironment setOptions =
    let
        ...
        options =
            setOptions (UpdateEnvironmentOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
updateTagsForResource resourceArn setOptions =
    let
        ...
        options =
            setOptions (UpdateTagsForResourceOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
validateConfigurationSettings applicationName optionSettings setOptions =
    let
        ...
        options =
            setOptions (ValidateConfigurationSettingsOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
