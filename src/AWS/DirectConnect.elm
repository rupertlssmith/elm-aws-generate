module AWS.DirectConnect exposing
    ( service
...
acceptDirectConnectGatewayAssociationProposal directConnectGatewayId proposalId associatedGatewayOwnerAccount setOptions =
    let
        ...
        options =
            setOptions (AcceptDirectConnectGatewayAssociationProposalOptions Nothing)
    in
...
allocateHostedConnection connectionId ownerAccount bandwidth connectionName vlan setOptions =
    let
        ...
        options =
            setOptions (AllocateHostedConnectionOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
confirmPrivateVirtualInterface virtualInterfaceId setOptions =
    let
        ...
        options =
            setOptions (ConfirmPrivateVirtualInterfaceOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createBGPPeer setOptions =
    let
        ...
        options =
            setOptions (CreateBGPPeerOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createConnection location bandwidth connectionName setOptions =
    let
        ...
        options =
            setOptions (CreateConnectionOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createDirectConnectGateway directConnectGatewayName setOptions =
    let
        ...
        options =
            setOptions (CreateDirectConnectGatewayOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createDirectConnectGatewayAssociation directConnectGatewayId setOptions =
    let
        ...
        options =
            setOptions (CreateDirectConnectGatewayAssociationOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createDirectConnectGatewayAssociationProposal directConnectGatewayId directConnectGatewayOwnerAccount gatewayId setOptions =
    let
        ...
        options =
            setOptions (CreateDirectConnectGatewayAssociationProposalOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createInterconnect interconnectName bandwidth location setOptions =
    let
        ...
        options =
            setOptions (CreateInterconnectOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createLag numberOfConnections location connectionsBandwidth lagName setOptions =
    let
        ...
        options =
            setOptions (CreateLagOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
deleteBGPPeer setOptions =
    let
        ...
        options =
            setOptions (DeleteBGPPeerOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
deleteDirectConnectGatewayAssociation setOptions =
    let
        ...
        options =
            setOptions (DeleteDirectConnectGatewayAssociationOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeConnectionLoa connectionId setOptions =
    let
        ...
        options =
            setOptions (DescribeConnectionLoaOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeConnections setOptions =
    let
        ...
        options =
            setOptions (DescribeConnectionsOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeDirectConnectGatewayAssociationProposals setOptions =
    let
        ...
        options =
            setOptions (DescribeDirectConnectGatewayAssociationProposalsOptions Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeDirectConnectGatewayAssociations setOptions =
    let
        ...
        options =
            setOptions (DescribeDirectConnectGatewayAssociationsOptions Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeDirectConnectGatewayAttachments setOptions =
    let
        ...
        options =
            setOptions (DescribeDirectConnectGatewayAttachmentsOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeDirectConnectGateways setOptions =
    let
        ...
        options =
            setOptions (DescribeDirectConnectGatewaysOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeInterconnectLoa interconnectId setOptions =
    let
        ...
        options =
            setOptions (DescribeInterconnectLoaOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeInterconnects setOptions =
    let
        ...
        options =
            setOptions (DescribeInterconnectsOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeLags setOptions =
    let
        ...
        options =
            setOptions (DescribeLagsOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeLoa connectionId setOptions =
    let
        ...
        options =
            setOptions (DescribeLoaOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
-}
describeLocations : AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper Locations)
describeLocations =
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
-}
describeVirtualGateways : AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper VirtualGateways)
...
describeVirtualInterfaces setOptions =
    let
        ...
        options =
            setOptions (DescribeVirtualInterfacesOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
updateDirectConnectGatewayAssociation setOptions =
    let
        ...
        options =
            setOptions (UpdateDirectConnectGatewayAssociationOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
updateLag lagId setOptions =
    let
        ...
        options =
            setOptions (UpdateLagOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
updateVirtualInterfaceAttributes virtualInterfaceId setOptions =
    let
        ...
        options =
            setOptions (UpdateVirtualInterfaceAttributesOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
