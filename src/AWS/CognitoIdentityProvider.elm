module AWS.CognitoIdentityProvider exposing
    ...
    , AccountTakeoverEventActionType(..), AdvancedSecurityModeType(..), AliasAttributeType(..), AttributeDataType(..), AuthFlowType(..), ChallengeName(..), ChallengeNameType(..), ChallengeResponse(..), CompromisedCredentialsEventActionType(..), DefaultEmailOptionType(..), DeliveryMediumType(..), DeviceRememberedStatusType(..), DomainStatusType(..), EmailSendingAccountType(..), EventFilterType(..), EventResponseType(..), EventType(..), ExplicitAuthFlowsType(..), FeedbackValueType(..), IdentityProviderTypeType(..), MessageActionType(..), OAuthFlowType(..), RiskDecisionType(..), RiskLevelType(..), StatusType(..), UserImportJobStatusType(..), UserPoolMfaType(..), UserStatusType(..), UsernameAttributeType(..), VerifiedAttributeType(..), VerifySoftwareTokenResponseType(..)
    )
...
adminCreateUser userPoolId username setOptions =
    let
        ...
        options =
            setOptions (AdminCreateUserOptions Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
adminInitiateAuth userPoolId clientId authFlow setOptions =
    let
        ...
        options =
            setOptions (AdminInitiateAuthOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
adminListDevices userPoolId username setOptions =
    let
        ...
        options =
            setOptions (AdminListDevicesOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
adminListGroupsForUser username userPoolId setOptions =
    let
        ...
        options =
            setOptions (AdminListGroupsForUserOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
adminListUserAuthEvents userPoolId username setOptions =
    let
        ...
        options =
            setOptions (AdminListUserAuthEventsOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
adminRespondToAuthChallenge userPoolId clientId challengeName setOptions =
    let
        ...
        options =
            setOptions (AdminRespondToAuthChallengeOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
adminSetUserMFAPreference username userPoolId setOptions =
    let
        ...
        options =
            setOptions (AdminSetUserMFAPreferenceOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
adminSetUserPassword userPoolId username password setOptions =
    let
        ...
        options =
            setOptions (AdminSetUserPasswordOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
adminUpdateDeviceStatus userPoolId username deviceKey setOptions =
    let
        ...
        options =
            setOptions (AdminUpdateDeviceStatusOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
associateSoftwareToken setOptions =
    let
        ...
        options =
            setOptions (AssociateSoftwareTokenOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
confirmDevice accessToken deviceKey setOptions =
    let
        ...
        options =
            setOptions (ConfirmDeviceOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
confirmForgotPassword clientId username confirmationCode password setOptions =
    let
        ...
        options =
            setOptions (ConfirmForgotPasswordOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
confirmSignUp clientId username confirmationCode setOptions =
    let
        ...
        options =
            setOptions (ConfirmSignUpOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createGroup groupName userPoolId setOptions =
    let
        ...
        options =
            setOptions (CreateGroupOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createIdentityProvider userPoolId providerName providerType providerDetails setOptions =
    let
        ...
        options =
            setOptions (CreateIdentityProviderOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createResourceServer userPoolId identifier name setOptions =
    let
        ...
        options =
            setOptions (CreateResourceServerOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createUserPool poolName setOptions =
    let
        ...
        options =
            setOptions (CreateUserPoolOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createUserPoolClient userPoolId clientName setOptions =
    let
        ...
        options =
            setOptions (CreateUserPoolClientOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createUserPoolDomain domain userPoolId setOptions =
    let
        ...
        options =
            setOptions (CreateUserPoolDomainOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeRiskConfiguration userPoolId setOptions =
    let
        ...
        options =
            setOptions (DescribeRiskConfigurationOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
forgetDevice deviceKey setOptions =
    let
        ...
        options =
            setOptions (ForgetDeviceOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
forgotPassword clientId username setOptions =
    let
        ...
        options =
            setOptions (ForgotPasswordOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
getDevice deviceKey setOptions =
    let
        ...
        options =
            setOptions (GetDeviceOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
getUICustomization userPoolId setOptions =
    let
        ...
        options =
            setOptions (GetUICustomizationOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
initiateAuth authFlow clientId setOptions =
    let
        ...
        options =
            setOptions (InitiateAuthOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listDevices accessToken setOptions =
    let
        ...
        options =
            setOptions (ListDevicesOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listGroups userPoolId setOptions =
    let
        ...
        options =
            setOptions (ListGroupsOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listIdentityProviders userPoolId setOptions =
    let
        ...
        options =
            setOptions (ListIdentityProvidersOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listResourceServers userPoolId setOptions =
    let
        ...
        options =
            setOptions (ListResourceServersOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listUserImportJobs userPoolId maxResults setOptions =
    let
        ...
        options =
            setOptions (ListUserImportJobsOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listUserPoolClients userPoolId setOptions =
    let
        ...
        options =
            setOptions (ListUserPoolClientsOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listUserPools maxResults setOptions =
    let
        ...
        options =
            setOptions (ListUserPoolsOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listUsers userPoolId setOptions =
    let
        ...
        options =
            setOptions (ListUsersOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listUsersInGroup userPoolId groupName setOptions =
    let
        ...
        options =
            setOptions (ListUsersInGroupOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
resendConfirmationCode clientId username setOptions =
    let
        ...
        options =
            setOptions (ResendConfirmationCodeOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
respondToAuthChallenge clientId challengeName setOptions =
    let
        ...
        options =
            setOptions (RespondToAuthChallengeOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
setRiskConfiguration userPoolId setOptions =
    let
        ...
        options =
            setOptions (SetRiskConfigurationOptions Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
setUICustomization userPoolId setOptions =
    let
        ...
        options =
            setOptions (SetUICustomizationOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
setUserMFAPreference accessToken setOptions =
    let
        ...
        options =
            setOptions (SetUserMFAPreferenceOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
setUserPoolMfaConfig userPoolId setOptions =
    let
        ...
        options =
            setOptions (SetUserPoolMfaConfigOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
signUp clientId username password setOptions =
    let
        ...
        options =
            setOptions (SignUpOptions Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
updateDeviceStatus accessToken deviceKey setOptions =
    let
        ...
        options =
            setOptions (UpdateDeviceStatusOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
updateGroup groupName userPoolId setOptions =
    let
        ...
        options =
            setOptions (UpdateGroupOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
updateIdentityProvider userPoolId providerName setOptions =
    let
        ...
        options =
            setOptions (UpdateIdentityProviderOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
updateResourceServer userPoolId identifier name setOptions =
    let
        ...
        options =
            setOptions (UpdateResourceServerOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
updateUserPool userPoolId setOptions =
    let
        ...
        options =
            setOptions (UpdateUserPoolOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
updateUserPoolClient userPoolId clientId setOptions =
    let
        ...
        options =
            setOptions (UpdateUserPoolClientOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
verifySoftwareToken userCode setOptions =
    let
        ...
        options =
            setOptions (VerifySoftwareTokenOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
accountTakeoverActionTypeToString :
    AccountTakeoverActionType
...
accountTakeoverActionsTypeToString :
    AccountTakeoverActionsType
    -> String -- List (String, String)
...
accountTakeoverRiskConfigurationTypeToString :
    AccountTakeoverRiskConfigurationType
    -> String -- List (String, String)
...
addCustomAttributesResponseToString :
...
adminConfirmSignUpResponseToString :
...
adminCreateUserConfigTypeToString :
...
adminCreateUserResponseToString :
    AdminCreateUserResponse
    -> String -- List (String, String)
...
adminDeleteUserAttributesResponseToString :
...
adminDisableProviderForUserResponseToString :
...
adminDisableUserResponseToString :
...
adminEnableUserResponseToString :
...
adminGetDeviceResponseToString :
...
adminInitiateAuthResponseToString :
...
adminLinkProviderForUserResponseToString :
...
adminListDevicesResponseToString :
...
adminListGroupsForUserResponseToString :
...
adminListUserAuthEventsResponseToString :
...
adminResetUserPasswordResponseToString :
...
adminRespondToAuthChallengeResponseToString :
...
adminSetUserMFAPreferenceResponseToString :
...
adminSetUserPasswordResponseToString :
...
adminSetUserSettingsResponseToString :
...
adminUpdateAuthEventFeedbackResponseToString :
...
adminUpdateDeviceStatusResponseToString :
...
adminUpdateUserAttributesResponseToString :
...
adminUserGlobalSignOutResponseToString :
...
analyticsConfigurationTypeToString :
...
associateSoftwareTokenResponseToString :
...
authenticationResultTypeToString :
...
changePasswordResponseToString :
...
codeDeliveryDetailsTypeToString :
...
compromisedCredentialsActionsTypeToString :
...
compromisedCredentialsRiskConfigurationTypeToString :
...
confirmForgotPasswordResponseToString :
...
createIdentityProviderResponseToString :
...
createResourceServerResponseToString :
...
createUserImportJobResponseToString :
...
createUserPoolClientResponseToString :
...
createUserPoolDomainResponseToString :
...
createUserPoolResponseToString :
...
customDomainConfigTypeToString :
    CustomDomainConfigType
    -> String -- List (String, String)
...
deleteUserAttributesResponseToString :
...
deleteUserPoolDomainResponseToString :
...
describeIdentityProviderResponseToString :
...
describeResourceServerResponseToString :
...
describeRiskConfigurationResponseToString :
...
describeUserImportJobResponseToString :
...
describeUserPoolClientResponseToString :
...
describeUserPoolDomainResponseToString :
...
describeUserPoolResponseToString :
...
deviceConfigurationTypeToString :
...
deviceSecretVerifierConfigTypeToString :
...
emailConfigurationTypeToString :
...
forgotPasswordResponseToString :
...
getIdentityProviderByIdentifierResponseToString :
...
getSigningCertificateResponseToString :
...
getUICustomizationResponseToString :
...
getUserAttributeVerificationCodeResponseToString :
...
getUserPoolMfaConfigResponseToString :
...
listIdentityProvidersResponseToString :
...
listResourceServersResponseToString :
...
listUserImportJobsResponseToString :
...
listUserPoolClientsResponseToString :
...
listUsersInGroupResponseToString :
...
notifyConfigurationTypeToString :
...
numberAttributeConstraintsTypeToString :
...
providerUserIdentifierTypeToString :
    ProviderUserIdentifierType
    -> String -- List (String, String)
...
resendConfirmationCodeResponseToString :
...
resourceServerScopeTypeToString :
...
respondToAuthChallengeResponseToString :
...
riskExceptionConfigurationTypeToString :
...
setRiskConfigurationResponseToString :
...
setUICustomizationResponseToString :
...
setUserMFAPreferenceResponseToString :
...
setUserPoolMfaConfigResponseToString :
...
setUserSettingsResponseToString :
...
softwareTokenMfaConfigTypeToString :
...
softwareTokenMfaSettingsTypeToString :
...
startUserImportJobResponseToString :
...
stopUserImportJobResponseToString :
...
stringAttributeConstraintsTypeToString :
...
updateAuthEventFeedbackResponseToString :
...
updateDeviceStatusResponseToString :
...
updateIdentityProviderResponseToString :
...
updateResourceServerResponseToString :
...
updateUserAttributesResponseToString :
...
updateUserPoolClientResponseToString :
...
updateUserPoolDomainResponseToString :
...
updateUserPoolResponseToString :
...
userPoolClientDescriptionToString :
...
userPoolDescriptionTypeToString :
...
verificationMessageTemplateTypeToString :
...
verifySoftwareTokenResponseToString :
...
verifyUserAttributeResponseToString :
    VerifyUserAttributeResponse
    -> String -- List (String, String)
