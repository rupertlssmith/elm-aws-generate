module AWS.DirectoryService
    exposing
        ...
        , DescribeDomainControllersOptions
        , describeEventTopics
        , DescribeEventTopicsOptions
        , describeSharedDirectories
        , DescribeSharedDirectoriesOptions
        , describeSnapshots
...
* `sharedDirectoryId` __:__ `String`
...
acceptSharedDirectory sharedDirectoryId =
    ...
    let
        requestInput = AcceptSharedDirectoryRequest
...
addIpRoutes directoryId ipRoutes setOptions =
    ...
    let
        requestInput = AddIpRoutesRequest
...
cancelSchemaExtension directoryId schemaExtensionId =
    ...
    let
        requestInput = CancelSchemaExtensionRequest
...
connectDirectory name password size connectSettings setOptions =
    ...
    let
        requestInput = ConnectDirectoryRequest
        ...
        options = setOptions (ConnectDirectoryOptions Nothing Nothing Nothing)
...
type alias ConnectDirectoryOptions =
    {
    shortName : Maybe String,description : Maybe String,tags : Maybe (List Tag)
    }
...
createComputer directoryId computerName password setOptions =
    ...
    let
        requestInput = CreateComputerRequest
...
type alias CreateComputerOptions =
    {
    organizationalUnitDistinguishedName : Maybe String,computerAttributes : Maybe (List Attribute)
    }
...
createConditionalForwarder directoryId remoteDomainName dnsIpAddrs =
    ...
    let
        requestInput = CreateConditionalForwarderRequest
...
createDirectory name password size setOptions =
    ...
    let
        requestInput = CreateDirectoryRequest
        ...
        options = setOptions (CreateDirectoryOptions Nothing Nothing Nothing Nothing)
...
type alias CreateDirectoryOptions =
    {
    shortName : Maybe String,description : Maybe String,vpcSettings : Maybe DirectoryVpcSettings,tags : Maybe (List Tag)
    }
...
createLogSubscription directoryId logGroupName =
    ...
    let
        requestInput = CreateLogSubscriptionRequest
...
createMicrosoftAD name password vpcSettings setOptions =
    ...
    let
        requestInput = CreateMicrosoftADRequest
        ...
        options = setOptions (CreateMicrosoftADOptions Nothing Nothing Nothing Nothing)
...
type alias CreateMicrosoftADOptions =
    {
    shortName : Maybe String,description : Maybe String,edition : Maybe DirectoryEdition,tags : Maybe (List Tag)
    }
...
createSnapshot directoryId setOptions =
    ...
    let
        requestInput = CreateSnapshotRequest
...
createTrust directoryId remoteDomainName trustPassword trustDirection setOptions =
    ...
    let
        requestInput = CreateTrustRequest
        ...
        options = setOptions (CreateTrustOptions Nothing Nothing Nothing)
...
type alias CreateTrustOptions =
    {
    trustType : Maybe TrustType,conditionalForwarderIpAddrs : Maybe (List String),selectiveAuth : Maybe SelectiveAuth
    }
...
deleteConditionalForwarder directoryId remoteDomainName =
    ...
    let
        requestInput = DeleteConditionalForwarderRequest
...
deleteDirectory directoryId =
    ...
    let
        requestInput = DeleteDirectoryRequest
...
deleteLogSubscription directoryId =
    ...
    let
        requestInput = DeleteLogSubscriptionRequest
...
deleteSnapshot snapshotId =
    ...
    let
        requestInput = DeleteSnapshotRequest
...
deleteTrust trustId setOptions =
    ...
    let
        requestInput = DeleteTrustRequest
...
deregisterEventTopic directoryId topicName =
    ...
    let
        requestInput = DeregisterEventTopicRequest
...
describeConditionalForwarders directoryId setOptions =
    ...
    let
        requestInput = DescribeConditionalForwardersRequest
...
describeDirectories setOptions =
    ...
    let
        requestInput = DescribeDirectoriesRequest
...
type alias DescribeDirectoriesOptions =
    {
    directoryIds : Maybe (List String),nextToken : Maybe String,limit : Maybe Int
    }
...
describeDomainControllers directoryId setOptions =
    ...
    let
        requestInput = DescribeDomainControllersRequest
        ...
        options = setOptions (DescribeDomainControllersOptions Nothing Nothing Nothing)
...
type alias DescribeDomainControllersOptions =
    {
    domainControllerIds : Maybe (List String),nextToken : Maybe String,limit : Maybe Int
    }
...
describeEventTopics setOptions =
    ...
    let
        requestInput = DescribeEventTopicsRequest
...
type alias DescribeEventTopicsOptions =
    {
    directoryId : Maybe String,topicNames : Maybe (List String)
    }
...
describeSharedDirectories ownerDirectoryId setOptions =
    ...
    let
        requestInput = DescribeSharedDirectoriesRequest
        ...
        options = setOptions (DescribeSharedDirectoriesOptions Nothing Nothing Nothing)
...
type alias DescribeSharedDirectoriesOptions =
    {
    sharedDirectoryIds : Maybe (List String),nextToken : Maybe String,limit : Maybe Int
    }
...
describeSnapshots setOptions =
    ...
    let
        requestInput = DescribeSnapshotsRequest
...
type alias DescribeSnapshotsOptions =
    {
    directoryId : Maybe String,snapshotIds : Maybe (List String),nextToken : Maybe String,limit : Maybe Int
    }
...
describeTrusts setOptions =
    ...
    let
        requestInput = DescribeTrustsRequest
...
type alias DescribeTrustsOptions =
    {
    directoryId : Maybe String,trustIds : Maybe (List String),nextToken : Maybe String,limit : Maybe Int
    }
...
disableRadius directoryId =
    ...
    let
        requestInput = DisableRadiusRequest
...
disableSso directoryId setOptions =
    ...
    let
        requestInput = DisableSsoRequest
...
type alias DisableSsoOptions =
    {
    userName : Maybe String,password : Maybe String
    }
...
enableRadius directoryId radiusSettings =
    ...
    let
        requestInput = EnableRadiusRequest
...
getDirectoryLimits :
    ...
    AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper GetDirectoryLimitsResult)

getDirectoryLimits =
    
    let
        requestInput = GetDirectoryLimitsRequest
...
getSnapshotLimits directoryId =
    ...
    let
        requestInput = GetSnapshotLimitsRequest
...
listIpRoutes directoryId setOptions =
    ...
    let
        requestInput = ListIpRoutesRequest
...
listLogSubscriptions setOptions =
    ...
    let
        requestInput = ListLogSubscriptionsRequest
        ...
        options = setOptions (ListLogSubscriptionsOptions Nothing Nothing Nothing)
...
type alias ListLogSubscriptionsOptions =
    {
    directoryId : Maybe String,nextToken : Maybe String,limit : Maybe Int
    }
...
listSchemaExtensions directoryId setOptions =
    ...
    let
        requestInput = ListSchemaExtensionsRequest
...
registerEventTopic directoryId topicName =
    ...
    let
        requestInput = RegisterEventTopicRequest
...
rejectSharedDirectory sharedDirectoryId =
    ...
    let
        requestInput = RejectSharedDirectoryRequest
...
removeIpRoutes directoryId cidrIps =
    ...
    let
        requestInput = RemoveIpRoutesRequest
...
resetUserPassword directoryId userName newPassword =
    ...
    let
        requestInput = ResetUserPasswordRequest
...
restoreFromSnapshot snapshotId =
    ...
    let
        requestInput = RestoreFromSnapshotRequest
...
* `directoryId` __:__ `String`
* `shareTarget` __:__ `ShareTarget`
* `shareMethod` __:__ `ShareMethod`
...
shareDirectory directoryId shareTarget shareMethod setOptions =
    ...
    let
        requestInput = ShareDirectoryRequest
        ...
        options = setOptions (ShareDirectoryOptions Nothing)
...
startSchemaExtension directoryId createSnapshotBeforeSchemaExtension ldifContent description =
    ...
    let
        requestInput = StartSchemaExtensionRequest
...
* `directoryId` __:__ `String`
* `unshareTarget` __:__ `UnshareTarget`
...
unshareDirectory directoryId unshareTarget =
    ...
    let
        requestInput = UnshareDirectoryRequest
...
updateConditionalForwarder directoryId remoteDomainName dnsIpAddrs =
    ...
    let
        requestInput = UpdateConditionalForwarderRequest
...
updateNumberOfDomainControllers directoryId desiredNumber =
    ...
    let
        requestInput = UpdateNumberOfDomainControllersRequest
...
updateRadius directoryId radiusSettings =
    ...
    let
        requestInput = UpdateRadiusRequest
...
updateTrust trustId setOptions =
    ...
    let
        requestInput = UpdateTrustRequest
        ...
        options = setOptions (UpdateTrustOptions Nothing)
...
verifyTrust trustId =
    ...
    let
        requestInput = VerifyTrustRequest
...
acceptSharedDirectoryResultToString : AcceptSharedDirectoryResult -> String -- List (String, String)
acceptSharedDirectoryResultToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "sharedDirectory" "" -- val.sharedDirectory
...
addIpRoutesResultToString : AddIpRoutesResult -> String -- List (String, String)
addIpRoutesResultToString val =
    -- Dict.empty
...
addTagsToResourceResultToString : AddTagsToResourceResult -> String -- List (String, String)
addTagsToResourceResultToString val =
    -- Dict.empty
...
cancelSchemaExtensionResultToString : CancelSchemaExtensionResult -> String -- List (String, String)
cancelSchemaExtensionResultToString val =
    -- Dict.empty
...
computerToString : Computer -> String -- List (String, String)
computerToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "computerAttributes" "" -- val.computerAttributes
...
conditionalForwarderToString : ConditionalForwarder -> String -- List (String, String)
conditionalForwarderToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "remoteDomainName" "" -- val.remoteDomainName
        
    --     |> Dict.insert
    --         "dnsIpAddrs" "" -- val.dnsIpAddrs
        
    --     |> Dict.insert
    --         "replicationScope" "" -- val.replicationScope
...
connectDirectoryResultToString : ConnectDirectoryResult -> String -- List (String, String)
connectDirectoryResultToString val =
    -- Dict.empty
...
createAliasResultToString : CreateAliasResult -> String -- List (String, String)
createAliasResultToString val =
    -- Dict.empty
...
createComputerResultToString : CreateComputerResult -> String -- List (String, String)
createComputerResultToString val =
    -- Dict.empty
...
createConditionalForwarderResultToString : CreateConditionalForwarderResult -> String -- List (String, String)
createConditionalForwarderResultToString val =
    -- Dict.empty
...
createDirectoryResultToString : CreateDirectoryResult -> String -- List (String, String)
createDirectoryResultToString val =
    -- Dict.empty
...
createLogSubscriptionResultToString : CreateLogSubscriptionResult -> String -- List (String, String)
createLogSubscriptionResultToString val =
    -- Dict.empty
...
createMicrosoftADResultToString : CreateMicrosoftADResult -> String -- List (String, String)
createMicrosoftADResultToString val =
    -- Dict.empty
...
createTrustResultToString : CreateTrustResult -> String -- List (String, String)
createTrustResultToString val =
    -- Dict.empty
...
deleteConditionalForwarderResultToString : DeleteConditionalForwarderResult -> String -- List (String, String)
deleteConditionalForwarderResultToString val =
    -- Dict.empty
...
deleteDirectoryResultToString : DeleteDirectoryResult -> String -- List (String, String)
deleteDirectoryResultToString val =
    -- Dict.empty
...
deleteLogSubscriptionResultToString : DeleteLogSubscriptionResult -> String -- List (String, String)
deleteLogSubscriptionResultToString val =
    -- Dict.empty
...
deleteTrustResultToString : DeleteTrustResult -> String -- List (String, String)
deleteTrustResultToString val =
    -- Dict.empty
...
deregisterEventTopicResultToString : DeregisterEventTopicResult -> String -- List (String, String)
deregisterEventTopicResultToString val =
    -- Dict.empty
...
describeConditionalForwardersResultToString : DescribeConditionalForwardersResult -> String -- List (String, String)
describeConditionalForwardersResultToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "conditionalForwarders" "" -- val.conditionalForwarders
...
describeDirectoriesResultToString : DescribeDirectoriesResult -> String -- List (String, String)
describeDirectoriesResultToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "directoryDescriptions" "" -- val.directoryDescriptions
...
describeDomainControllersResultToString : DescribeDomainControllersResult -> String -- List (String, String)
describeDomainControllersResultToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "domainControllers" "" -- val.domainControllers
...
describeEventTopicsResultToString : DescribeEventTopicsResult -> String -- List (String, String)
describeEventTopicsResultToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "eventTopics" "" -- val.eventTopics
...
describeSharedDirectoriesResultToString : DescribeSharedDirectoriesResult -> String -- List (String, String)
describeSharedDirectoriesResultToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "sharedDirectories" "" -- val.sharedDirectories
...
describeSnapshotsResultToString : DescribeSnapshotsResult -> String -- List (String, String)
describeSnapshotsResultToString val =
    -- Dict.empty
...
describeTrustsResultToString : DescribeTrustsResult -> String -- List (String, String)
describeTrustsResultToString val =
    -- Dict.empty
...
directoryConnectSettingsToString : DirectoryConnectSettings -> String -- List (String, String)
directoryConnectSettingsToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "customerDnsIps" "" -- val.customerDnsIps
...
directoryConnectSettingsDescriptionToString : DirectoryConnectSettingsDescription -> String -- List (String, String)
directoryConnectSettingsDescriptionToString val =
    -- Dict.empty
...
directoryDescriptionToString : DirectoryDescription -> String -- List (String, String)
directoryDescriptionToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "shareStatus" "" -- val.shareStatus
        
    --     |> Dict.insert
    --         "shareMethod" "" -- val.shareMethod
        
    --     |> Dict.insert
    --         "shareNotes" "" -- val.shareNotes
        
    --     |> Dict.insert
    --         "launchTime" "" -- val.launchTime
        
    --     |> Dict.insert
    --         "stageLastUpdatedDateTime" "" -- val.stageLastUpdatedDateTime
        
    --     |> Dict.insert
    --         "type_" "" -- val.type_
        
    --     |> Dict.insert
    --         "vpcSettings" "" -- val.vpcSettings
        
    --     |> Dict.insert
    --         "connectSettings" "" -- val.connectSettings
        
    --     |> Dict.insert
    --         "radiusSettings" "" -- val.radiusSettings
        
    --     |> Dict.insert
    --         "radiusStatus" "" -- val.radiusStatus
        
    --     |> Dict.insert
    --         "stageReason" "" -- val.stageReason
        
    --     |> Dict.insert
    --         "ssoEnabled" "" -- val.ssoEnabled
        
    --     |> Dict.insert
    --         "desiredNumberOfDomainControllers" "" -- val.desiredNumberOfDomainControllers
        
    --     |> Dict.insert
    --         "ownerDirectoryDescription" "" -- val.ownerDirectoryDescription
...
directoryLimitsToString : DirectoryLimits -> String -- List (String, String)
directoryLimitsToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "cloudOnlyDirectoriesLimit" "" -- val.cloudOnlyDirectoriesLimit
        
    --     |> Dict.insert
    --         "cloudOnlyDirectoriesCurrentCount" "" -- val.cloudOnlyDirectoriesCurrentCount
        
    --     |> Dict.insert
    --         "cloudOnlyDirectoriesLimitReached" "" -- val.cloudOnlyDirectoriesLimitReached
        
    --     |> Dict.insert
    --         "cloudOnlyMicrosoftADLimit" "" -- val.cloudOnlyMicrosoftADLimit
        
    --     |> Dict.insert
    --         "cloudOnlyMicrosoftADCurrentCount" "" -- val.cloudOnlyMicrosoftADCurrentCount
        
    --     |> Dict.insert
    --         "cloudOnlyMicrosoftADLimitReached" "" -- val.cloudOnlyMicrosoftADLimitReached
        
    --     |> Dict.insert
    --         "connectedDirectoriesLimit" "" -- val.connectedDirectoriesLimit
        
    --     |> Dict.insert
    --         "connectedDirectoriesCurrentCount" "" -- val.connectedDirectoriesCurrentCount
        
    --     |> Dict.insert
    --         "connectedDirectoriesLimitReached" "" -- val.connectedDirectoriesLimitReached
...
directoryVpcSettingsToString : DirectoryVpcSettings -> String -- List (String, String)
directoryVpcSettingsToString val =
    -- Dict.empty
...
directoryVpcSettingsDescriptionToString : DirectoryVpcSettingsDescription -> String -- List (String, String)
directoryVpcSettingsDescriptionToString val =
    -- Dict.empty
...
disableRadiusResultToString : DisableRadiusResult -> String -- List (String, String)
disableRadiusResultToString val =
    -- Dict.empty
...
disableSsoResultToString : DisableSsoResult -> String -- List (String, String)
disableSsoResultToString val =
    -- Dict.empty
...
domainControllerToString : DomainController -> String -- List (String, String)
domainControllerToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "domainControllerId" "" -- val.domainControllerId
        
    --     |> Dict.insert
    --         "dnsIpAddr" "" -- val.dnsIpAddr
    ...
    --     |> Dict.insert
    --         "statusLastUpdatedDateTime" "" -- val.statusLastUpdatedDateTime
...
enableRadiusResultToString : EnableRadiusResult -> String -- List (String, String)
enableRadiusResultToString val =
    -- Dict.empty
...
enableSsoResultToString : EnableSsoResult -> String -- List (String, String)
enableSsoResultToString val =
    -- Dict.empty
...
eventTopicToString : EventTopic -> String -- List (String, String)
eventTopicToString val =
    -- Dict.empty
...
getDirectoryLimitsResultToString : GetDirectoryLimitsResult -> String -- List (String, String)
getDirectoryLimitsResultToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "directoryLimits" "" -- val.directoryLimits
...
getSnapshotLimitsResultToString : GetSnapshotLimitsResult -> String -- List (String, String)
getSnapshotLimitsResultToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "snapshotLimits" "" -- val.snapshotLimits
...
ipRouteToString : IpRoute -> String -- List (String, String)
ipRouteToString val =
    -- Dict.empty
...
ipRouteInfoToString : IpRouteInfo -> String -- List (String, String)
ipRouteInfoToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "ipRouteStatusMsg" "" -- val.ipRouteStatusMsg
        
    --     |> Dict.insert
    --         "addedDateTime" "" -- val.addedDateTime
        
    --     |> Dict.insert
    --         "ipRouteStatusReason" "" -- val.ipRouteStatusReason
...
listIpRoutesResultToString : ListIpRoutesResult -> String -- List (String, String)
listIpRoutesResultToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "ipRoutesInfo" "" -- val.ipRoutesInfo
...
listLogSubscriptionsResultToString : ListLogSubscriptionsResult -> String -- List (String, String)
listLogSubscriptionsResultToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "logSubscriptions" "" -- val.logSubscriptions
...
listSchemaExtensionsResultToString : ListSchemaExtensionsResult -> String -- List (String, String)
listSchemaExtensionsResultToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "schemaExtensionsInfo" "" -- val.schemaExtensionsInfo
...
listTagsForResourceResultToString : ListTagsForResourceResult -> String -- List (String, String)
listTagsForResourceResultToString val =
    -- Dict.empty
...
logSubscriptionToString : LogSubscription -> String -- List (String, String)
logSubscriptionToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "subscriptionCreatedDateTime" "" -- val.subscriptionCreatedDateTime
...
ownerDirectoryDescriptionToString : OwnerDirectoryDescription -> String -- List (String, String)
ownerDirectoryDescriptionToString val =
    -- Dict.empty
...
radiusSettingsToString : RadiusSettings -> String -- List (String, String)
radiusSettingsToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "radiusServers" "" -- val.radiusServers
        
    --     |> Dict.insert
    --         "radiusPort" "" -- val.radiusPort
        
    --     |> Dict.insert
    --         "radiusTimeout" "" -- val.radiusTimeout
        
    --     |> Dict.insert
    --         "radiusRetries" "" -- val.radiusRetries
        
    --     |> Dict.insert
    --         "sharedSecret" "" -- val.sharedSecret
        
    --     |> Dict.insert
    --         "authenticationProtocol" "" -- val.authenticationProtocol
        
    --     |> Dict.insert
    --         "displayLabel" "" -- val.displayLabel
        
    --     |> Dict.insert
    --         "useSameUsername" "" -- val.useSameUsername
...
registerEventTopicResultToString : RegisterEventTopicResult -> String -- List (String, String)
registerEventTopicResultToString val =
    -- Dict.empty
...
rejectSharedDirectoryResultToString : RejectSharedDirectoryResult -> String -- List (String, String)
rejectSharedDirectoryResultToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "sharedDirectoryId" "" -- val.sharedDirectoryId
...
removeIpRoutesResultToString : RemoveIpRoutesResult -> String -- List (String, String)
removeIpRoutesResultToString val =
    -- Dict.empty
...
removeTagsFromResourceResultToString : RemoveTagsFromResourceResult -> String -- List (String, String)
removeTagsFromResourceResultToString val =
    -- Dict.empty
...
resetUserPasswordResultToString : ResetUserPasswordResult -> String -- List (String, String)
resetUserPasswordResultToString val =
    -- Dict.empty
...
restoreFromSnapshotResultToString : RestoreFromSnapshotResult -> String -- List (String, String)
restoreFromSnapshotResultToString val =
    -- Dict.empty
...
schemaExtensionInfoToString : SchemaExtensionInfo -> String -- List (String, String)
schemaExtensionInfoToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "schemaExtensionId" "" -- val.schemaExtensionId
        
    --     |> Dict.insert
    --         "description" "" -- val.description
        
    --     |> Dict.insert
    --         "schemaExtensionStatus" "" -- val.schemaExtensionStatus
        
    --     |> Dict.insert
    --         "schemaExtensionStatusReason" "" -- val.schemaExtensionStatusReason
...
shareDirectoryResultToString : ShareDirectoryResult -> String -- List (String, String)
shareDirectoryResultToString val =
    -- Dict.empty
...
shareTargetToString : ShareTarget -> String -- List (String, String)
shareTargetToString val =
    -- Dict.empty
...
sharedDirectoryToString : SharedDirectory -> String -- List (String, String)
sharedDirectoryToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "ownerAccountId" "" -- val.ownerAccountId
        
    --     |> Dict.insert
    --         "ownerDirectoryId" "" -- val.ownerDirectoryId
    ...
    --     |> Dict.insert
    --         "lastUpdatedDateTime" "" -- val.lastUpdatedDateTime
...
snapshotLimitsToString : SnapshotLimits -> String -- List (String, String)
snapshotLimitsToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "manualSnapshotsLimit" "" -- val.manualSnapshotsLimit
        
    --     |> Dict.insert
    --         "manualSnapshotsCurrentCount" "" -- val.manualSnapshotsCurrentCount
        
    --     |> Dict.insert
    --         "manualSnapshotsLimitReached" "" -- val.manualSnapshotsLimitReached
...
startSchemaExtensionResultToString : StartSchemaExtensionResult -> String -- List (String, String)
startSchemaExtensionResultToString val =
    -- Dict.empty
...
trustToString : Trust -> String -- List (String, String)
trustToString val =
    -- Dict.empty
    ...
    --     |> Dict.insert
    --         "trustDirection" "" -- val.trustDirection
        
    --     |> Dict.insert
    --         "trustState" "" -- val.trustState
    ...
    --     |> Dict.insert
    --         "stateLastUpdatedDateTime" "" -- val.stateLastUpdatedDateTime
        
    --     |> Dict.insert
    --         "trustStateReason" "" -- val.trustStateReason
        
    --     |> Dict.insert
    --         "selectiveAuth" "" -- val.selectiveAuth
...
unshareDirectoryResultToString : UnshareDirectoryResult -> String -- List (String, String)
unshareDirectoryResultToString val =
    -- Dict.empty
...
unshareTargetToString : UnshareTarget -> String -- List (String, String)
unshareTargetToString val =
    -- Dict.empty
...
updateConditionalForwarderResultToString : UpdateConditionalForwarderResult -> String -- List (String, String)
updateConditionalForwarderResultToString val =
    -- Dict.empty
...
updateNumberOfDomainControllersResultToString : UpdateNumberOfDomainControllersResult -> String -- List (String, String)
updateNumberOfDomainControllersResultToString val =
    -- Dict.empty
...
updateRadiusResultToString : UpdateRadiusResult -> String -- List (String, String)
updateRadiusResultToString val =
    -- Dict.empty
...
updateTrustResultToString : UpdateTrustResult -> String -- List (String, String)
updateTrustResultToString val =
    -- Dict.empty
...
verifyTrustResultToString : VerifyTrustResult -> String -- List (String, String)
verifyTrustResultToString val =
    -- Dict.empty
