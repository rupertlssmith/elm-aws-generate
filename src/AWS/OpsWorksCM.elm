module AWS.OpsWorksCM
    exposing
        ...
        , ExportServerEngineAttributeOptions
        , restoreServer
        , RestoreServerOptions
        , startMaintenance
        , StartMaintenanceOptions
        , updateServer
        , UpdateServerOptions
...
* `engineAttributes` __:__ `(List EngineAttribute)`
...
associateNode serverName nodeName engineAttributes =
    ...
    let
        requestInput = AssociateNodeRequest
...
createBackup serverName setOptions =
    ...
    let
        requestInput = CreateBackupRequest
...
createServer serverName instanceProfileArn instanceType serviceRoleArn setOptions =
    ...
    let
        requestInput = CreateServerRequest
...
type alias CreateServerOptions =
    {
    associatePublicIpAddress : Maybe Bool,disableAutomatedBackup : Maybe Bool,engine : Maybe String,engineModel : Maybe String,engineVersion : Maybe String,engineAttributes : Maybe (List EngineAttribute),backupRetentionCount : Maybe Int,keyPair : Maybe String,preferredMaintenanceWindow : Maybe String,preferredBackupWindow : Maybe String,securityGroupIds : Maybe (List String),subnetIds : Maybe (List String),backupId : Maybe String
    }
...
deleteServer serverName =
    ...
    let
        requestInput = DeleteServerRequest
...
describeAccountAttributes =
    ...
    let
        requestInput = DescribeAccountAttributesRequest
...
type alias DescribeBackupsOptions =
    {
    backupId : Maybe String,serverName : Maybe String,nextToken : Maybe String,maxResults : Maybe Int
    }
...
describeNodeAssociationStatus nodeAssociationStatusToken serverName =
    ...
    let
        requestInput = DescribeNodeAssociationStatusRequest
...
describeServers setOptions =
    ...
    let
        requestInput = DescribeServersRequest
...
type alias DescribeServersOptions =
    {
    serverName : Maybe String,nextToken : Maybe String,maxResults : Maybe Int
    }
...
disassociateNode serverName nodeName setOptions =
    ...
    let
        requestInput = DisassociateNodeRequest
...
* `exportAttributeName` __:__ `String`
* `serverName` __:__ `String`
...
exportServerEngineAttribute exportAttributeName serverName setOptions =
    ...
    let
        requestInput = ExportServerEngineAttributeRequest
        ...
        options = setOptions (ExportServerEngineAttributeOptions Nothing)
...
restoreServer backupId serverName setOptions =
    ...
    let
        requestInput = RestoreServerRequest
...
type alias RestoreServerOptions =
    {
    instanceType : Maybe String,keyPair : Maybe String
    }
...
startMaintenance serverName setOptions =
    ...
    let
        requestInput = StartMaintenanceRequest
        ...
        options = setOptions (StartMaintenanceOptions Nothing)
...
updateServer serverName setOptions =
    ...
    let
        requestInput = UpdateServerRequest
...
type alias UpdateServerOptions =
    {
    disableAutomatedBackup : Maybe Bool,backupRetentionCount : Maybe Int,preferredMaintenanceWindow : Maybe String,preferredBackupWindow : Maybe String
    }
...
updateServerEngineAttributes serverName attributeName setOptions =
    ...
    let
        requestInput = UpdateServerEngineAttributesRequest
...
associateNodeResponseToString : AssociateNodeResponse -> String -- List (String, String)
associateNodeResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "nodeAssociationStatusToken" "" -- val.nodeAssociationStatusToken
...
backupToString val =
    ...
    --     |> Dict.insert
    --         "backupArn" "" -- val.backupArn
        
    --     |> Dict.insert
    --         "backupId" "" -- val.backupId
        
    --     |> Dict.insert
    --         "backupType" "" -- val.backupType
    ...
    --     |> Dict.insert
    --         "s3DataSize" "" -- val.s3DataSize
        
    --     |> Dict.insert
    --         "s3DataUrl" "" -- val.s3DataUrl
        
    --     |> Dict.insert
    --         "s3LogUrl" "" -- val.s3LogUrl
...
createBackupResponseToString : CreateBackupResponse -> String -- List (String, String)
createBackupResponseToString val =
    -- Dict.empty
...
createServerResponseToString : CreateServerResponse -> String -- List (String, String)
createServerResponseToString val =
    -- Dict.empty
...
deleteServerResponseToString : DeleteServerResponse -> String -- List (String, String)
deleteServerResponseToString val =
    -- Dict.empty
...
describeNodeAssociationStatusResponseToString : DescribeNodeAssociationStatusResponse -> String -- List (String, String)
describeNodeAssociationStatusResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "nodeAssociationStatus" "" -- val.nodeAssociationStatus
        
    --     |> Dict.insert
    --         "engineAttributes" "" -- val.engineAttributes
...
describeServersResponseToString : DescribeServersResponse -> String -- List (String, String)
describeServersResponseToString val =
    -- Dict.empty
...
disassociateNodeResponseToString : DisassociateNodeResponse -> String -- List (String, String)
disassociateNodeResponseToString val =
    -- Dict.empty
...
engineAttributeToString : EngineAttribute -> String -- List (String, String)
engineAttributeToString val =
    -- Dict.empty
...
exportServerEngineAttributeResponseToString : ExportServerEngineAttributeResponse -> String -- List (String, String)
exportServerEngineAttributeResponseToString val =
    -- Dict.empty
        
    --     |> Dict.insert
    --         "engineAttribute" "" -- val.engineAttribute
...
restoreServerResponseToString : RestoreServerResponse -> String -- List (String, String)
restoreServerResponseToString val =
    -- Dict.empty
...
serverToString val =
    ...
    --     |> Dict.insert
    --         "backupRetentionCount" "" -- val.backupRetentionCount
    ...
    --     |> Dict.insert
    --         "cloudFormationStackArn" "" -- val.cloudFormationStackArn
        
    --     |> Dict.insert
    --         "disableAutomatedBackup" "" -- val.disableAutomatedBackup
    ...
    --     |> Dict.insert
    --         "maintenanceStatus" "" -- val.maintenanceStatus
...
serverEventToString : ServerEvent -> String -- List (String, String)
serverEventToString val =
    -- Dict.empty
...
startMaintenanceResponseToString : StartMaintenanceResponse -> String -- List (String, String)
startMaintenanceResponseToString val =
    -- Dict.empty
...
updateServerEngineAttributesResponseToString : UpdateServerEngineAttributesResponse -> String -- List (String, String)
updateServerEngineAttributesResponseToString val =
    -- Dict.empty
...
updateServerResponseToString : UpdateServerResponse -> String -- List (String, String)
updateServerResponseToString val =
    -- Dict.empty
