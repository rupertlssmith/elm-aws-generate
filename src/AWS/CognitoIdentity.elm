...
createIdentityPool identityPoolName allowUnauthenticatedIdentities setOptions =
    ...
    let
        requestInput = CreateIdentityPoolInput
        ...
        options = setOptions (CreateIdentityPoolOptions Nothing Nothing Nothing Nothing Nothing Nothing)
...
type alias CreateIdentityPoolOptions =
    {
    supportedLoginProviders : Maybe (Dict String String),developerProviderName : Maybe String,openIdConnectProviderARNs : Maybe (List String),cognitoIdentityProviders : Maybe (List CognitoIdentityProvider),samlProviderARNs : Maybe (List String),identityPoolTags : Maybe (Dict String String)
    }
...
deleteIdentities identityIdsToDelete =
    ...
    let
        requestInput = DeleteIdentitiesInput
...
deleteIdentityPool identityPoolId =
    ...
    let
        requestInput = DeleteIdentityPoolInput
...
describeIdentity identityId =
    ...
    let
        requestInput = DescribeIdentityInput
...
describeIdentityPool identityPoolId =
    ...
    let
        requestInput = DescribeIdentityPoolInput
...
getCredentialsForIdentity identityId setOptions =
    ...
    let
        requestInput = GetCredentialsForIdentityInput
...
type alias GetCredentialsForIdentityOptions =
    {
    logins : Maybe (Dict String String),customRoleArn : Maybe String
    }
...
type alias GetIdOptions =
    {
    accountId : Maybe String,logins : Maybe (Dict String String)
    }
...
getIdentityPoolRoles identityPoolId =
    ...
    let
        requestInput = GetIdentityPoolRolesInput
...
getOpenIdToken identityId setOptions =
    ...
    let
        requestInput = GetOpenIdTokenInput
...
getOpenIdTokenForDeveloperIdentity identityPoolId logins setOptions =
    ...
    let
        requestInput = GetOpenIdTokenForDeveloperIdentityInput
...
type alias GetOpenIdTokenForDeveloperIdentityOptions =
    {
    identityId : Maybe String,tokenDuration : Maybe Int
    }
...
listIdentities identityPoolId maxResults setOptions =
    ...
    let
        requestInput = ListIdentitiesInput
...
type alias ListIdentitiesOptions =
    {
    nextToken : Maybe String,hideDisabled : Maybe Bool
    }
...
listIdentityPools maxResults setOptions =
    ...
    let
        requestInput = ListIdentityPoolsInput
...
lookupDeveloperIdentity identityPoolId setOptions =
    ...
    let
        requestInput = LookupDeveloperIdentityInput
...
type alias LookupDeveloperIdentityOptions =
    {
    identityId : Maybe String,developerUserIdentifier : Maybe String,maxResults : Maybe Int,nextToken : Maybe String
    }
...
mergeDeveloperIdentities sourceUserIdentifier destinationUserIdentifier developerProviderName identityPoolId =
    ...
    let
        requestInput = MergeDeveloperIdentitiesInput
...
setIdentityPoolRoles identityPoolId roles setOptions =
    ...
    let
        requestInput = SetIdentityPoolRolesInput
...
unlinkDeveloperIdentity identityId identityPoolId developerProviderName developerUserIdentifier =
    ...
    let
        requestInput = UnlinkDeveloperIdentityInput
...
unlinkIdentity identityId logins loginsToRemove =
    ...
    let
        requestInput = UnlinkIdentityInput
...
updateIdentityPool identityPoolId identityPoolName allowUnauthenticatedIdentities setOptions =
    ...
    let
        ...
        options = setOptions (UpdateIdentityPoolOptions Nothing Nothing Nothing Nothing Nothing Nothing)
...
cognitoIdentityProviderToString : CognitoIdentityProvider -> String -- List (String, String)
...
deleteIdentitiesResponseToString : DeleteIdentitiesResponse -> String -- List (String, String)
...
getCredentialsForIdentityResponseToString : GetCredentialsForIdentityResponse -> String -- List (String, String)
...
getIdResponseToString : GetIdResponse -> String -- List (String, String)
...
getIdentityPoolRolesResponseToString : GetIdentityPoolRolesResponse -> String -- List (String, String)
...
getOpenIdTokenForDeveloperIdentityResponseToString : GetOpenIdTokenForDeveloperIdentityResponse -> String -- List (String, String)
...
getOpenIdTokenResponseToString : GetOpenIdTokenResponse -> String -- List (String, String)
...
identityDescriptionToString : IdentityDescription -> String -- List (String, String)
...
identityPoolToString : IdentityPool -> String -- List (String, String)
...
identityPoolShortDescriptionToString : IdentityPoolShortDescription -> String -- List (String, String)
...
listIdentityPoolsResponseToString : ListIdentityPoolsResponse -> String -- List (String, String)
...
lookupDeveloperIdentityResponseToString : LookupDeveloperIdentityResponse -> String -- List (String, String)
...
mappingRuleToString : MappingRule -> String -- List (String, String)
...
mergeDeveloperIdentitiesResponseToString : MergeDeveloperIdentitiesResponse -> String -- List (String, String)
...
roleMappingToString : RoleMapping -> String -- List (String, String)
...
rulesConfigurationTypeToString : RulesConfigurationType -> String -- List (String, String)
...
unprocessedIdentityIdToString : UnprocessedIdentityId -> String -- List (String, String)
...
getIdentityPoolRolesResponseEncoder data =
    []
        ...
        |> AWS.Core.Encode.optionalMember
            (JE.dict identity (roleMappingEncoder))
