module AWS.MarketplaceMetering exposing
    ( service
    , batchMeterUsage, meterUsage, MeterUsageOptions, registerUsage, RegisterUsageOptions, resolveCustomer
    , BatchMeterUsageResult, MeterUsageResult, RegisterUsageResult, ResolveCustomerResult
...
meterUsage productCode timestamp usageDimension setOptions =
    let
        ...
        options =
            setOptions (MeterUsageOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
registerUsage productCode publicKeyVersion setOptions =
    let
        ...
        options =
            setOptions (RegisterUsageOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
