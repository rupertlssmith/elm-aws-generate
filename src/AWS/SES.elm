module AWS.SES
    exposing
        ...
        , ListCustomVerificationEmailTemplatesOptions
        , listIdentities
        ...
        , PutConfigurationSetDeliveryOptionsOptions
        , putIdentityPolicy
        , reorderReceiptRuleSet
        , sendBounce
        , SendBounceOptions
        , sendBulkTemplatedEmail
        , SendBulkTemplatedEmailOptions
        , sendCustomVerificationEmail
        , SendCustomVerificationEmailOptions
        , sendEmail
        , SendEmailOptions
        , sendRawEmail
        , SendRawEmailOptions
        ...
        , UpdateAccountSendingEnabledOptions
        , updateConfigurationSetEventDestination
        , updateConfigurationSetReputationMetricsEnabled
        , updateConfigurationSetSendingEnabled
        , updateConfigurationSetTrackingOptions
        , updateCustomVerificationEmailTemplate
        , UpdateCustomVerificationEmailTemplateOptions
        , updateReceiptRule
        , updateTemplate
        , verifyDomainDkim
...
cloneReceiptRuleSet ruleSetName originalRuleSetName =
    ...
    let
        requestInput = CloneReceiptRuleSetRequest
...
createConfigurationSet configurationSet =
    ...
    let
        requestInput = CreateConfigurationSetRequest
...
createConfigurationSetEventDestination configurationSetName eventDestination =
    ...
    let
        requestInput = CreateConfigurationSetEventDestinationRequest
...
* `configurationSetName` __:__ `String`
* `trackingOptions` __:__ `TrackingOptions`
...
createConfigurationSetTrackingOptions configurationSetName trackingOptions =
    ...
    let
        requestInput = CreateConfigurationSetTrackingOptionsRequest
...
* `fromEmailAddress` __:__ `String`
* `templateSubject` __:__ `String`
* `templateContent` __:__ `String`
* `successRedirectionURL` __:__ `String`
* `failureRedirectionURL` __:__ `String`
...
createCustomVerificationEmailTemplate templateName fromEmailAddress templateSubject templateContent successRedirectionURL failureRedirectionURL =
    ...
    let
        requestInput = CreateCustomVerificationEmailTemplateRequest
...
createReceiptFilter filter =
    ...
    let
        requestInput = CreateReceiptFilterRequest
...
createReceiptRule ruleSetName rule setOptions =
    ...
    let
        requestInput = CreateReceiptRuleRequest
...
createReceiptRuleSet ruleSetName =
    ...
    let
        requestInput = CreateReceiptRuleSetRequest
...
createTemplate template =
    ...
    let
        requestInput = CreateTemplateRequest
...
deleteConfigurationSet configurationSetName =
    ...
    let
        requestInput = DeleteConfigurationSetRequest
...
deleteConfigurationSetEventDestination configurationSetName eventDestinationName =
    ...
    let
        requestInput = DeleteConfigurationSetEventDestinationRequest
...
deleteConfigurationSetTrackingOptions configurationSetName =
    ...
    let
        requestInput = DeleteConfigurationSetTrackingOptionsRequest
...
deleteCustomVerificationEmailTemplate templateName =
    ...
    let
        requestInput = DeleteCustomVerificationEmailTemplateRequest
...
deleteIdentity identity =
    ...
    let
        requestInput = DeleteIdentityRequest
...
deleteIdentityPolicy identity policyName =
    ...
    let
        requestInput = DeleteIdentityPolicyRequest
...
deleteReceiptFilter filterName =
    ...
    let
        requestInput = DeleteReceiptFilterRequest
...
deleteReceiptRule ruleSetName ruleName =
    ...
    let
        requestInput = DeleteReceiptRuleRequest
...
deleteReceiptRuleSet ruleSetName =
    ...
    let
        requestInput = DeleteReceiptRuleSetRequest
...
deleteTemplate templateName =
    ...
    let
        requestInput = DeleteTemplateRequest
...
deleteVerifiedEmailAddress emailAddress =
    ...
    let
        requestInput = DeleteVerifiedEmailAddressRequest
...
describeActiveReceiptRuleSet :
    ...
    AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper DescribeActiveReceiptRuleSetResponse)

describeActiveReceiptRuleSet =
    
    let
        requestInput = DescribeActiveReceiptRuleSetRequest
...
describeConfigurationSet configurationSetName setOptions =
    ...
    let
        requestInput = DescribeConfigurationSetRequest
...
describeReceiptRule ruleSetName ruleName =
    ...
    let
        requestInput = DescribeReceiptRuleRequest
...
describeReceiptRuleSet ruleSetName =
    ...
    let
        requestInput = DescribeReceiptRuleSetRequest
...
getAccountSendingEnabled :
    ...
    AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper GetAccountSendingEnabledResponse)
...
getCustomVerificationEmailTemplate templateName =
    ...
    let
        requestInput = GetCustomVerificationEmailTemplateRequest
...
getIdentityDkimAttributes identities =
    ...
    let
        requestInput = GetIdentityDkimAttributesRequest
...
getIdentityMailFromDomainAttributes identities =
    ...
    let
        requestInput = GetIdentityMailFromDomainAttributesRequest
...
getIdentityNotificationAttributes identities =
    ...
    let
        requestInput = GetIdentityNotificationAttributesRequest
...
getIdentityPolicies identity policyNames =
    ...
    let
        requestInput = GetIdentityPoliciesRequest
...
getIdentityVerificationAttributes identities =
    ...
    let
        requestInput = GetIdentityVerificationAttributesRequest
...
getSendQuota :
    ...
    AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper GetSendQuotaResponse)
...
getSendStatistics :
    ...
    AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper GetSendStatisticsResponse)
...
getTemplate templateName =
    ...
    let
        requestInput = GetTemplateRequest
...
listConfigurationSets setOptions =
    ...
    let
        requestInput = ListConfigurationSetsRequest
...
type alias ListConfigurationSetsOptions =
    {
    nextToken : Maybe String,maxItems : Maybe Int
    }
...
listCustomVerificationEmailTemplates setOptions =
    ...
    let
        requestInput = ListCustomVerificationEmailTemplatesRequest
        ...
        options = setOptions (ListCustomVerificationEmailTemplatesOptions Nothing Nothing)
...
listIdentities setOptions =
    ...
    let
        requestInput = ListIdentitiesRequest
...
type alias ListIdentitiesOptions =
    {
    identityType : Maybe IdentityType,nextToken : Maybe String,maxItems : Maybe Int
    }
...
listIdentityPolicies identity =
    ...
    let
        requestInput = ListIdentityPoliciesRequest
...
listReceiptFilters :
    ...
    AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper ListReceiptFiltersResponse)

listReceiptFilters =
    
    let
        requestInput = ListReceiptFiltersRequest
...
listReceiptRuleSets setOptions =
    ...
    let
        requestInput = ListReceiptRuleSetsRequest
...
listTemplates setOptions =
    ...
    let
        requestInput = ListTemplatesRequest
        ...
        options = setOptions (ListTemplatesOptions Nothing Nothing)
...
listVerifiedEmailAddresses :
    ...
    AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper ListVerifiedEmailAddressesResponse)
...
putConfigurationSetDeliveryOptions configurationSetName setOptions =
    ...
    let
        requestInput = PutConfigurationSetDeliveryOptionsRequest
        ...
        options = setOptions (PutConfigurationSetDeliveryOptionsOptions Nothing)
...
putIdentityPolicy identity policyName policy =
    ...
    let
        requestInput = PutIdentityPolicyRequest
...
reorderReceiptRuleSet ruleSetName ruleNames =
    ...
    let
        requestInput = ReorderReceiptRuleSetRequest
...
sendBounce originalMessageId bounceSender bouncedRecipientInfoList setOptions =
    ...
    let
        requestInput = SendBounceRequest
...
type alias SendBounceOptions =
    {
    explanation : Maybe String,messageDsn : Maybe MessageDsn,bounceSenderArn : Maybe String
    }
...
* `source` __:__ `String`
* `template` __:__ `String`
* `destinations` __:__ `(List BulkEmailDestination)`
...
sendBulkTemplatedEmail source template destinations setOptions =
    ...
    let
        requestInput = SendBulkTemplatedEmailRequest
        ...
        options = setOptions (SendBulkTemplatedEmailOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
...
type alias SendBulkTemplatedEmailOptions =
    {
    sourceArn : Maybe String,replyToAddresses : Maybe (List String),returnPath : Maybe String,returnPathArn : Maybe String,configurationSetName : Maybe String,defaultTags : Maybe (List MessageTag),templateArn : Maybe String,defaultTemplateData : Maybe String
    }
...
sendCustomVerificationEmail emailAddress templateName setOptions =
    ...
    let
        requestInput = SendCustomVerificationEmailRequest
        ...
        options = setOptions (SendCustomVerificationEmailOptions Nothing)
...
type alias SendEmailOptions =
    {
    replyToAddresses : Maybe (List String),returnPath : Maybe String,sourceArn : Maybe String,returnPathArn : Maybe String,tags : Maybe (List MessageTag),configurationSetName : Maybe String
    }
...
sendRawEmail rawMessage setOptions =
    ...
    let
        requestInput = SendRawEmailRequest
...
type alias SendRawEmailOptions =
    {
    source : Maybe String,destinations : Maybe (List String),fromArn : Maybe String,sourceArn : Maybe String,returnPathArn : Maybe String,tags : Maybe (List MessageTag),configurationSetName : Maybe String
    }
...
sendTemplatedEmail source destination template templateData setOptions =
    ...
    let
        requestInput = SendTemplatedEmailRequest
        ...
        options = setOptions (SendTemplatedEmailOptions Nothing Nothing Nothing Nothing Nothing Nothing Nothing)
...
type alias SendTemplatedEmailOptions =
    {
    replyToAddresses : Maybe (List String),returnPath : Maybe String,sourceArn : Maybe String,returnPathArn : Maybe String,tags : Maybe (List MessageTag),configurationSetName : Maybe String,templateArn : Maybe String
    }
...
setActiveReceiptRuleSet setOptions =
    ...
    let
        requestInput = SetActiveReceiptRuleSetRequest
...
setIdentityDkimEnabled identity dkimEnabled =
    ...
    let
        requestInput = SetIdentityDkimEnabledRequest
...
setIdentityFeedbackForwardingEnabled identity forwardingEnabled =
    ...
    let
        requestInput = SetIdentityFeedbackForwardingEnabledRequest
...
setIdentityHeadersInNotificationsEnabled identity notificationType enabled =
    ...
    let
        requestInput = SetIdentityHeadersInNotificationsEnabledRequest
...
setIdentityMailFromDomain identity setOptions =
    ...
    let
        requestInput = SetIdentityMailFromDomainRequest
...
type alias SetIdentityMailFromDomainOptions =
    {
    mailFromDomain : Maybe String,behaviorOnMXFailure : Maybe BehaviorOnMXFailure
    }
...
setIdentityNotificationTopic identity notificationType setOptions =
    ...
    let
        requestInput = SetIdentityNotificationTopicRequest
...
setReceiptRulePosition ruleSetName ruleName setOptions =
    ...
    let
        requestInput = SetReceiptRulePositionRequest
...
testRenderTemplate templateName templateData =
    ...
    let
        requestInput = TestRenderTemplateRequest
...
updateAccountSendingEnabled setOptions =
    ...
    let
        requestInput = UpdateAccountSendingEnabledRequest
            
            options.enabled
            
        
        options = setOptions (UpdateAccountSendingEnabledOptions Nothing)
...
updateConfigurationSetEventDestination configurationSetName eventDestination =
    ...
    let
        requestInput = UpdateConfigurationSetEventDestinationRequest
...
updateConfigurationSetReputationMetricsEnabled configurationSetName enabled =
    ...
    let
        requestInput = UpdateConfigurationSetReputationMetricsEnabledRequest
...
updateConfigurationSetSendingEnabled configurationSetName enabled =
    ...
    let
        requestInput = UpdateConfigurationSetSendingEnabledRequest
...
updateConfigurationSetTrackingOptions configurationSetName trackingOptions =
    ...
    let
        requestInput = UpdateConfigurationSetTrackingOptionsRequest
...
updateCustomVerificationEmailTemplate templateName setOptions =
    ...
    let
        requestInput = UpdateCustomVerificationEmailTemplateRequest
        ...
        options = setOptions (UpdateCustomVerificationEmailTemplateOptions Nothing Nothing Nothing Nothing Nothing)
...
type alias UpdateCustomVerificationEmailTemplateOptions =
    {
    fromEmailAddress : Maybe String,templateSubject : Maybe String,templateContent : Maybe String,successRedirectionURL : Maybe String,failureRedirectionURL : Maybe String
    }
...
updateReceiptRule ruleSetName rule =
    ...
    let
        requestInput = UpdateReceiptRuleRequest
...
updateTemplate template =
    ...
    let
        requestInput = UpdateTemplateRequest
...
verifyDomainDkim domain =
    ...
    let
        requestInput = VerifyDomainDkimRequest
...
verifyDomainIdentity domain =
    ...
    let
        requestInput = VerifyDomainIdentityRequest
...
verifyEmailAddress emailAddress =
    ...
    let
        requestInput = VerifyEmailAddressRequest
...
verifyEmailIdentity emailAddress =
    ...
    let
        requestInput = VerifyEmailIdentityRequest
...
addHeaderActionToString : AddHeaderAction -> String -- List (String, String)
...
bodyToString : Body -> String -- List (String, String)
bodyToString val =
    -- Dict.empty
...
bounceActionToString : BounceAction -> String -- List (String, String)
...
bouncedRecipientInfoToString : BouncedRecipientInfo -> String -- List (String, String)
...
bulkEmailDestinationToString : BulkEmailDestination -> String -- List (String, String)
...
bulkEmailDestinationStatusToString : BulkEmailDestinationStatus -> String -- List (String, String)
...
cloneReceiptRuleSetResponseToString : CloneReceiptRuleSetResponse -> String -- List (String, String)
...
cloudWatchDestinationToString : CloudWatchDestination -> String -- List (String, String)
...
cloudWatchDimensionConfigurationToString : CloudWatchDimensionConfiguration -> String -- List (String, String)
...
configurationSetToString : ConfigurationSet -> String -- List (String, String)
...
contentToString : Content -> String -- List (String, String)
contentToString val =
    -- Dict.empty
...
createConfigurationSetEventDestinationResponseToString : CreateConfigurationSetEventDestinationResponse -> String -- List (String, String)
...
createConfigurationSetResponseToString : CreateConfigurationSetResponse -> String -- List (String, String)
...
createConfigurationSetTrackingOptionsResponseToString : CreateConfigurationSetTrackingOptionsResponse -> String -- List (String, String)
...
createReceiptFilterResponseToString : CreateReceiptFilterResponse -> String -- List (String, String)
...
createReceiptRuleResponseToString : CreateReceiptRuleResponse -> String -- List (String, String)
...
createReceiptRuleSetResponseToString : CreateReceiptRuleSetResponse -> String -- List (String, String)
...
createTemplateResponseToString : CreateTemplateResponse -> String -- List (String, String)
...
customVerificationEmailTemplateToString : CustomVerificationEmailTemplate -> String -- List (String, String)
...
deleteConfigurationSetEventDestinationResponseToString : DeleteConfigurationSetEventDestinationResponse -> String -- List (String, String)
...
deleteConfigurationSetResponseToString : DeleteConfigurationSetResponse -> String -- List (String, String)
...
deleteConfigurationSetTrackingOptionsResponseToString : DeleteConfigurationSetTrackingOptionsResponse -> String -- List (String, String)
...
deleteIdentityPolicyResponseToString : DeleteIdentityPolicyResponse -> String -- List (String, String)
...
deleteIdentityResponseToString : DeleteIdentityResponse -> String -- List (String, String)
...
deleteReceiptFilterResponseToString : DeleteReceiptFilterResponse -> String -- List (String, String)
...
deleteReceiptRuleResponseToString : DeleteReceiptRuleResponse -> String -- List (String, String)
...
deleteReceiptRuleSetResponseToString : DeleteReceiptRuleSetResponse -> String -- List (String, String)
...
deleteTemplateResponseToString : DeleteTemplateResponse -> String -- List (String, String)
...
deliveryOptionsToString : DeliveryOptions -> String -- List (String, String)
...
describeActiveReceiptRuleSetResponseToString : DescribeActiveReceiptRuleSetResponse -> String -- List (String, String)
...
describeConfigurationSetResponseToString : DescribeConfigurationSetResponse -> String -- List (String, String)
...
describeReceiptRuleResponseToString : DescribeReceiptRuleResponse -> String -- List (String, String)
...
describeReceiptRuleSetResponseToString : DescribeReceiptRuleSetResponse -> String -- List (String, String)
...
eventDestinationToString : EventDestination -> String -- List (String, String)
...
extensionFieldToString : ExtensionField -> String -- List (String, String)
...
getAccountSendingEnabledResponseToString : GetAccountSendingEnabledResponse -> String -- List (String, String)
...
getCustomVerificationEmailTemplateResponseToString : GetCustomVerificationEmailTemplateResponse -> String -- List (String, String)
...
getIdentityDkimAttributesResponseToString : GetIdentityDkimAttributesResponse -> String -- List (String, String)
...
getIdentityMailFromDomainAttributesResponseToString : GetIdentityMailFromDomainAttributesResponse -> String -- List (String, String)
...
getIdentityNotificationAttributesResponseToString : GetIdentityNotificationAttributesResponse -> String -- List (String, String)
...
getIdentityPoliciesResponseToString : GetIdentityPoliciesResponse -> String -- List (String, String)
...
getIdentityVerificationAttributesResponseToString : GetIdentityVerificationAttributesResponse -> String -- List (String, String)
...
getSendQuotaResponseToString : GetSendQuotaResponse -> String -- List (String, String)
...
getSendStatisticsResponseToString : GetSendStatisticsResponse -> String -- List (String, String)
...
getTemplateResponseToString : GetTemplateResponse -> String -- List (String, String)
...
identityDkimAttributesToString : IdentityDkimAttributes -> String -- List (String, String)
...
identityMailFromDomainAttributesToString : IdentityMailFromDomainAttributes -> String -- List (String, String)
...
identityNotificationAttributesToString : IdentityNotificationAttributes -> String -- List (String, String)
...
identityVerificationAttributesToString : IdentityVerificationAttributes -> String -- List (String, String)
...
kinesisFirehoseDestinationToString : KinesisFirehoseDestination -> String -- List (String, String)
...
lambdaActionToString : LambdaAction -> String -- List (String, String)
...
listConfigurationSetsResponseToString : ListConfigurationSetsResponse -> String -- List (String, String)
...
listCustomVerificationEmailTemplatesResponseToString : ListCustomVerificationEmailTemplatesResponse -> String -- List (String, String)
...
listIdentitiesResponseToString : ListIdentitiesResponse -> String -- List (String, String)
...
listIdentityPoliciesResponseToString : ListIdentityPoliciesResponse -> String -- List (String, String)
...
listReceiptFiltersResponseToString : ListReceiptFiltersResponse -> String -- List (String, String)
...
listReceiptRuleSetsResponseToString : ListReceiptRuleSetsResponse -> String -- List (String, String)
...
listTemplatesResponseToString : ListTemplatesResponse -> String -- List (String, String)
...
listVerifiedEmailAddressesResponseToString : ListVerifiedEmailAddressesResponse -> String -- List (String, String)
...
messageDsnToString : MessageDsn -> String -- List (String, String)
...
messageTagToString : MessageTag -> String -- List (String, String)
...
putConfigurationSetDeliveryOptionsResponseToString : PutConfigurationSetDeliveryOptionsResponse -> String -- List (String, String)
...
putIdentityPolicyResponseToString : PutIdentityPolicyResponse -> String -- List (String, String)
...
rawMessageToString : RawMessage -> String -- List (String, String)
...
receiptActionToString : ReceiptAction -> String -- List (String, String)
...
receiptFilterToString : ReceiptFilter -> String -- List (String, String)
...
receiptIpFilterToString : ReceiptIpFilter -> String -- List (String, String)
...
receiptRuleToString : ReceiptRule -> String -- List (String, String)
...
receiptRuleSetMetadataToString : ReceiptRuleSetMetadata -> String -- List (String, String)
...
recipientDsnFieldsToString : RecipientDsnFields -> String -- List (String, String)
...
reorderReceiptRuleSetResponseToString : ReorderReceiptRuleSetResponse -> String -- List (String, String)
...
reputationOptionsToString : ReputationOptions -> String -- List (String, String)
...
s3ActionToString : S3Action -> String -- List (String, String)
...
sNSActionToString : SNSAction -> String -- List (String, String)
...
sNSDestinationToString : SNSDestination -> String -- List (String, String)
...
sendBounceResponseToString : SendBounceResponse -> String -- List (String, String)
...
sendBulkTemplatedEmailResponseToString : SendBulkTemplatedEmailResponse -> String -- List (String, String)
...
sendCustomVerificationEmailResponseToString : SendCustomVerificationEmailResponse -> String -- List (String, String)
...
sendDataPointToString : SendDataPoint -> String -- List (String, String)
...
sendEmailResponseToString : SendEmailResponse -> String -- List (String, String)
...
sendRawEmailResponseToString : SendRawEmailResponse -> String -- List (String, String)
...
sendTemplatedEmailResponseToString : SendTemplatedEmailResponse -> String -- List (String, String)
...
setActiveReceiptRuleSetResponseToString : SetActiveReceiptRuleSetResponse -> String -- List (String, String)
...
setIdentityDkimEnabledResponseToString : SetIdentityDkimEnabledResponse -> String -- List (String, String)
...
setIdentityFeedbackForwardingEnabledResponseToString : SetIdentityFeedbackForwardingEnabledResponse -> String -- List (String, String)
...
setIdentityHeadersInNotificationsEnabledResponseToString : SetIdentityHeadersInNotificationsEnabledResponse -> String -- List (String, String)
...
setIdentityMailFromDomainResponseToString : SetIdentityMailFromDomainResponse -> String -- List (String, String)
...
setIdentityNotificationTopicResponseToString : SetIdentityNotificationTopicResponse -> String -- List (String, String)
...
setReceiptRulePositionResponseToString : SetReceiptRulePositionResponse -> String -- List (String, String)
...
stopActionToString : StopAction -> String -- List (String, String)
...
templateToString : Template -> String -- List (String, String)
...
templateMetadataToString : TemplateMetadata -> String -- List (String, String)
...
testRenderTemplateResponseToString : TestRenderTemplateResponse -> String -- List (String, String)
...
trackingOptionsToString : TrackingOptions -> String -- List (String, String)
...
updateConfigurationSetEventDestinationResponseToString : UpdateConfigurationSetEventDestinationResponse -> String -- List (String, String)
...
updateConfigurationSetTrackingOptionsResponseToString : UpdateConfigurationSetTrackingOptionsResponse -> String -- List (String, String)
...
updateReceiptRuleResponseToString : UpdateReceiptRuleResponse -> String -- List (String, String)
...
updateTemplateResponseToString : UpdateTemplateResponse -> String -- List (String, String)
...
verifyDomainDkimResponseToString : VerifyDomainDkimResponse -> String -- List (String, String)
...
verifyDomainIdentityResponseToString : VerifyDomainIdentityResponse -> String -- List (String, String)
...
verifyEmailIdentityResponseToString : VerifyEmailIdentityResponse -> String -- List (String, String)
...
workmailActionToString : WorkmailAction -> String -- List (String, String)
