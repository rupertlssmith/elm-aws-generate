...
copyWorkspaceImage name sourceImageId sourceRegion setOptions =
    let
        ...
        options =
            setOptions (CopyWorkspaceImageOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
createIpGroup groupName setOptions =
    let
        ...
        options =
            setOptions (CreateIpGroupOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
-}
describeAccount : AWS.Core.Http.Request (AWS.Core.Decode.ResponseWrapper DescribeAccountResult)
describeAccount =
    let
        requestInput =
...
describeAccountModifications setOptions =
    let
        ...
        options =
            setOptions (DescribeAccountModificationsOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeIpGroups setOptions =
    let
        ...
        options =
            setOptions (DescribeIpGroupsOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeWorkspaceBundles setOptions =
    let
        ...
        options =
            setOptions (DescribeWorkspaceBundlesOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeWorkspaceDirectories setOptions =
    let
        ...
        options =
            setOptions (DescribeWorkspaceDirectoriesOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeWorkspaceImages setOptions =
    let
        ...
        options =
            setOptions (DescribeWorkspaceImagesOptions Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeWorkspaces setOptions =
    let
        ...
        options =
            setOptions (DescribeWorkspacesOptions Nothing Nothing Nothing Nothing Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
describeWorkspacesConnectionStatus setOptions =
    let
        ...
        options =
            setOptions (DescribeWorkspacesConnectionStatusOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
importWorkspaceImage ec2ImageId ingestionProcess imageName imageDescription setOptions =
    let
        ...
        options =
            setOptions (ImportWorkspaceImageOptions Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
listAvailableManagementCidrRanges managementCidrRangeConstraint setOptions =
    let
        ...
        options =
            setOptions (ListAvailableManagementCidrRangesOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
...
modifyAccount setOptions =
    let
        ...
        options =
            setOptions (ModifyAccountOptions Nothing Nothing)
    in
    AWS.Core.Http.request
        AWS.Core.Http.POST
        "/"
